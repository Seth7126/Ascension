...
public class PermissionRequestFragment extends Fragment {
    ...
    final int PERMISSIONS_REQUEST_CODE;
    public static final String PERMISSION_LIST = "PermissionList";
    HashMap afterRequestRationale;
    HashMap beforeRequestRationale;
            ...
            if(PermissionUtil.verifyPermissions(arr_v)) {
                ...
                if(z) {
                    if(arr_s.length == 1) {
                        ...
                        Toast.makeText(this.getActivity(), "Please enable the permissions from application settings.", 0).show();
                    }
                }
    ...
    void updateRequestRationaleStatus(HashMap hashMap0, String[] arr_s) {
