    ...
    public void onMessageReceived(RemoteMessage remoteMessage0) {
        ...
        if(remoteMessage0.getNotification() != null) {
            if(notification0 == null) {
                ...
                notificationBuilder0.setTitle(remoteMessage0.getNotification().getTitle());
                notificationBuilder0.setBody(remoteMessage0.getNotification().getBody());
        ...
        if(notification0 != null) {
            ...
            notification0.dispatch(this.getApplicationContext());
        }
