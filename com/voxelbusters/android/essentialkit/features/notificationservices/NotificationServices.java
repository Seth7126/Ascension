...
import com.voxelbusters.android.essentialkit.features.notificationservices.datatypes.LocationNotificationTrigger;
import com.voxelbusters.android.essentialkit.features.notificationservices.datatypes.Notification;
import com.voxelbusters.android.essentialkit.features.notificationservices.datatypes.NotificationAccessState;
import com.voxelbusters.android.essentialkit.features.notificationservices.datatypes.NotificationSettings;
import com.voxelbusters.android.essentialkit.features.notificationservices.datatypes.NotificationType;
import com.voxelbusters.android.essentialkit.features.notificationservices.datatypes.TimeIntervalNotificationTrigger;
import com.voxelbusters.android.essentialkit.features.notificationservices.provider.fcm.FCM;
...
public class NotificationServices implements IFeature {
    ...
    public NotificationServices(Context context0) {
        ...
        new Handler().postDelayed(new Runnable() {
            @Override
            public void run() {
                if(NotificationServices.pendingLaunchNotification != null) {
                    NotificationServices.processLaunchNotification(NotificationServices.pendingLaunchNotification);
                }
            }
        }, 1000L);
    }
    ...
    private Object[] getStatusBarNotifications() {
        NotificationManager notificationManager0 = (NotificationManager)this.context.getSystemService("notification");
        Object[] arr_object = Build.VERSION.SDK_INT < 23 ? new StatusBarNotification[0] : notificationManager0.getActiveNotifications();
    ...
    public static void processLaunchNotification(Notification notification0) {
        ...
        if(iNotificationServices$INotificationReceivedListener0 != null) {
            ...
            NotificationServices.pendingLaunchNotification = null;
            return;
        }
    ...
    public void requestSystemNotificationSettings(IRequestSystemNotificationSettingsListener iNotificationServices$IRequestSystemNotificationSettingsListener0) {
        NotificationManagerCompat notificationManagerCompat0 = NotificationManagerCompat.from(this.context);
        boolean z = notificationManagerCompat0.areNotificationsEnabled();
        Logger.debug(("Notification importance : " + notificationManagerCompat0.getImportance()));
        iNotificationServices$IRequestSystemNotificationSettingsListener0.onSuccess((z ? NotificationAccessState.Authorized : NotificationAccessState.Denied));
    }
    ...
    public void scheduleNotification(Notification notification0, IScheduleNotificationListener iNotificationServices$IScheduleNotificationListener0) {
        if(notification0.trigger == null || notification0.trigger instanceof TimeIntervalNotificationTrigger) {
            this.alarmScheduler.schedule(notification0, iNotificationServices$IScheduleNotificationListener0);
        }
        else if(!(notification0.trigger instanceof LocationNotificationTrigger)) {
    ...
    public void setApplicationIconBadgeNumber(int v) {
        if(v <= 0 && Build.VERSION.SDK_INT >= 26) {
            new NotificationChannel("com.playdekgames.android.Ascension", ApplicationUtil.getApplicationName(this.context), 3).setShowBadge(false);
        }
    }
