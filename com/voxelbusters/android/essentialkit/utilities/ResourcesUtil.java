...
public class ResourcesUtil {
    ...
    public static int getResourceId(Context context0, String s, String s1) {
        return context0.getResources().getIdentifier(StringUtil.getFileNameWithoutExtension(s), s1, "com.playdekgames.android.Ascension");
    }

    public static InputStream getStreamFromAssets(Context context0, String s) throws IOException {
