    ...
    public static Intent getSelectiveIntentChooser(Context context0, Intent intent0, Intent intent1) {
        ...
        if(!list0.isEmpty()) {
            ...
            for(Object object0: list0) {
                ...
                String s = resolveInfo0.activityInfo == null ? null : resolveInfo0.activityInfo.packageName;
                Intent intent3 = new Intent(intent1);
                intent3.setComponent(new ComponentName(s, resolveInfo0.activityInfo.name));
