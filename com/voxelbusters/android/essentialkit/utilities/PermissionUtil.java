...
public class PermissionUtil {
    ...
    // 检测为 Lambda 实现
    static void lambda$requestPermissions$0(ArrayList arrayList0, List list0, String s, PermissionRequestFragment permissionRequestFragment0, Activity activity0) [...]
    ...
    public static void requestPermissions(Context context0, List list0, String s, IPermissionRequestCallback iPermissionRequestCallback0) {
        ...
        for(Object object0: list0) {
            ...
            if(PermissionUtil.getPermissionStatus(context0, s1) != PermissionStatus.Authorized) {
                arrayList0.add(s1);
            }
        }
        ...
        ((Activity)context0).runOnUiThread(() -> {
            ...
            bundle0.putStringArray("PermissionList", ((String[])arrayList0.toArray(new String[list0.size()])));
