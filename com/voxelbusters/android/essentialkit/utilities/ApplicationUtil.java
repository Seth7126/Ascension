...
public class ApplicationUtil {
    ...
    public static int getAppState(Context context0) {
        ...
        if(list0 != null) {
            ...
            for(Object object0: list0) {
                ...
                switch(activityManager$RunningAppProcessInfo0.importance) {
                    case 100: {
                        return 1;
                    }
                    case 400: {
    ...
    public static ApplicationInfo getApplicationInfo(Context context0) {
        ...
        try {
            return packageManager0.getApplicationInfo("com.playdekgames.android.Ascension", 0);
        }
    ...
    public static String getFileProviderAuthorityName(Context context0) {
        return "com.playdekgames.android.Ascension.essentialkit.fileprovider";
    }
    ...
    public static Class getMainLauncherActivity(Context context0) {
        String s = context0.getPackageManager().getLaunchIntentForPackage("com.playdekgames.android.Ascension").getComponent().getClassName();
        try {
    ...
    public static boolean hasPermission(Context context0, String s) {
        return context0.getPackageManager().checkPermission(s, "com.playdekgames.android.Ascension") == 0;
    }

    public static boolean isDebugBuild(Context context0) {
        int v = ApplicationUtil.getApplicationInfo(context0).flags;
        System.out.println("Flags : " + v);
        return (v & 2) != 0;
    }
