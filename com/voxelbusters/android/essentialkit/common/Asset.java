...
public class Asset {
    ...
    Asset(Context context0, Uri uri0, com.voxelbusters.android.essentialkit.common.Asset.1 asset$10) {
        this(context0, uri0);
    }
    ...
    // 检测为 Lambda 实现
    void lambda$load$0$com-voxelbusters-android-essentialkit-common-Asset(ILoadAssetListener iLoadAssetListener0) [...]
    ...
    public void load(ILoadAssetListener iLoadAssetListener0) {
        ...
        AsyncTask.execute(() -> try {
            ...
            if(iLoadAssetListener0 != null) {
                iLoadAssetListener0.onSuccess(new ByteBuffer(arr_b1));
            }
        }
    ...
    class com.voxelbusters.android.essentialkit.common.Asset.1 {
    }
