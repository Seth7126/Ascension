...
public class UnityPermissions {
    ...
    public static boolean hasUserAuthorizedPermission(Activity activity0, String s) {
        return activity0.checkCallingOrSelfPermission(s) == 0;
    }
    ...
    public static void requestUserPermissions(Activity activity0, String[] arr_s, IPermissionRequestCallbacks iPermissionRequestCallbacks0) {
        if(activity0 != null && arr_s != null) {
            if(!PlatformSupport.MARSHMALLOW_SUPPORT) {
                if(iPermissionRequestCallbacks0 != null) {
                    for(int v = 0; v < arr_s.length; ++v) {
                        iPermissionRequestCallbacks0.onPermissionDeniedAndDontAskAgain(arr_s[v]);
                    }
                }
                return;
            }
            ...
            if(fragmentManager0.findFragmentByTag("96489") == null) {
                g g0 = new g(activity0, iPermissionRequestCallbacks0);
                ...
                fragmentTransaction0.add(0, g0, "96489");
