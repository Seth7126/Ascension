...
final class zzay implements ServiceConnection {
    ...
    final Object zza() throws Exception {
        ...
        try {
            while(v1 >= 3) {
                v = bundle0 == null ? this.zza.zzg.zzy(v1, "com.playdekgames.android.Ascension", "subs") : this.zza.zzg.zzc(v1, "com.playdekgames.android.Ascension", "subs", bundle0);
                if(v != 0) {
                    --v1;
                    continue;
                }
        ...
        label_21:
            ...
            int v3 = 22;
            while(v3 >= 3) {
                v = bundle0 == null ? this.zza.zzg.zzy(v3, "com.playdekgames.android.Ascension", "inapp") : this.zza.zzg.zzc(v3, "com.playdekgames.android.Ascension", "inapp", bundle0);
                if(v == 0) {
                    this.zza.zzk = v3;
