...
class BillingClientImpl extends BillingClient {
    ...
    BillingClientImpl(String s, Context context0, zzby zzby0, ExecutorService executorService0) {
        ...
        zzha zzha0 = zzhb.zzz();
        zzha0.zzj("6.2.1");
        zzha0.zzi("com.playdekgames.android.Ascension");
    ...
    public final void acknowledgePurchase(AcknowledgePurchaseParams acknowledgePurchaseParams0, AcknowledgePurchaseResponseListener acknowledgePurchaseResponseListener0) {
        ...
        if(this.zzak(new zzq(this, acknowledgePurchaseParams0, acknowledgePurchaseResponseListener0), 30000L, new zzr(this, acknowledgePurchaseResponseListener0), this.zzag()) == null) {
    ...
    public void createAlternativeBillingOnlyReportingDetailsAsync(AlternativeBillingOnlyReportingDetailsListener alternativeBillingOnlyReportingDetailsListener0) {
        ...
        if(this.zzak(new zzv(this, alternativeBillingOnlyReportingDetailsListener0), 30000L, new zzw(this, alternativeBillingOnlyReportingDetailsListener0), this.zzag()) == null) {
            BillingResult billingResult0 = this.zzai();
    ...
    public void getBillingConfigAsync(GetBillingConfigParams getBillingConfigParams0, BillingConfigResponseListener billingConfigResponseListener0) {
        ...
        if(this.zzak(new com.android.billingclient.api.zzs(this, bundle0, billingConfigResponseListener0), 30000L, new zzt(this, billingConfigResponseListener0), this.zzag()) == null) {
            BillingResult billingResult0 = this.zzai();
    ...
    public final BillingResult launchBillingFlow(Activity activity0, BillingFlowParams billingFlowParams0) {
        ...
        if(this.zzd != null && this.zzd.zzd() != null) {
            ...
            if(this.zzl) {
                ...
                future0 = this.zzak(() -> this.zzg.zzg(v7, "com.playdekgames.android.Ascension", s2, s1, null, bundle0), 5000L, null, this.zzc);
                v8 = 78;
            }
            else {
                future0 = this.zzak(() -> this.zzg.zzf(3, "com.playdekgames.android.Ascension", s, s1, null), 5000L, null, this.zzc);
                v8 = 80;
            }
            try {
                if(future0 == null) {
                ...
                int v9 = zzb.zzb(bundle1, "BillingClient");
                String s7 = zzb.zzg(bundle1, "BillingClient");
                if(v9 != 0) {
                    zzb.zzk("BillingClient", "Unable to buy item, Error response code: " + v9);
                    BillingResult billingResult0 = zzca.zza(v9, s7);
                    zzby zzby0 = this.zzf;
                    if(bundle1 != null) {
                        v8 = 23;
                    }
                    zzby0.zza(zzbx.zzb(v8, 2, billingResult0));
    ...
    public final void querySkuDetailsAsync(SkuDetailsParams skuDetailsParams0, SkuDetailsResponseListener skuDetailsResponseListener0) {
        ...
        if(this.zzak(new zzy(this, s, list0, null, skuDetailsResponseListener0), 30000L, new zzz(this, skuDetailsResponseListener0), this.zzag()) == null) {
            BillingResult billingResult0 = this.zzai();
    ...
    public BillingResult showAlternativeBillingOnlyInformationDialog(Activity activity0, AlternativeBillingOnlyInformationDialogListener alternativeBillingOnlyInformationDialogListener0) {
        ...
        if(this.zzak(new zzo(this, activity0, new zzat(this, this.zzc, alternativeBillingOnlyInformationDialogListener0), alternativeBillingOnlyInformationDialogListener0), 30000L, new zzp(this, alternativeBillingOnlyInformationDialogListener0), this.zzc) == null) {
            BillingResult billingResult0 = this.zzai();
    ...
    static zzcx zzaf(BillingClientImpl billingClientImpl0, String s, int v) {
        ...
        do {
            try {
                bundle1 = billingClientImpl0.zzn ? billingClientImpl0.zzg.zzj((billingClientImpl0.zzv ? 19 : 9), "com.playdekgames.android.Ascension", s, s1, bundle0) : billingClientImpl0.zzg.zzi(3, "com.playdekgames.android.Ascension", s, s1);
            }
            catch(Exception exception0) {
    ...
    static zzbp zzg(BillingClientImpl billingClientImpl0, String s) {
        ...
        do {
            ...
            try {
                bundle1 = billingClientImpl0.zzg.zzh(6, "com.playdekgames.android.Ascension", s, s1, bundle0);
            }
    ...
    final Object zzk(AcknowledgePurchaseParams acknowledgePurchaseParams0, AcknowledgePurchaseResponseListener acknowledgePurchaseResponseListener0) throws Exception {
        ...
        try {
            ...
            Bundle bundle0 = new Bundle();
            bundle0.putString("playBillingLibraryVersion", this.zzb);
            bundle1 = zzs0.zzd(9, "com.playdekgames.android.Ascension", acknowledgePurchaseParams0.getPurchaseToken(), bundle0);
        }
        catch(Exception exception0) {
    ...
    final Object zzl(ConsumeParams consumeParams0, ConsumeResponseListener consumeResponseListener0) throws Exception {
        ...
        try {
            ...
            if(this.zzn) {
                ...
                Bundle bundle1 = zzs0.zze(9, "com.playdekgames.android.Ascension", s, bundle0);
                v = bundle1.getInt("RESPONSE_CODE");
                s2 = zzb.zzg(bundle1, "BillingClient");
            }
            else {
                v = this.zzg.zza(3, "com.playdekgames.android.Ascension", s);
                s2 = "";
            }
    ...
    final Object zzm(Bundle bundle0, BillingConfigResponseListener billingConfigResponseListener0) throws Exception {
        try {
            this.zzg.zzp(18, "com.playdekgames.android.Ascension", bundle0, new zzbg(billingConfigResponseListener0, this.zzf, null));
        }
    ...
    alab1:
        while(true) {
            ...
            try {
                ...
                bundle2 = zzs0.zzl(v4, "com.playdekgames.android.Ascension", s, bundle0, bundle1);
            }
            catch(Exception exception0) {
        ...
        while(true) {
            ...
            try {
                if(this.zzo) {
                    ...
                    bundle2 = zzs0.zzl(10, "com.playdekgames.android.Ascension", s, bundle0, bundle1);
                }
                else {
                    bundle2 = this.zzg.zzk(3, "com.playdekgames.android.Ascension", s, bundle0);
                }
            }
            catch(Exception exception0) {
    ...
    final Object zzp(Bundle bundle0, Activity activity0, ResultReceiver resultReceiver0) throws Exception {
        this.zzg.zzt(12, "com.playdekgames.android.Ascension", bundle0, new zzbo(new WeakReference(activity0), resultReceiver0, null));
        return null;
    }
    ...
    final Void zzq(AlternativeBillingOnlyReportingDetailsListener alternativeBillingOnlyReportingDetailsListener0) throws Exception {
        try {
            this.zzg.zzm(21, "com.playdekgames.android.Ascension", zzb.zzd(this.zzb), new zzba(alternativeBillingOnlyReportingDetailsListener0, this.zzf, null));
        }
    ...
    final Void zzr(ExternalOfferReportingDetailsListener externalOfferReportingDetailsListener0) throws Exception {
        try {
            this.zzg.zzn(22, "com.playdekgames.android.Ascension", zzb.zzd(this.zzb), new zzbc(externalOfferReportingDetailsListener0, this.zzf, null));
        }
        catch(Exception exception0) {
            zzby zzby0 = this.zzf;
    ...
    final Void zzs(AlternativeBillingOnlyAvailabilityListener alternativeBillingOnlyAvailabilityListener0) throws Exception {
        try {
            this.zzg.zzr(21, "com.playdekgames.android.Ascension", zzb.zzd(this.zzb), new zzbk(alternativeBillingOnlyAvailabilityListener0, this.zzf, null));
        }
        catch(Exception unused_ex) {
    ...
    final Void zzt(ExternalOfferAvailabilityListener externalOfferAvailabilityListener0) throws Exception {
        try {
            this.zzg.zzs(22, "com.playdekgames.android.Ascension", zzb.zzd(this.zzb), new zzbm(externalOfferAvailabilityListener0, this.zzf, null));
        }
        catch(Exception exception0) {
            zzby zzby0 = this.zzf;
            Object[] arr_object = {exception0.getClass().getName(), com.google.android.gms.internal.play_billing.zzab.zzb(exception0.getMessage())};
    ...
    final Void zzu(Activity activity0, ResultReceiver resultReceiver0, AlternativeBillingOnlyInformationDialogListener alternativeBillingOnlyInformationDialogListener0) throws Exception {
        try {
            this.zzg.zzo(21, "com.playdekgames.android.Ascension", zzb.zzd(this.zzb), new zzbe(new WeakReference(activity0), resultReceiver0, null));
        }
        catch(Exception unused_ex) {
    ...
    final Void zzv(Activity activity0, ResultReceiver resultReceiver0, ExternalOfferInformationDialogListener externalOfferInformationDialogListener0) throws Exception {
        try {
            this.zzg.zzq(22, "com.playdekgames.android.Ascension", zzb.zzd(this.zzb), new zzbi(new WeakReference(activity0), resultReceiver0, null));
        }
        catch(Exception exception0) {
            zzby zzby0 = this.zzf;
            Object[] arr_object = {exception0.getClass().getName(), com.google.android.gms.internal.play_billing.zzab.zzb(exception0.getMessage())};
