...
public final class CommonNotificationBuilder {
    ...
    private static PendingIntent createContentIntent(Context context0, NotificationParams notificationParams0, String s, PackageManager packageManager0) {
        ...
        PendingIntent pendingIntent0 = PendingIntent.getActivity(context0, CommonNotificationBuilder.generatePendingIntentRequestCode(), intent0, 0x40000000);
        return CommonNotificationBuilder.shouldUploadMetrics(notificationParams0) ? CommonNotificationBuilder.wrapContentIntent(context0, notificationParams0, pendingIntent0) : pendingIntent0;
    }

    private static PendingIntent createDeleteIntent(Context context0, NotificationParams notificationParams0) {
        return CommonNotificationBuilder.shouldUploadMetrics(notificationParams0) ? CommonNotificationBuilder.createMessagingPendingIntent(context0, new Intent("com.google.firebase.messaging.NOTIFICATION_DISMISS").putExtras(notificationParams0.paramsForAnalyticsIntent())) : null;
    }

    private static PendingIntent createMessagingPendingIntent(Context context0, Intent intent0) {
        return PendingIntent.getBroadcast(context0, CommonNotificationBuilder.generatePendingIntentRequestCode(), new Intent("com.google.firebase.MESSAGING_EVENT").setComponent(new ComponentName(context0, "com.google.firebase.iid.FirebaseInstanceIdReceiver")).putExtra("wrapped_intent", intent0), 0x40000000);
    }

    static DisplayNotificationInfo createNotificationInfo(Context context0, NotificationParams notificationParams0) {
        Bundle bundle0 = CommonNotificationBuilder.getManifestMetadata(context0.getPackageManager(), "com.playdekgames.android.Ascension");
        return CommonNotificationBuilder.createNotificationInfo(context0, "com.playdekgames.android.Ascension", notificationParams0, CommonNotificationBuilder.getOrCreateChannel(context0, notificationParams0.getNotificationChannelId(), bundle0), context0.getResources(), context0.getPackageManager(), bundle0);
    }

    public static DisplayNotificationInfo createNotificationInfo(Context context0, String s, NotificationParams notificationParams0, String s1, Resources resources0, PackageManager packageManager0, Bundle bundle0) {
        Builder notificationCompat$Builder0 = new Builder(context0, s1);
        String s2 = notificationParams0.getPossiblyLocalizedString(resources0, s, "gcm.n.title");
        if(!TextUtils.isEmpty(s2)) {
            notificationCompat$Builder0.setContentTitle(s2);
        }
        String s3 = notificationParams0.getPossiblyLocalizedString(resources0, s, "gcm.n.body");
        if(!TextUtils.isEmpty(s3)) {
            notificationCompat$Builder0.setContentText(s3);
            notificationCompat$Builder0.setStyle(new BigTextStyle().bigText(s3));
        }
        notificationCompat$Builder0.setSmallIcon(CommonNotificationBuilder.getSmallIcon(packageManager0, resources0, s, notificationParams0.getString("gcm.n.icon"), bundle0));
        Uri uri0 = CommonNotificationBuilder.getSound(s, notificationParams0, resources0);
        if(uri0 != null) {
            notificationCompat$Builder0.setSound(uri0);
        }
        notificationCompat$Builder0.setContentIntent(CommonNotificationBuilder.createContentIntent(context0, notificationParams0, s, packageManager0));
        PendingIntent pendingIntent0 = CommonNotificationBuilder.createDeleteIntent(context0, notificationParams0);
        if(pendingIntent0 != null) {
            notificationCompat$Builder0.setDeleteIntent(pendingIntent0);
        }
        Integer integer0 = CommonNotificationBuilder.getColor(context0, notificationParams0.getString("gcm.n.color"), bundle0);
        if(integer0 != null) {
        ...
        String s4 = notificationParams0.getString("gcm.n.ticker");
        if(s4 != null) {
            notificationCompat$Builder0.setTicker(s4);
        }
    ...
    private static String getOrCreateChannel(Context context0, String s, Bundle bundle0) {
        if(Build.VERSION.SDK_INT < 26) {
            return null;
        }
        try {
            context0.getPackageManager().getApplicationInfo("com.playdekgames.android.Ascension", 0);
        }
        ...
        if(notificationManager0.getNotificationChannel("fcm_fallback_notification_channel") == null) {
            notificationManager0.createNotificationChannel(new NotificationChannel("fcm_fallback_notification_channel", context0.getString(context0.getResources().getIdentifier("fcm_fallback_notification_channel_label", "string", "com.playdekgames.android.Ascension")), 3));
        }
    ...
    private static PendingIntent wrapContentIntent(Context context0, NotificationParams notificationParams0, PendingIntent pendingIntent0) {
        return CommonNotificationBuilder.createMessagingPendingIntent(context0, new Intent("com.google.firebase.messaging.NOTIFICATION_OPEN").putExtras(notificationParams0.paramsForAnalyticsIntent()).putExtra("pending_intent", pendingIntent0));
    }
}
