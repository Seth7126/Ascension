...
final class SharedPreferencesQueue {
    ...
    private final ArrayDeque internalQueue;
    ...
    // 检测为 Lambda 实现
    final void bridge$lambda$0$SharedPreferencesQueue() [...]
    ...
    private final void syncStateAsync() {
        SharedPreferencesQueue..Lambda.0 sharedPreferencesQueue$$Lambda$00 = () -> this.syncState();
        this.syncExecutor.execute(sharedPreferencesQueue$$Lambda$00);
    }
}
