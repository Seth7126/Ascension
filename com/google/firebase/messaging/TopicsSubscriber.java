...
class TopicsSubscriber {
    ...
    private TopicsSubscriber(FirebaseInstanceId firebaseInstanceId0, Metadata metadata0, TopicsStore topicsStore0, GmsRpc gmsRpc0, Context context0, ScheduledExecutorService scheduledExecutorService0) {
    ...
    private static Object awaitTask(Task task0) throws IOException {
        try {
            return Tasks.await(task0, 30L, TimeUnit.SECONDS);
        }
    ...
    private void blockingSubscribeToTopic(String s) throws IOException {
        InstanceIdResult instanceIdResult0 = (InstanceIdResult)TopicsSubscriber.awaitTask(this.iid.getInstanceId());
        String s1 = instanceIdResult0.getId();
        String s2 = instanceIdResult0.getToken();
        TopicsSubscriber.awaitTask(this.rpc.subscribeToTopic(s1, s2, s));
    }
    ...
    private void blockingUnsubscribeFromTopic(String s) throws IOException {
        ...
        String s1 = instanceIdResult0.getId();
        String s2 = instanceIdResult0.getToken();
        TopicsSubscriber.awaitTask(this.rpc.unsubscribeFromTopic(s1, s2, s));
    }

    static Task createInstance(FirebaseApp firebaseApp0, FirebaseInstanceId firebaseInstanceId0, Metadata metadata0, UserAgentPublisher userAgentPublisher0, HeartBeatInfo heartBeatInfo0, FirebaseInstallationsApi firebaseInstallationsApi0, Context context0, ScheduledExecutorService scheduledExecutorService0) {
        return TopicsSubscriber.createInstance(firebaseInstanceId0, metadata0, new GmsRpc(firebaseApp0, metadata0, userAgentPublisher0, heartBeatInfo0, firebaseInstallationsApi0), context0, scheduledExecutorService0);
    }

    static Task createInstance(FirebaseInstanceId firebaseInstanceId0, Metadata metadata0, GmsRpc gmsRpc0, Context context0, ScheduledExecutorService scheduledExecutorService0) {
        return Tasks.call(scheduledExecutorService0, () -> new TopicsSubscriber(firebaseInstanceId0, metadata0, TopicsStore.getInstance(context0, scheduledExecutorService0), gmsRpc0, context0, scheduledExecutorService0));
    }
    ...
    // 检测为 Lambda 实现
    static final TopicsSubscriber lambda$createInstance$0$TopicsSubscriber(Context context0, ScheduledExecutorService scheduledExecutorService0, FirebaseInstanceId firebaseInstanceId0, Metadata metadata0, GmsRpc gmsRpc0) throws Exception [...]
    ...
    void syncWithDelaySecondsInternal(long v) {
        this.scheduleSyncTaskWithDelaySeconds(new TopicsSyncTask(this, this.context, this.metadata, Math.min(Math.max(30L, v << 1), TopicsSubscriber.MAX_DELAY_SEC)), v);
