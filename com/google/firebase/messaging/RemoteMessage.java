...
public final class RemoteMessage extends AbstractSafeParcelable {
    public static class Builder {
        ...
        public Builder(String s) {
            ...
            if(TextUtils.isEmpty(s)) {
                ...
                throw new IllegalArgumentException((s1.length() == 0 ? new String("Invalid to: ") : "Invalid to: " + s1));
            }
    ...
    private final int getMessagePriority(String s) {
        if("high".equals(s)) {
            return 1;
        }
    ...
    final void populateSendMessageIntent(Intent intent0) {
