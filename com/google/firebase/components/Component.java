...
public final class Component {
    ...
    private Component(Set set0, Set set1, int v, int v1, ComponentFactory componentFactory0, Set set2) {
    ...
    Component(Set set0, Set set1, int v, int v1, ComponentFactory componentFactory0, Set set2, com.google.firebase.components.Component.1 component$10) {
        this(set0, set1, v, v1, componentFactory0, set2);
    }
    ...
    public static Component intoSet(Object object0, Class class0) {
        return Component.intoSetBuilder(class0).factory(Component..Lambda.3.lambdaFactory$(object0)).build();
    }
    ...
    public static Component of(Class class0, Object object0) {
        return Component.builder(class0).factory(Component..Lambda.1.lambdaFactory$(object0)).build();
    }

    @SafeVarargs
    public static Component of(Object object0, Class class0, Class[] arr_class) {
        return Component.builder(class0, arr_class).factory(Component..Lambda.2.lambdaFactory$(object0)).build();
    }
