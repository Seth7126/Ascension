...
public final class ComponentDiscovery {
    ...
    private static List instantiate(List list0) {
        ...
        for(Object object0: list0) {
            ...
            try {
                ...
                list1.add(((ComponentRegistrar)class0.getDeclaredConstructor().newInstance()));
            }
            catch(ClassNotFoundException classNotFoundException0) {
                Log.w("ComponentDiscovery", String.format("Class %s is not an found.", s), classNotFoundException0);
            }
            catch(IllegalAccessException illegalAccessException0) {
                Log.w("ComponentDiscovery", String.format("Could not instantiate %s.", s), illegalAccessException0);
            }
            catch(InstantiationException instantiationException0) {
                Log.w("ComponentDiscovery", String.format("Could not instantiate %s.", s), instantiationException0);
            }
            catch(NoSuchMethodException noSuchMethodException0) {
                Log.w("ComponentDiscovery", String.format("Could not instantiate %s", s), noSuchMethodException0);
            }
            catch(InvocationTargetException invocationTargetException0) {
                Log.w("ComponentDiscovery", String.format("Could not instantiate %s", s), invocationTargetException0);
            }
        }
        return list1;
    }
