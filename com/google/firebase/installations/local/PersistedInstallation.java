...
public class PersistedInstallation {
    ...
    public PersistedInstallation(FirebaseApp firebaseApp0) {
        this.dataFile = new File(firebaseApp0.getApplicationContext().getFilesDir(), "PersistedInstallation." + firebaseApp0.getPersistenceKey() + ".json");
    ...
    private JSONObject readJSONFromFile() {
        ...
        try(FileInputStream fileInputStream0 = new FileInputStream(this.dataFile)) {
            while(true) {
