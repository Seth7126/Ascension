...
class GetAuthTokenListener implements StateListener {
    ...
    public boolean onException(PersistedInstallationEntry persistedInstallationEntry0, Exception exception0) {
        if(!persistedInstallationEntry0.isErrored() && !persistedInstallationEntry0.isNotGenerated() && !persistedInstallationEntry0.isUnregistered()) {
            return false;
        }
