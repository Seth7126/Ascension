...
public final class zza {
    ...
    public static String zza(int v) {
        ...
        if(map0.containsKey(integer0)) {
            return zza.zzb.containsKey(integer0) ? ((String)map0.get(integer0)) + " (https://developer.android.com/reference/com/google/android/play/core/install/model/InstallErrorCode#" + ((String)zza.zzb.get(integer0)) + ")" : "";
        }
        return "";
    }
}
