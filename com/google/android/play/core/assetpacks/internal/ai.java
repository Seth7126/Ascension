...
public final class ai {
    ...
    static {
        ai.a = new o("PhoneskyVerificationUtils");
    }

    public static boolean a(Context context0) {
        String[] arr_s = context0.getPackageManager().getPackagesForUid(Binder.getCallingUid());
        return arr_s != null && Arrays.asList(arr_s).contains("com.android.vending");
    }
    ...
    label_3:
        for(int v = 0; v < arr_signature.length; ++v) {
            String s = ah.a(arr_signature[v].toByteArray());
            if("8P1sW0EPJcslw7UzRsiXL64w-O50Ed-RBICtay1g24M".equals(s) || (Build.TAGS.contains("dev-keys") || Build.TAGS.contains("test-keys")) && "GXWy8XF3vIml3_MfnmSmyuKBpT3B0dWbHRR_4cgq-gA".equals(s)) {
                return true;
            label_10:
                ai.a.e("Phonesky package is not signed -- possibly self-built package. Could not verify.", new Object[0]);
                break;
            }
        }
        try {
