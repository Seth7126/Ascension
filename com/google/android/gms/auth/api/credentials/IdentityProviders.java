...
public final class IdentityProviders {
    ...
    public static final String getIdentityProviderForAccount(Account account0) {
        Preconditions.checkNotNull(account0, "account cannot be null");
        if("com.google".equals(account0.type)) {
            return "https://accounts.google.com";
        }
        return "com.facebook.auth.login".equals(account0.type) ? "https://www.facebook.com" : null;
    }
}
