...
public class zzi implements Parcelable.Creator {
    ...
    public PlayerEntity zzc(Parcel parcel0) {
        ...
        while(parcel0.dataPosition() < v) {
            ...
            switch(((char)v5)) {
                ...
                case 33: {
                    zzm0 = (zzm)SafeParcelReader.createParcelable(parcel0, v5, zzm.CREATOR);
                    break;
                }
                case 35: {
        ...
        return new PlayerEntity(s, s1, uri0, uri1, v1, v4, v2, s2, s3, s4, mostRecentGameInfoEntity0, playerLevelInfo0, z, z1, s5, s6, uri2, s7, uri3, s8, v3, zzm0, zza0);
    }
}
