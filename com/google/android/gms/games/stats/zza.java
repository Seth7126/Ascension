...
public final class zza extends DataBufferRef implements PlayerStats {
    ...
    zza(DataHolder dataHolder0, int v) {
        super(dataHolder0, v);
    }
    ...
    public final void writeToParcel(Parcel parcel0, int v) {
        ((PlayerStatsEntity)(((PlayerStats)this.freeze()))).writeToParcel(parcel0, v);
    }

    @Override  // com.google.android.gms.games.stats.PlayerStats
    public final Bundle zzcm() {
        Bundle bundle0 = this.zzlw;
        if(bundle0 != null) {
            return bundle0;
        }
        ...
        if(s != null && s1 != null) {
            ...
            for(int v = 0; v < arr_s.length; ++v) {
                this.zzlw.putString(arr_s[v], arr_s1[v]);
            }
        }
        return this.zzlw;
    }
