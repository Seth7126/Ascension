...
public final class AchievementRef extends DataBufferRef implements Achievement {
    ...
    public final Player getPlayer() {
        return (Player)Preconditions.checkNotNull(this.zzad());
    }
    ...
    public final void writeToParcel(Parcel parcel0, int v) {
        ((AchievementEntity)(((Achievement)this.freeze()))).writeToParcel(parcel0, v);
    }

    @Override  // com.google.android.gms.games.achievement.Achievement
    public final Player zzad() {
        return this.hasNull("external_player_id") ? null : new PlayerRef(this.mDataHolder, this.mDataRow);
    }
