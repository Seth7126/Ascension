...
public final class LeaderboardScoreRef extends DataBufferRef implements LeaderboardScore {
    ...
    public LeaderboardScoreRef(DataHolder dataHolder0, int v) {
        super(dataHolder0, v);
        this.zzkh = new PlayerRef(dataHolder0, v);
    }
    ...
    public final Player getScoreHolder() {
        return this.hasNull("external_player_id") ? null : this.zzkh;
    }

    // 去混淆评级： 低(20)
    @Override  // com.google.android.gms.games.leaderboard.LeaderboardScore
    public final String getScoreHolderDisplayName() {
        return this.hasNull("external_player_id") ? this.getString("default_display_name") : this.zzkh.getDisplayName();
    }
    ...
    public final void getScoreHolderDisplayName(CharArrayBuffer charArrayBuffer0) {
        ...
        this.zzkh.getDisplayName(charArrayBuffer0);
    }

    // 去混淆评级： 低(20)
    @Override  // com.google.android.gms.games.leaderboard.LeaderboardScore
    public final Uri getScoreHolderHiResImageUri() {
        return this.hasNull("external_player_id") ? null : this.zzkh.getHiResImageUri();
    }

    // 去混淆评级： 低(20)
    @Override  // com.google.android.gms.games.leaderboard.LeaderboardScore
    public final String getScoreHolderHiResImageUrl() {
        return this.hasNull("external_player_id") ? null : this.zzkh.getHiResImageUrl();
    }

    // 去混淆评级： 低(20)
    @Override  // com.google.android.gms.games.leaderboard.LeaderboardScore
    public final Uri getScoreHolderIconImageUri() {
        return this.hasNull("external_player_id") ? this.parseUri("default_display_image_uri") : this.zzkh.getIconImageUri();
    }

    // 去混淆评级： 低(20)
    @Override  // com.google.android.gms.games.leaderboard.LeaderboardScore
    public final String getScoreHolderIconImageUrl() {
        return this.hasNull("external_player_id") ? this.getString("default_display_image_url") : this.zzkh.getIconImageUrl();
    }
