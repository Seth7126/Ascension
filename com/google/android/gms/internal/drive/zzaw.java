...
public final class zzaw extends GmsClient {
    ...
    protected final Bundle getGetServiceRequestExtraArgs() {
        Preconditions.checkNotNull("com.playdekgames.android.Ascension");
        Preconditions.checkState(!this.getClientSettings().getAllRequestedScopes().isEmpty());
        Bundle bundle0 = new Bundle();
        if(!"com.playdekgames.android.Ascension".equals(this.zzeb)) {
    ...
    public final boolean requiresSignIn() {
        return !"com.playdekgames.android.Ascension".equals(this.zzeb) || !UidVerifier.isGooglePlayServicesUid(this.getContext(), Process.myUid());
    }
