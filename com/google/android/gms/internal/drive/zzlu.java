...
final class zzlu implements zzmf {
                ...
                if(v4 == 2) {
                    if((v6 & 0x20000000L) == 0L) {
                        ...
                        if(v21 == 0) {
                            ...
                            zzkp0.add(new String(arr_b, v9, v21, zzkm.UTF_8));
                        }
                    alab2:
                        while(true) {
                            v9 += v21;
                            ...
                            label_129:
                                ...
                                int v22 = zziy.zza(arr_b, v9, zziz0);
                                if(v2 != zziz0.zznk) {
                                    break alab1;
                                }
                                v9 = zziy.zza(arr_b, v22, zziz0);
                                v21 = zziz0.zznk;
                                if(v21 < 0) {
                                    break alab2;
                                }
                        ...
                        if(v23 == 0) {
                            ...
                            int v24 = v9 + v23;
                            if(!zznf.zze(arr_b, v9, v24)) {
                                throw zzkq.zzdn();
                            }
                            zzkp0.add(new String(arr_b, v9, v23, zzkm.UTF_8));
                        alab3:
                            while(true) {
                                v9 = v24;
                                while(true) {
                                label_152:
                                    ...
                                    int v25 = zziy.zza(arr_b, v9, zziz0);
                                    if(v2 != zziz0.zznk) {
                                        break alab1;
                                    }
                                    v9 = zziy.zza(arr_b, v25, zziz0);
                                    int v26 = zziz0.zznk;
                                    if(v26 < 0) {
                                        throw zzkq.zzdj();
                                    }
                                    if(v26 != 0) {
                                        ...
                                        zzkp0.add(new String(arr_b, v9, v26, zzkm.UTF_8));
                                        break;
                                    }
                                    zzkp0.add("");
                                }
    ...
    private static int zza(byte[] arr_b, int v, int v1, zznm zznm0, Class class0, zziz zziz0) throws IOException {
        int v2;
        switch(zzlv.zzox[zznm0.ordinal()]) {
            case 1: {
    ...
    static zzlu zza(Class class0, zzlo zzlo0, zzly zzly0, zzla zzla0, zzmx zzmx0, zzjy zzjy0, zzll zzll0) {
        ...
        if(zzlo0 instanceof zzme) {
            ...
            int[] arr_v1 = new int[v17 * 3];
            Object[] arr_object1 = new Object[v17 << 1];
            int v59 = v18 + v13;
            int v60 = v18;
            int v61 = v8;
            int v62 = v59;
            ...
            while(v61 < v1) {
                ...
                if((v72 & 0xFF) >= 51) {
                    ...
                    switch((v72 & 0xFF) - 51) {
                        case 12: {
                            if((v2 & 1) == 1) {
                                arr_object1[(v64 / 3 << 1) + 1] = arr_object[v16];
                                ++v16;
                            }
                            break;
                        }
                    ...
                    zzme1 = zzme0;
                    v83 = (int)unsafe0.objectFieldOffset(field0);
                    int v84 = (v79 << 1) + 1;
                    ...
                    zzme1 = zzme0;
                    int v89 = v16 + 1;
                    Field field2 = zzlu.zza(class1, ((String)arr_object[v16]));
                    if((v72 & 0xFF) == 9 || (v72 & 0xFF) == 17) {
                        ...
                        switch(v72 & 0xFF) {
                            ...
                            case 44: {
                                if((v2 & 1) == 1) {
                                    arr_object1[(v64 / 3 << 1) + 1] = arr_object[v89];
                                    ++v89;
                                }
                                break;
                            }
                            case 50: {
                                ...
                                int v90 = v64 / 3 << 1;
                                int v91 = v89 + 1;
                                arr_object1[v90] = arr_object[v89];
                                if((v72 & 0x800) == 0) {
                                    v89 = v91;
                                }
                                else {
                                    v89 = v91 + 1;
                                    arr_object1[v90 + 1] = arr_object[v91];
                                }
                                ++v60;
                            }
                        }
                    ...
                    if((v2 & 1) != 1 || (v72 & 0xFF) > 17) {
                        ...
                        int v92 = v77 + 1;
                        s1 = s;
                        int v93 = s1.charAt(v77);
                        if(v93 >= 0xD800) {
                            int v94 = v93 & 0x1FFF;
                            int v95 = 13;
                            int v96;
                            while((v96 = s1.charAt(v92)) >= 0xD800) {
                                v94 |= (v96 & 0x1FFF) << v95;
                                v95 += 13;
                                ++v92;
                            }
                        ...
                        int v97 = (v << 1) + v93 / 0x20;
                        Object object2 = arr_object[v97];
                        v85 = v89;
                ...
                arr_v1[v64] = v65;
                int v98 = v64 + 2;
                arr_v1[v64 + 1] = v83 | (((v72 & 0x100) == 0 ? 0 : 0x10000000) | ((v72 & 0x200) == 0 ? 0 : 0x20000000) | (v72 & 0xFF) << 20);
                v64 = v98 + 1;
                arr_v1[v98] = v86 << 20 | v87;
                v = v88;
                s = s1;
                v61 = v77;
                class1 = class2;
            ...
            return new zzlu(arr_v1, arr_object1, v15, v14, zzme0.zzee(), z, false, arr_v, v18, v59, zzly0, zzla0, zzmx0, zzjy0, zzll0);
        }
        ((zzms)zzlo0).zzec();
    ...
    final int zza(Object object0, byte[] arr_b, int v, int v1, int v2, zziz zziz0) throws IOException {
        ...
        while(true) {
            if(v4 < v1) {
                ...
                int v13 = v12 >>> 3;
                int v14 = v13 <= v5 ? this.zzau(v13) : this.zzp(v13, v6 / 3);
                if(v14 == -1) {
                    v15 = v13;
                    v16 = v11;
                    v17 = v12;
                    ...
                    if(v21 <= 17) {
                        ...
                        if(v26 != v9) {
                            ...
                            v8 = unsafe0.getInt(object0, ((long)v26));
                            v9 = v26;
                        }
                        switch(v21) {
                            case 0: {
        ...
        if(v39 != -1) {
            unsafe0.putInt(object0, ((long)v39), v8);
        }
        int v42 = this.zzun;
        zzmy zzmy0 = null;
        while(v42 < this.zzuo) {
