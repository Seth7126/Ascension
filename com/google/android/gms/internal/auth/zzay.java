...
public enum zzay {
    ...
    // 去混淆评级： 中等(160)
    public static boolean zza(zzay zzay0) {
        return zzay.zzcr.equals(zzay0) || zzay.zzda.equals(zzay0) || zzay.zzdd.equals(zzay0) || zzay.zzde.equals(zzay0) || zzay.zzcv.equals(zzay0) || zzay.zzdg.equals(zzay0) || zzay.zzck.equals(zzay0) || zzay.zzdl.equals(zzay0) || zzay.zzdm.equals(zzay0) || zzay.zzdn.equals(zzay0) || zzay.zzdo.equals(zzay0) || zzay.zzdp.equals(zzay0) || zzay.zzdq.equals(zzay0) || zzay.zzds.equals(zzay0) || zzay.zzdk.equals(zzay0) || zzay.zzdr.equals(zzay0);
    }

    public static final zzay zzc(String s) {
        zzay[] arr_zzay = zzay.values();
        zzay zzay0 = null;
        for(int v = 0; v < arr_zzay.length; ++v) {
            zzay zzay1 = arr_zzay[v];
            if(zzay1.zzek.equals(s)) {
                zzay0 = zzay1;
            }
        }
        return zzay0;
