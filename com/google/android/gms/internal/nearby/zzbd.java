...
public final class zzbd extends ConnectionsClient {
    ...
    public final Task acceptConnection(String s, PayloadCallback payloadCallback0) {
        return this.zza((zzx zzx0, ResultHolder baseImplementation$ResultHolder0) -> zzx0.zza(baseImplementation$ResultHolder0, s, this.registerListener(payloadCallback0, PayloadCallback.class.getName())));
    }
    ...
    public final Task requestConnection(String s, String s1, ConnectionLifecycleCallback connectionLifecycleCallback0) {
        ListenerHolder listenerHolder0 = this.registerListener(new zzbx(this, connectionLifecycleCallback0), ConnectionLifecycleCallback.class.getName());
        this.zzb(s1);
