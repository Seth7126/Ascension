...
public final class zzdq implements Snapshots {
    ...
    public final PendingResult open(GoogleApiClient googleApiClient0, SnapshotMetadata snapshotMetadata0) {
        return this.open(googleApiClient0, snapshotMetadata0.getUniqueName(), false);
    }
    ...
    public final PendingResult open(GoogleApiClient googleApiClient0, String s, boolean z, int v) {
        return googleApiClient0.execute(new zzds(this, googleApiClient0, s, z, v));
    }
    ...
    public final PendingResult resolveConflict(GoogleApiClient googleApiClient0, String s, Snapshot snapshot0) {
        ...
        return this.resolveConflict(googleApiClient0, s, snapshotMetadata0.getSnapshotId(), snapshotMetadataChange0, snapshot0.getSnapshotContents());
    }
