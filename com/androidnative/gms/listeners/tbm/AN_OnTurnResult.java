...
public class AN_OnTurnResult implements ResultCallback {
    ...
    public void onResult(TurnBasedMultiplayer.UpdateMatchResult turnBasedMultiplayer$UpdateMatchResult0) {
        ...
        Log.d("AndroidNative", "AN_OnTurnResult  statusCode:" + v);
        ...
        UnityPlayer.UnitySendMessage("GooglePlayTBM", "AN_OnTurnResult", stringBuilder0.toString());
    }
}
