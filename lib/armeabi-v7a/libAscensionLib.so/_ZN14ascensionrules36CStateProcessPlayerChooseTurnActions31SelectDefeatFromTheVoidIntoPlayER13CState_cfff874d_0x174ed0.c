// 函数: _ZN14ascensionrules36CStateProcessPlayerChooseTurnActions31SelectDefeatFromTheVoidIntoPlayER13CStateMachineP6CStateiPj
// 地址: 0x174ed0
        ...
        do
            if (*(result + r5_1) == result_1)
                ...
                core::CWorldBase::OutputMessageFormat(r7, 
                    "%s defeats %s from The Void into play(%d power)\n", r8 + 0x10, r1_4 + 4, r9, 
                    var_3c, var_38, var_34)
                ascensionrules::CreateStateProcessDefeatMonsterSequence(r8, result_1, 9, 
                    0xfffffffe, 4, false, true, false, nullptr, 0)
                CState::AddOwnedChild(arg2)
