// 函数: _ZN14ascensionrules35CStateProcessAcquireHeroOrConstruct37SelectAcquireFromCenterRowToTopOfDeckER13CStateMachineP6CStateiPj
// 地址: 0x122384
...
if (result != 0)
    ...
    if (result s>= 1)
        void* __offset(CState, 0x2a8) r6_1 = arg2 + 0x2a8
        int32_t r1_1 = 0
