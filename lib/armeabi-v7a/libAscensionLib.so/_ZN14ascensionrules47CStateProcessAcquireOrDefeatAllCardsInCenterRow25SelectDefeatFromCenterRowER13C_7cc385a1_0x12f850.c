// 函数: _ZN14ascensionrules47CStateProcessAcquireOrDefeatAllCardsInCenterRow25SelectDefeatFromCenterRowER13CStateMachineP6CStateiPj
// 地址: 0x12f850
...
*(arg2 + r4 + 0x6c4) = 1
*(arg2 + 0x680) += 1
ascensionrules::CreateStateProcessDefeatMonsterSequence(r9, arg3, 7, r4, 9, false, false, false, 
    nullptr, 0)
