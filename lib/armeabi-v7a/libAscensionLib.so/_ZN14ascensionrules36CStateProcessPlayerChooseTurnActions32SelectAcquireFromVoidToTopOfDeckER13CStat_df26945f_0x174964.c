// 函数: _ZN14ascensionrules36CStateProcessPlayerChooseTurnActions32SelectAcquireFromVoidToTopOfDeckER13CStateMachineP6CStateiPj
// 地址: 0x174964
    ...
    if (r0_3 s>= 1)
        ...
        do
            if (*(r8_1 + r10_1) == r0_2)
                ...
                if (r0_4 == 0xffffffff)
                    r0_4 = memchr(r1_2 + 0x20, 2, *(r1_2 + 0x1c)) - (r1_2 + 0x20)
            ...
            label_174b40:
                ...
                ascensionrules::CreateStateProcessAcquireCardSequence(r9, r0_2, 9, 0, 2, nullptr, 0)
                CState::AddOwnedChild(arg2)
                CStateList::AppendState(arg2)
