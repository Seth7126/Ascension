// 函数: _ZN14ascensionrules36CStateProcessPlayerChooseTurnActions33SelectAcquireFromDreamscapeToHandER13CStateMachineP6CStateiPj
// 地址: 0x1731b4
    ...
    if (result s>= 1)
        ...
        do
            ...
            if (*(r5_1 + 0x258) == result_1)
                ...
                if (r0_1 == 0xffffffff)
                    r0_1 = memchr(r5_1 + 0x278, 1, *(r5_1 + 0x274)) - (r5_1 + 0x278)
                ...
                ascension::CWorld::OutputEvent(r9, 0x1b, zx.d(*(r10 + 8)), zx.d(*(result_1 + 8)))
                ascensionrules::CreateStateProcessAcquireCardSequence(r10, result_1, 0x14, 
                    zx.d(*(r10 + 8)), 1, nullptr, 0)
                CState::AddOwnedChild(arg2)
