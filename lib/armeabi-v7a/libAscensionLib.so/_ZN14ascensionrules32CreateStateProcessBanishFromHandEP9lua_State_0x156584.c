// 函数: _ZN14ascensionrules32CreateStateProcessBanishFromHandEP9lua_State
// 地址: 0x156584
...
lua_pushlightuserdata(arg1, 
    ascensionrules::CreateStateProcessBanishFromHandOrDiscardOrSource(r0, r0_2, true, false, false, 
