// 函数: _ZN14ascensionrules36CStateProcessPlayerChooseTurnActions33SelectDefeatFromConstructIntoPlayER13CStateMachineP6CStateiPj
// 地址: 0x173f80
        ...
        do
            if (r6 == *(r1_1 - 0xc))
                ...
                ascensionrules::CreateStateProcessDefeatMonsterSequence(r5, r6, 4, 
                    zx.d(*(r0_1 + 8)), 4, false, true, false, *(arg2 + 0x20), *(arg2 + 0x1c))
