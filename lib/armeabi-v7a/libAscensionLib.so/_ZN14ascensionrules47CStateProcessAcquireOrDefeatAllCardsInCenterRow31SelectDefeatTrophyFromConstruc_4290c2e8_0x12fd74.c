// 函数: _ZN14ascensionrules47CStateProcessAcquireOrDefeatAllCardsInCenterRow31SelectDefeatTrophyFromConstructER13CStateMachineP6CStateiPj
// 地址: 0x12fd74
...
*(arg2 + 0x680) += 1
ascensionrules::CreateStateProcessDefeatMonsterSequence(r9, r5, 4, zx.d(*(arg3 + 8)), 5, false, 
