// 函数: _ZNK14ascensionrules40CStateBanishAllOtherCenterRowWithPortals10CloneStateER13CStateMachinePN4core10CWorldBaseERPcRj
// 地址: 0x162878
...
if (result == 0 || *arg_0 u< 0x3dc)
    ...
    result = result_1
    *(arg1 + 0x3c)
    ascensionrules::CStateBanishAllOtherCenterRowWithPortals::CStateBanishAllOtherCenterRowWithPortals(
        result_1, r0_2)
else
    *(arg1 + 0x3c)
    ascensionrules::CStateBanishAllOtherCenterRowWithPortals::CStateBanishAllOtherCenterRowWithPortals(
