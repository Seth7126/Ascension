// 函数: _ZN14ascensionrules36CStateProcessPlayerChooseTurnActions39SelectAcquireFromAvailableUniquesToHandER13CStateMachineP6CStateiPj
// 地址: 0x172d1c
    ...
    if (result s>= 1)
        ...
        do
            ...
            if (*(r5_1 + 0x258) == result_1)
                ...
                ascensionrules::CreateStateProcessAcquireCardSequence(r10, result_1, 0x1b, 0, 1, 
                    nullptr, 0)
                CState::AddOwnedChild(arg2)
