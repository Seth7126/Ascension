// 函数: _ZN14ascensionrules39CStateProcessDefeatMonsterWithLessPower31SelectDefeatFromTheVoidIntoPlayER13CStateMachineP6CStateiPj
// 地址: 0x15b8e0
...
core::CWorldBase::OutputMessageFormat(r8_1, "%s defeats %s from The Void into play\n", r6_1 + 0x10, 
    *(arg3 + 0xc) + 4)
int32_t var_28_1 = 0
