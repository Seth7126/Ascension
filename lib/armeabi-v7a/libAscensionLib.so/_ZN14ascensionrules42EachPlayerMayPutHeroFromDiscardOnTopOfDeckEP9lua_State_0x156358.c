// 函数: _ZN14ascensionrules42EachPlayerMayPutHeroFromDiscardOnTopOfDeckEP9lua_State
// 地址: 0x156358
...
if (r1_1 s>= 1)
    ...
    do
        ...
        CState* r0_5 = ascensionrules::CreateStateRecoverHeroFromDiscardPile(r0_4, 1, nullptr)
