// 函数: _ZN14ascensionrules42CStateProcessAcquireHeroOfHonorValueToHand35SelectAcquireFromKingdomToTopOfDeckER13CStateMachineP6CStateiPj
// 地址: 0x123184
...
if (result s>= 1)
    ...
    do
        if (*(arg3 + 0x14) == *(r7_1 - 0x40))
            ...
            return ascensionrules::CStateProcessAcquireHeroOfHonorValueToHand::AcquireFromKingdom(
