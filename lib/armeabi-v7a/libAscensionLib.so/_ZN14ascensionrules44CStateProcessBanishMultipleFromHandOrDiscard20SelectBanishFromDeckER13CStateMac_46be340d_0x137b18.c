// 函数: _ZN14ascensionrules44CStateProcessBanishMultipleFromHandOrDiscard20SelectBanishFromDeckER13CStateMachineP6CStateiPj
// 地址: 0x137b18
...
if (not(cond:0) && ascension::CPlayer::IsCardInDeck(r5) != 0)
