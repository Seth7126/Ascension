// 函数: _ZN14ascensionrules31CStateProcessAcquireFromTheVoid30SelectAcquireFromTheVoidToHandER13CStateMachineP6CStateiPj
// 地址: 0x124590
        ...
        do
            ...
            label_124728:
                ...
                if (ascension::CWorld::RemoveCardFromVoid(r10_1) != 0)
                    ...
                    if (r0_13 == 0xffffffff)
                        r0_13 = memchr(r9_1 - 0x20, 1, __n) - (r9_1 - 0x20)
