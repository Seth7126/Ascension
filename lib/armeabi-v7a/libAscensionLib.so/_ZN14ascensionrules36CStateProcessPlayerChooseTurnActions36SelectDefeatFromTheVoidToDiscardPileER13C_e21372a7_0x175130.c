// 函数: _ZN14ascensionrules36CStateProcessPlayerChooseTurnActions36SelectDefeatFromTheVoidToDiscardPileER13CStateMachineP6CStateiPj
// 地址: 0x175130
        ...
        do
            if (*(result + r5_1) == result_1)
                ...
                ascensionrules::CreateStateProcessDefeatMonsterSequence(r8, result_1, 9, 
                    0xfffffffe, 3, false, true, false, nullptr, 0)
                CState::AddOwnedChild(arg2)
