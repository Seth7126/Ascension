// 函数: _ZN14ascensionrules31EachPlayerReturnConstructToHandEP9lua_State
// 地址: 0x156d20
...
if (r1_1 s>= 1)
    ...
    do
        ...
        CState* r0_5 = ascensionrules::CreateStateProcessReturnConstructToHand(r0_4, 1, 0, nullptr)
