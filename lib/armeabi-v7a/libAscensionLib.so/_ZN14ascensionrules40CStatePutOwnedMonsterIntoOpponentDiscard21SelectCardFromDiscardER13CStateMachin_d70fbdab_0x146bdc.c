// 函数: _ZN14ascensionrules40CStatePutOwnedMonsterIntoOpponentDiscard21SelectCardFromDiscardER13CStateMachineP6CStateiPj
// 地址: 0x146bdc
...
int32_t var_28 = 0
ascension::CWorld::OutputAnimationCard(r7, arg3, 5, 3, zx.d(*(r6 + 8)), 0xb, 0, 0)
ascension::CPlayer::RemoveCardFromDiscard(r6)
