// 函数: _ZNK14ascensionrules24CStateBanishAllCenterRow10CloneStateER13CStateMachinePN4core10CWorldBaseERPcRj
// 地址: 0x13a948
...
if (result == 0 || *arg_0 u< 0x3dc)
    ...
    result = result_1
    *(arg1 + 0x3c)
    ascensionrules::CStateBanishAllCenterRow::CStateBanishAllCenterRow(result_1, r0_2)
else
    *(arg1 + 0x3c)
    ascensionrules::CStateBanishAllCenterRow::CStateBanishAllCenterRow(result, r0_2)
    *(result + 0x2c) = 0
    *arg4 += 0x3dc
    *arg_0 -= 0x3dc
