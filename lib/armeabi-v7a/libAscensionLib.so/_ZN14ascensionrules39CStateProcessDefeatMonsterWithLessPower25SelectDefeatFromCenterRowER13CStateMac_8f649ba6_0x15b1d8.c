// 函数: _ZN14ascensionrules39CStateProcessDefeatMonsterWithLessPower25SelectDefeatFromCenterRowER13CStateMachineP6CStateiPj
// 地址: 0x15b1d8
...
if (result != 0)
    ...
    if (*(r8 + 0x30) u< 2)
        ...
        *(r5_1 + 0xa9) = 0
        ...
        bool r0_4 = *(arg2 + 0x258)
        uint32_t r6_1 = zx.d(*(arg2 + 0x256))
        r5_1 = operator new(0x99c)
        bool r2_1 = true
        ...
        ascensionrules::CStateProcessDefeatMonsterSequence::CStateProcessDefeatMonsterSequence(
            r5_1, r9, result_1, 7, arg3, r2_1, r0_4, true)
    CState::AddOwnedChild(arg2)
    CStateList::AppendState(arg2)
    int32_t* r0_15 = *(arg2 + 0x260)
    
    if (r0_15 != 0)
        void* r2_5 = r0_15 + *r0_15 + 4
        uint32_t r1_9 = zx.d(*r2_5)
        
        if (r1_9 u<= 7)
            uint32_t r3_1 = zx.d(*(result_1 + 8))
            *r2_5 = r1_9.b + 1
            r0_15[*r0_15 * 8 + r1_9 + 4] = r3_1
    
    result = *(arg2 + 0x25c)
    
    if (result != 0 && zx.d(r8[0xa14]) == 0)
        uint32_t var_50_2 = zx.d(*(result + 8))
