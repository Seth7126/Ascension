// 函数: _ZN14ascensionrules40CStateProcessAcquireOrDefeatAnyCenterRow32SelectAcquireFromVoidToTopOfDeckER13CStateMachineP6CStateiPj
// 地址: 0x12a6f8
...
do
    if (*r5_1 == arg3)
        ...
        if (r0 == 0xffffffff)
            r0 = memchr(&r5_1[8], 2, r5_1[7]) - &r5_1[8]
