// 函数: _ZN14ascensionrules40CStateProcessGainRunesOrAcquireConstruct24SelectAcquireToTopOfDeckER13CStateMachineP6CStateiPj
// 地址: 0x12c160
    ...
    if (result s>= 1)
        ...
        do
            if (result_1 == *(r5_1 - 0x40))
                ...
                if (r0_1 == 0xffffffff)
                    r0_1 = memchr(r5_1 - 0x20, 2, *(r5_1 - 0x24)) - (r5_1 - 0x20)
