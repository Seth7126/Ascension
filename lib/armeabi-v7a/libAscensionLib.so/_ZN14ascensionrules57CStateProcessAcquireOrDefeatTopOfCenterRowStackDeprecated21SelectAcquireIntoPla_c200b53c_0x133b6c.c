// 函数: _ZN14ascensionrules57CStateProcessAcquireOrDefeatTopOfCenterRowStackDeprecated21SelectAcquireIntoPlayER13CStateMachineP6CStateiPj
// 地址: 0x133b6c
...
if (r0_1 == 0xffffffff)
    r0_1 = memchr(r6_1 - 0x20, 4, *(r6_1 - 0x24)) - (r6_1 - 0x20)
