// 函数: _ZN14ascensionrules40CStateProcessGainRunesOrAcquireConstruct19SelectCardToAcquireER13CStateMachineP6CStateiPj
// 地址: 0x12bf70
...
ascension::CWorld::OutputEvent(r6, 5, zx.d(*(*(arg2 + 0x254) + 8)), zx.d(*(result + 8)))
int32_t var_24 = 3
