// 函数: _ZN14ascensionrules50CStateEachOpponentDiscardsFromHandForEachConstruct10EnterStateER13CStateMachine
// 地址: 0x145840
...
if (r1 != *(r8 + 0x1c))
    ...
    while (true)
        ...
        if (result != r5_1)
            CState* r0 = operator new(0x2b8)
            CGameStateOptions::CGameStateOptions(r0.b)
            *(r0 + 0x2a4) = 0
            *(r0 + 0x2a8) = 0
            *(r0 + 0x2ac) = 0
            *(r0 + 0x2b0) = 0
            *r0 = _vtable_for_ascensionrules::CStateProcessDiscardFromHandForEachConstruct + 8
            *(r0 + 0x24c) = r5_1
            *(r0 + 0x250) = 0
            *(r0 + 0x254) = 0
            *(r0 + 0x258) = _vtable_for_ascension::CEventPreventDestroyConstruct + 8
            *(r0 + 0x25c) = 0x19
            *(r0 + 0x260) = 0
            int32_t r0_4
