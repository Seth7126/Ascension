// 函数: _ZN14ascensionrules35CreateStateProcessBanishFromDiscardEP9lua_State
// 地址: 0x15662c
...
lua_pushlightuserdata(arg1, 
    ascensionrules::CreateStateProcessBanishFromHandOrDiscardOrSource(r0, r0_2, false, true, false, 
