// 函数: _ZNK14ascensionrules35CStateProcessShuffleDiscardIntoDeck10CloneStateER13CStateMachinePN4core10CWorldBaseERPcRj
// 地址: 0x1481e8
...
if (result == 0 || *arg_0 u< 0x254)
    ...
    *result = _vtable_for_ascensionrules::CStateProcessShuffleDiscardIntoDeck + 8
    *(result + 0x24c) = r0_2
    *(result + 0x250) = r4_1
else
...
if (*(arg1 + 0x38) s>= 1)
    ...
    CGameStateOptions::AddSimpleUserOption(result.w, 0, 0xa0f0, "Shuffle", 
        ascensionrules::CStateProcessShuffleDiscardIntoDeck::SelectShuffleDeck)
    int32_t var_2c_2 = 0
    CGameStateOptions::AddSimpleUserOption(result.w, 0, 0xa0f1, "Pass", 0)
    (*(*result + 0x34))(result, arg2, *(result + 0x24c), "Shuffle Discard Pile into Deck?")
