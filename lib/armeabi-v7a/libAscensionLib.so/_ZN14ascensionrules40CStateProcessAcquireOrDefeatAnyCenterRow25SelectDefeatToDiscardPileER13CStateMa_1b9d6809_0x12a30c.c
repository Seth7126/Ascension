// 函数: _ZN14ascensionrules40CStateProcessAcquireOrDefeatAnyCenterRow25SelectDefeatToDiscardPileER13CStateMachineP6CStateiPj
// 地址: 0x12a30c
...
if (arg3 != 0)
    ...
    if (*(r6 + 0x30) u< 2)
        ...
        ascensionrules::CreateStateProcessDefeatMonsterSequence(r8, arg3, 7, r7, 3, false, true, 
            false, nullptr, 0)
