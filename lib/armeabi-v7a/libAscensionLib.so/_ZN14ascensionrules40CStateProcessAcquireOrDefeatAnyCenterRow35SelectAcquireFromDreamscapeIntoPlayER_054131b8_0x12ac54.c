// 函数: _ZN14ascensionrules40CStateProcessAcquireOrDefeatAnyCenterRow35SelectAcquireFromDreamscapeIntoPlayER13CStateMachineP6CStateiPj
// 地址: 0x12ac54
...
do
    ...
    if (*(r2 + 0x260) == arg3)
        ...
        ascensionrules::CStateProcessAcquireCardSequence::CStateProcessAcquireCardSequence(
            operator new(0x990), r10_1, arg3, 0x14, zx.d(*(r10_1 + 8)))
        CState::AddOwnedChild(arg2)
        CStateList::AppendState(arg2)
        *(arg2 + 0xcec) = 1
        return 
