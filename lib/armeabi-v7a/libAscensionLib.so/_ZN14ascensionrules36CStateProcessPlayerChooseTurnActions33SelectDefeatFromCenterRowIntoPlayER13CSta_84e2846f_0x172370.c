// 函数: _ZN14ascensionrules36CStateProcessPlayerChooseTurnActions33SelectDefeatFromCenterRowIntoPlayER13CStateMachineP6CStateiPj
// 地址: 0x172370
        ...
        do
            if (*(r1_8 - 0xc) == r0_1)
                ...
                if (*(r5 + 0x30) u< 2)
                    ...
                    ascensionrules::CreateStateProcessDefeatMonsterSequence(r8, r0_1, 7, r7, 4, 
