// 函数: _ZN14ascensionrules36CStateProcessPlayerChooseTurnActions25SelectDefeatFromCenterRowER13CStateMachineP6CStateiPj
// 地址: 0x172024
        ...
        do
            if (*(r1_8 - 0xc) == r0_1)
                ...
                if (*(r5 + 0x30) u< 2)
                    ...
                    ascensionrules::CreateStateProcessDefeatMonsterSequence(r8, r0_1, 7, r7, 9, 
