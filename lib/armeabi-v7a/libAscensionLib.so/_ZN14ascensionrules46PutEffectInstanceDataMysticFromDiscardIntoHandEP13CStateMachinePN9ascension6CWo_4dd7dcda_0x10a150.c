// 函数: _ZN14ascensionrules46PutEffectInstanceDataMysticFromDiscardIntoHandEP13CStateMachinePN9ascension6CWorldEPNS2_7CPlayerEjPN4core9CInstanceEPNS2_19CEffectInstanceDataEPNS2_6CEventE
// 地址: 0x10a150
    ...
    do
        if (zx.d(*(r9_1 + (r10_1 << 2))) != 0)
            ...
            if (r0_3 != 0)
                ...
                if (r0_4 != 0 && strcasecmp(*(r0_4 + 0xc) + 0x44, "Mystic") == 0)
