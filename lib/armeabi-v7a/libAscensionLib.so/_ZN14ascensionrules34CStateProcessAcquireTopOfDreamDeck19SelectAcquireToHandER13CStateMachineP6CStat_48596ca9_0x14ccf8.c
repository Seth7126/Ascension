// 函数: _ZN14ascensionrules34CStateProcessAcquireTopOfDreamDeck19SelectAcquireToHandER13CStateMachineP6CStateiPj
// 地址: 0x14ccf8
...
do
    if (*(r7_1 - 0x40) == arg3)
        ...
        ascensionrules::CreateStateProcessAcquireCardSequence(r9_1, arg3, 0xc, 0, 1, nullptr, 0)
