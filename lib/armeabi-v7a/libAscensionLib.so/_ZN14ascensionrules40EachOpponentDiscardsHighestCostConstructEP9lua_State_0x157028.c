// 函数: _ZN14ascensionrules40EachOpponentDiscardsHighestCostConstructEP9lua_State
// 地址: 0x157028
...
if (r1_1 s>= 1)
    ...
    do
        ...
        if (r0_4 != r0)
            CState* r0_5 = ascensionrules::CreateStateProcessDiscardHighestCostConstruct(r0_4)
            int32_t r0_8
