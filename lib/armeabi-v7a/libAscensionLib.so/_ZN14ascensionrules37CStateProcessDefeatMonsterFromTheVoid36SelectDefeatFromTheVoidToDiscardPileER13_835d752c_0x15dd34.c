// 函数: _ZN14ascensionrules37CStateProcessDefeatMonsterFromTheVoid36SelectDefeatFromTheVoidToDiscardPileER13CStateMachineP6CStateiPj
// 地址: 0x15dd34
...
do
    if (*(r1_1 - 0xc) == arg3)
        ...
        if (*(r6_1 + 0x30) u>= 2)
            ...
            if (zx.d(*(arg2 + 0x250)) == 0)
                r1_13 = "%s defeats %s from The Void\n"
            else
                r1_13 = "%s defeats %s from The Void (%d power)\n"
