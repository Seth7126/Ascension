// 函数: _ZNK14ascensionrules32CStateAcquirePortalFromCenterRow10CloneStateER13CStateMachinePN4core10CWorldBaseERPcRj
// 地址: 0x161730
...
if (result == 0 || *arg_0 u< 0x25c)
    ...
    *result = _vtable_for_ascensionrules::CStateAcquirePortalFromCenterRow + 8
    *(result + 0x24c) = r0_2
    *(result + 0x250) = r4_1
    *(result + 0x254) = r8_1
    *(result + 0x258) = r7
