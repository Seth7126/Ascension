// 函数: _ZN14ascensionrules43CStateProcessAcquireOrDefeatTopOfCenterDeck21SelectAcquireIntoPlayER13CStateMachineP6CStateiPj
// 地址: 0x1324c0
...
do
    ...
    if (*(r2 + 0x260) == arg3)
        ...
        ascensionrules::CStateProcessAcquireCardSequence::CStateProcessAcquireCardSequence(
            operator new(0x990), r10_1, arg3, 0xc, 0)
        CState::AddOwnedChild(arg2)
