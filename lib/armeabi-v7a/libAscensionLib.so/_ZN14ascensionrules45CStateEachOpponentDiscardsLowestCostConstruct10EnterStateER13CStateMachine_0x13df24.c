// 函数: _ZN14ascensionrules45CStateEachOpponentDiscardsLowestCostConstruct10EnterStateER13CStateMachine
// 地址: 0x13df24
...
if (r1 != *(r8 + 0x1c))
    ...
    while (true)
        ...
        if (result != r5_1)
            ...
            __builtin_memset(r0 + 0x29c, 0, 0x11)
            *r0 = _vtable_for_ascensionrules::CStateProcessDiscardLowestCostConstruct + 8
            *(r0 + 0x24c) = r5_1
            *(r0 + 0x250) = _vtable_for_ascension::CEventPreventDestroyConstruct + 8
            *(r0 + 0x254) = 0x19
            *(r0 + 0x258) = 0
            int32_t r0_4
