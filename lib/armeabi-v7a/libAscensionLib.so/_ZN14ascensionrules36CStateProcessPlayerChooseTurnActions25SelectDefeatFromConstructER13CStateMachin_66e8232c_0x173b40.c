// 函数: _ZN14ascensionrules36CStateProcessPlayerChooseTurnActions25SelectDefeatFromConstructER13CStateMachineP6CStateiPj
// 地址: 0x173b40
        ...
        do
            if (r6 == *(r1_1 - 0xc))
                ...
                ascensionrules::CreateStateProcessDefeatMonsterSequence(r5, r6, 4, 
                    zx.d(*(r0_1 + 8)), 9, false, true, false, *(arg2 + 0x20), *(arg2 + 0x1c))
