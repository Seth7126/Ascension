// 函数: _ZN14ascensionrules36CStateProcessPlayerChooseTurnActions32SelectAcquireFromCenterRowToHandER13CStateMachineP6CStateiPj
// 地址: 0x170f4c
    ...
    if (r0_18 s>= 1)
        ...
        do
            ...
            if (*(r10_1 + 0x258) == r0_3)
                ...
                if (r0_19 == 0xffffffff)
                    r0_19 = memchr(r10_1 + 0x278, 1, *(r10_1 + 0x274)) - (r10_1 + 0x278)
            ...
            label_1711ec:
                ...
                ascensionrules::CreateStateProcessAcquireCardSequence(r8_2, r0_3, 7, r9, 1, 
                    nullptr, 0)
                CState::AddOwnedChild(arg2)
                CStateList::AppendState(arg2)
                break
