// 函数: _ZNK14ascensionrules25CStateGainHonorForInsight10CloneStateER13CStateMachinePN4core10CWorldBaseERPcRj
// 地址: 0x154c70
...
if (result == 0 || *arg_0 u< 0x27c)
    uint32_t result_1 = operator new(0x27c)
    int32_t r4_1 = *(arg1 + 0x250)
    result = result_1
    int32_t r8_1 = *(arg1 + 0x254)
    CGameStateOptions::CGameStateOptions(result_1.b)
    *result = _vtable_for_ascensionrules::CStateGainHonorForInsight + 8
    *(result + 0x24c) = r0_2
    *(result + 0x250) = r4_1
    *(result + 0x254) = r8_1
    *(result + 0x258) = r7
