// 函数: _ZN14ascensionrules44EachPlayerDrawCardsForTreasureUnderCenterRowEP13CStateMachinePN9ascension6CWorldEPNS2_7CPlayerEjPN4core9CInstanceEPNS2_19CEffectInstanceDataEPNS2_6CEventE
// 地址: 0x10f6bc
        ...
        if (r7_2 != 0)
            ...
            if (result s>= 1)
                ...
                do
                    ...
                    CState* r0_4 =
                        ascensionrules::CreateStateProcessDrawCards(r0_3, r7_2, nullptr, 0)
                    ...
                    if (r0_3 != arg3 && zx.d(*(arg2 + 0xa2d)) != 0)
                        ...
                        void* r0_8 = __dynamic_cast(arg7, _typeinfo_for_ascension::CEvent, 
                            _typeinfo_for_ascension::CEventEnterCenterRow, 0, var_38, var_34, 
                            var_30)
