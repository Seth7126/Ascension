// 函数: _ZN14ascensionrules30EachOpponentDiscardsEntireHandEP13CStateMachinePN9ascension6CWorldEPNS2_7CPlayerEjPN4core9CInstanceEPNS2_19CEffectInstanceDataEPNS2_6CEventE
// 地址: 0x10fa68
...
if (result s>= 1)
    ...
    do
        ...
        if (result != arg3)
            CState* r0_2 = ascensionrules::CreateStateProcessDiscardEntireHand(result)
