// 函数: _ZN14ascensionrules36CStateProcessPlayerChooseTurnActions38SelectDefeatFromCenterRowToDiscardPileER13CStateMachineP6CStateiPj
// 地址: 0x1726bc
    ...
    if (result s>= 1)
        ...
        do
            if (*(r1_8 - 0xc) == r0_1)
                ...
                label_172864:
                    var_3c = r0_11
                    ascensionrules::CreateStateMustPayResources(r8, r0_1, 0, r9, 0, var_44, 0, 
                        var_3c)
                    CState::AddOwnedChild(arg2)
                    CStateList::AppendState(arg2)
                
                core::CWorldBase::OutputMessageFormat(r5, "%s defeats %s (%d power)\n", r8 + 0x10, 
                    (*(*r0_1 + 0xc))(r0_1), r9, var_44, var_40, var_3c)
                
                if (*(r5 + 0x30) u< 2)
                    ascensionrules::CreateStateRemoveCenterRowCard(r8, r7, nullptr, true, true, 0, 
                        0, false, nullptr, nullptr, 0, nullptr, 0)
                    CState::AddOwnedChild(arg2)
                    CStateList::AppendState(arg2)
                    ascensionrules::CreateStateProcessDefeatMonster(r8, r0_1, r7)
                    CState::AddOwnedChild(arg2)
                else
                    CState::CleanupEmbeddedState()
                    ascensionrules::CreateStateProcessDefeatMonsterSequence(r8, r0_1, 7, r7, 3, 
                        false, true, false, *(arg2 + 0x20), *(arg2 + 0x1c))
