// 函数: _ZNK14ascensionrules37CStateRecoverConstructFromDiscardPile10CloneStateER13CStateMachinePN4core10CWorldBaseERPcRj
// 地址: 0x127144
...
if (result == 0 || *arg_0 u< 0x258)
    ...
    *(result + 0x24c) = r0_2
    *result = _vtable_for_ascensionrules::CStateRecoverConstructFromDiscardPile + 8
    *(result + 0x250) = r7_1
    *(result + 0x254) = r9_1
else
    int32_t r10_1 = *(arg1 + 0x254)
