// 函数: _ZN14ascensionrules26CStateProcessAcquirePortal24SelectAcquireToTopOfDeckER13CStateMachineP6CStateiPj
// 地址: 0x160c18
...
label_160c4c:
    ...
    ascensionrules::CreateStateProcessAcquireCardSequence(r6_1, arg3, r2_2, *(arg2 + 0x258), 2, 
        nullptr, 0)
...
if (r0_7 == 0xffffffff)
    r0_7 = memchr(r4_1 - 0x20, 2, *(r4_1 - 0x24)) - (r4_1 - 0x20)
