// 函数: _ZN14ascensionrules39EachOpponentDiscardsLowestCostConstructEP13CStateMachinePN9ascension6CWorldEPNS2_7CPlayerEjPN4core9CInstanceEPNS2_19CEffectInstanceDataEPNS2_6CEventE
// 地址: 0x110c44
...
if (result s>= 1)
    ...
    do
        ...
        if (result != arg3)
            CState* r0_2 = ascensionrules::CreateStateProcessDiscardLowestCostConstruct(result)
            int32_t r0_5
