// 函数: _ZN14ascensionrules35CStateProcessAcquireHeroToTopOfDeck32SelectAcquireFromCenterRowToHandER13CStateMachineP6CStateiPj
// 地址: 0x11ffc4
...
if (arg3 != 0)
    ...
    if (result s>= 1)
        ...
        if (r0_17 == 0xffffffff)
            r0_17 = memchr(r6_2 - 0x20, 1, *(r6_2 - 0x24)) - (r6_2 - 0x20)
