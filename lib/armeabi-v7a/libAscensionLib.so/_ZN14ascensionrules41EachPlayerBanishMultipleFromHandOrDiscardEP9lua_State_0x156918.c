// 函数: _ZN14ascensionrules41EachPlayerBanishMultipleFromHandOrDiscardEP9lua_State
// 地址: 0x156918
...
if (r0_6 s>= 1)
    ...
    do
        ...
        CState* r0_10 = ascensionrules::CreateStateProcessBanishMultipleFromHandOrDiscard(r0_9, 
            r0_4, true, true, false, false, nullptr)
