// 函数: _ZN14ascensionrules36CStateProcessPlayerChooseTurnActions30SelectAcquireFromKingdomToHandER13CStateMachineP6CStateiPj
// 地址: 0x1705f8
...
if (result s>= 1)
    ...
    do
        if (*(r0_2 + 0x14) == *(r7_1 - 0x40))
            ...
            if (r0_3 == 0xffffffff)
                r0_3 = memchr(r7_1 - 0x20, 1, *(r7_1 - 0x24)) - (r7_1 - 0x20)
