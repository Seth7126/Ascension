// 函数: _ZN14ascensionrules40CreateStateProcessDestroyConstructInPlayEP9lua_State
// 地址: 0x156e4c
...
lua_pushlightuserdata(arg1, 
    ascensionrules::CreateStateProcessDestroyConstructInPlay(r0, r0_2, r6, lua_touserdata(arg1, 4)))
return 1
