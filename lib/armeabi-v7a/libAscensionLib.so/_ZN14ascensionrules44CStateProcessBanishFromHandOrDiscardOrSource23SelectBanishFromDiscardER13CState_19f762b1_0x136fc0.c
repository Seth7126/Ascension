// 函数: _ZN14ascensionrules44CStateProcessBanishFromHandOrDiscardOrSource23SelectBanishFromDiscardER13CStateMachineP6CStateiPj
// 地址: 0x136fc0
...
if (r0 != 0)
    ...
    if (r1_1 u<= 7)
        ...
        *r2_1 = r1_1.b + 1
        r0[*r0 * 8 + r1_1 + 4] = r3 | 0x620000 | 0xa0000000
