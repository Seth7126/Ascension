// 函数: _ZN14ascensionrules36GainPowerForEachMilitiaAlreadyPlayedEP13CStateMachinePN9ascension6CWorldEPNS2_7CPlayerEjPN4core9CInstanceEPNS2_19CEffectInstanceDataEPNS2_6CEventE
// 地址: 0x1064b4
        ...
        if ((zx.d(r6[1].b) & 1) == 0)
            ...
            if (r0_3 != 0)
                ...
                if (*(r0_4 + 0x88) == 1 && *(r0_4 + 0x8c) == 0
                        && strcasecmp(r0_4 + 0x44, "Militia") == 0)
                    r7 += 1
