...
public final class ShortcutBadger {
    ...
    static {
        ...
        linkedList0.add(DefaultBadger.class);
        ...
        linkedList0.add(ZTEHomeBadger.class);
    ...
    private static boolean initBadger(Context context0) {
        Badger badger0;
        Intent intent0 = context0.getPackageManager().getLaunchIntentForPackage("com.playdekgames.android.Ascension");
        if(intent0 == null) {
            Log.e("ShortcutBadger", "Unable to find launch intent for package com.playdekgames.android.Ascension");
            return false;
        }
        ...
        for(Object object0: context0.getPackageManager().queryIntentActivities(intent1, 0x10000)) {
            ...
            for(Object object1: ShortcutBadger.BADGERS) {
