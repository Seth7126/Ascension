    ...
    public MatcherMatchResult(Matcher matcher0, CharSequence charSequence0) {
        ...
        this.groups = new MatchNamedGroupCollection() {
            ...
            public MatchGroup get(int v) {
                IntRange intRange0 = RegexKt.access$range(MatcherMatchResult.access$getMatchResult$p(MatcherMatchResult.this), v);
                if(((int)intRange0.getStart()) >= 0) {
                    String s = MatcherMatchResult.access$getMatchResult$p(MatcherMatchResult.this).group(v);
            ...
            public MatchGroup get(String s) {
                ...
                java.util.regex.MatchResult matchResult0 = MatcherMatchResult.access$getMatchResult$p(MatcherMatchResult.this);
