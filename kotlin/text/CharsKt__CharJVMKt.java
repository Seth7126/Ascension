    ...
    public static final String titlecase(char c, Locale locale0) {
        ...
        if(s.length() > 1) {
            if(c != 329) {
                ...
                Intrinsics.checkNotNullExpressionValue(s2, "(this as java.lang.Strin….toLowerCase(Locale.ROOT)");
                return ((char)v) + s2;
            }
            return s;
        }
        ...
        Intrinsics.checkNotNullExpressionValue(s4, "(this as java.lang.Strin….toUpperCase(Locale.ROOT)");
        return !Intrinsics.areEqual(s, s4) == 0 ? String.valueOf(Character.toTitleCase(c)) : s;
    }
