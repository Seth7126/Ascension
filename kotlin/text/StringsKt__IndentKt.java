...
class StringsKt__IndentKt extends StringsKt__AppendableKt {
    ...
    private static final String reindent$StringsKt__IndentKt(List list0, int v, Function1 function10, Function1 function11) {
        ...
        for(Object object0: list0) {
            ...
            if(v2 != 0 && v2 != v1 || !StringsKt.isBlank(s)) {
                String s2 = (String)function11.invoke(s);
                if(s2 != null) {
                    String s3 = (String)function10.invoke(s2);
                    if(s3 != null) {
                        s = s3;
                    }
                }
        ...
        String s4 = ((StringBuilder)CollectionsKt.joinTo$default(((List)collection0), new StringBuilder(v), "\n", null, null, 0, null, null, 0x7C, null)).toString();
        Intrinsics.checkNotNullExpressionValue(s4, "mapIndexedNotNull { inde…\"\\n\")\n        .toString()");
        return s4;
    }

    public static final String replaceIndent(String s, String s1) {
        String s3;
        Intrinsics.checkNotNullParameter(s, "$this$replaceIndent");
        ...
        for(Object object2: list0) {
            ...
            if(v != 0 && v != v5 || !StringsKt.isBlank(s2)) {
                String s4 = StringsKt.drop(s2, v1);
                if(s4 != null) {
        ...
        String s6 = ((StringBuilder)CollectionsKt.joinTo$default(((List)collection1), new StringBuilder(v2 + v3 * v4), "\n", null, null, 0, null, null, 0x7C, null)).toString();
    ...
    public static final String replaceIndentByMargin(String s, String s1, String s2) {
        int v7;
        Intrinsics.checkNotNullParameter(s, "$this$replaceIndentByMargin");
        Intrinsics.checkNotNullParameter(s1, "newIndent");
    ...
    public static final String trimIndent(String s) {
        Intrinsics.checkNotNullParameter(s, "$this$trimIndent");
        return StringsKt.replaceIndent(s, "");
    }

    public static final String trimMargin(String s, String s1) {
        Intrinsics.checkNotNullParameter(s, "$this$trimMargin");
