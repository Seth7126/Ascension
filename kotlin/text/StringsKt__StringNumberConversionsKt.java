...
class StringsKt__StringNumberConversionsKt extends StringsKt__StringNumberConversionsJVMKt {
    ...
    public static final Byte toByteOrNull(String s) {
        Intrinsics.checkNotNullParameter(s, "$this$toByteOrNull");
    ...
    public static final Integer toIntOrNull(String s) {
        Intrinsics.checkNotNullParameter(s, "$this$toIntOrNull");
    ...
    public static final Long toLongOrNull(String s) {
        Intrinsics.checkNotNullParameter(s, "$this$toLongOrNull");
    ...
    public static final Short toShortOrNull(String s) {
        Intrinsics.checkNotNullParameter(s, "$this$toShortOrNull");
