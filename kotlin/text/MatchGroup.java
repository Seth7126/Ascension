...
public final class MatchGroup {
    ...
    public boolean equals(Object object0) {
        return this == object0 || object0 instanceof MatchGroup && Intrinsics.areEqual(this.value, ((MatchGroup)object0).value) && Intrinsics.areEqual(this.range, ((MatchGroup)object0).range);
    }
    ...
    public int hashCode() {
        int v = 0;
        int v1 = this.value == null ? 0 : this.value.hashCode();
        IntRange intRange0 = this.range;
        if(intRange0 != null) {
            v = intRange0.hashCode();
        }
        return v1 * 0x1F + v;
    }
