...
public final class Charsets {
    ...
    static {
        ...
        Intrinsics.checkNotNullExpressionValue(charset0, "Charset.forName(\"UTF-8\")");
        Charsets.UTF_8 = charset0;
        Charset charset1 = Charset.forName("UTF-16");
        Intrinsics.checkNotNullExpressionValue(charset1, "Charset.forName(\"UTF-16\")");
        Charsets.UTF_16 = charset1;
        Charset charset2 = Charset.forName("UTF-16BE");
        Intrinsics.checkNotNullExpressionValue(charset2, "Charset.forName(\"UTF-16BE\")");
        Charsets.UTF_16BE = charset2;
        Charset charset3 = Charset.forName("UTF-16LE");
        Intrinsics.checkNotNullExpressionValue(charset3, "Charset.forName(\"UTF-16LE\")");
        Charsets.UTF_16LE = charset3;
        Charset charset4 = Charset.forName("US-ASCII");
        Intrinsics.checkNotNullExpressionValue(charset4, "Charset.forName(\"US-ASCII\")");
        Charsets.US_ASCII = charset4;
        Charset charset5 = Charset.forName("ISO-8859-1");
        Intrinsics.checkNotNullExpressionValue(charset5, "Charset.forName(\"ISO-8859-1\")");
    ...
    public final Charset UTF32() {
        ...
        if(charset0 == null) {
            ...
            Intrinsics.checkNotNullExpressionValue(charset0, "Charset.forName(\"UTF-32\")");
    ...
    public final Charset UTF32_BE() {
        ...
        if(charset0 == null) {
            ...
            Intrinsics.checkNotNullExpressionValue(charset0, "Charset.forName(\"UTF-32BE\")");
    ...
    public final Charset UTF32_LE() {
        ...
        if(charset0 == null) {
            ...
            Intrinsics.checkNotNullExpressionValue(charset0, "Charset.forName(\"UTF-32LE\")");
