...
public class ULongProgression implements Iterable, KMappedMarker {
    ...
    @Override
    public int hashCode() {
        return this.isEmpty() ? -1 : ((int)(this.step ^ this.step >>> 0x20)) + (((int)(this.first ^ this.first >>> 0x20)) * 0x1F + ((int)(this.last ^ this.last >>> 0x20))) * 0x1F;
    }

    public boolean isEmpty() {
        int v = UnsignedKt.ulongCompare(this.first, this.last);
        return Long.compare(this.step, 0L) <= 0 ? v < 0 : v > 0;
    }
