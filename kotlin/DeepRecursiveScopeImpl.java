...
final class DeepRecursiveScopeImpl extends DeepRecursiveScope implements Continuation {
    ...
    public static final Continuation access$getCont$p(DeepRecursiveScopeImpl deepRecursiveScopeImpl0) {
        return deepRecursiveScopeImpl0.cont;
    }

    public static final Function3 access$getFunction$p(DeepRecursiveScopeImpl deepRecursiveScopeImpl0) {
        return deepRecursiveScopeImpl0.function;
    }

    public static final Object access$getResult$p-d1pmJ48(DeepRecursiveScopeImpl deepRecursiveScopeImpl0) {
        return deepRecursiveScopeImpl0.result;
    }
