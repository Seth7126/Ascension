...
public final class TimedValue {
    ...
    public final TimedValue copy-RFiDyg4(Object object0, long v) {
        return new TimedValue(object0, v);
    }
    ...
    public boolean equals(Object object0) {
        return this == object0 || object0 instanceof TimedValue && Intrinsics.areEqual(this.value, ((TimedValue)object0).value) && this.duration == ((TimedValue)object0).duration;
    }
    ...
    @Override
    public int hashCode() {
        return this.value == null ? ((int)(this.duration ^ this.duration >>> 0x20)) : this.value.hashCode() * 0x1F + ((int)(this.duration ^ this.duration >>> 0x20));
    }
