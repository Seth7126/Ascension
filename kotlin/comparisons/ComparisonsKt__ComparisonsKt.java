...
class ComparisonsKt__ComparisonsKt {
    ...
    public static final Comparator naturalOrder() {
        NaturalOrderComparator naturalOrderComparator0 = (Object object0, Object object1) -> this.compare(((Comparable)object0), ((Comparable)object1));
        if(naturalOrderComparator0 == null) {
            throw new NullPointerException("null cannot be cast to non-null type kotlin.Comparator<T> /* = java.util.Comparator<T> */");
        }
        return naturalOrderComparator0;
    }
    ...
    public static final Comparator reverseOrder() {
        ReverseOrderComparator reverseOrderComparator0 = (Object object0, Object object1) -> this.compare(((Comparable)object0), ((Comparable)object1));
        if(reverseOrderComparator0 == null) {
            throw new NullPointerException("null cannot be cast to non-null type kotlin.Comparator<T> /* = java.util.Comparator<T> */");
        }
        return reverseOrderComparator0;
    }

    public static final Comparator reversed(Comparator comparator0) {
        Intrinsics.checkNotNullParameter(comparator0, "$this$reversed");
    ...
    public static final Comparator then(Comparator comparator0, Comparator comparator1) {
        Intrinsics.checkNotNullParameter(comparator0, "$this$then");
    ...
    public static final Comparator thenDescending(Comparator comparator0, Comparator comparator1) {
        Intrinsics.checkNotNullParameter(comparator0, "$this$thenDescending");
        Intrinsics.checkNotNullParameter(comparator1, "comparator");
        return new Comparator() {
            @Override
            public final int compare(Object object0, Object object1) {
