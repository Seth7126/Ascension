...
class UCollectionsKt___UCollectionsKt {
    public static final int sumOfUByte(Iterable iterable0) {
        Intrinsics.checkNotNullParameter(iterable0, "$this$sum");
        int v = 0;
    ...
    public static final byte[] toUByteArray(Collection collection0) {
        Intrinsics.checkNotNullParameter(collection0, "$this$toUByteArray");
    ...
    public static final int[] toUIntArray(Collection collection0) {
        Intrinsics.checkNotNullParameter(collection0, "$this$toUIntArray");
    ...
    public static final long[] toULongArray(Collection collection0) {
        Intrinsics.checkNotNullParameter(collection0, "$this$toULongArray");
    ...
    public static final short[] toUShortArray(Collection collection0) {
        Intrinsics.checkNotNullParameter(collection0, "$this$toUShortArray");
