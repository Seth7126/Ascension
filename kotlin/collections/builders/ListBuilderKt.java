...
public final class ListBuilderKt {
    ...
    public static final Object[] copyOfUninitializedElements(Object[] arr_object, int v) {
        Intrinsics.checkNotNullParameter(arr_object, "$this$copyOfUninitializedElements");
    ...
    public static final void resetAt(Object[] arr_object, int v) {
        Intrinsics.checkNotNullParameter(arr_object, "$this$resetAt");
        arr_object[v] = null;
    }

    public static final void resetRange(Object[] arr_object, int v, int v1) {
        Intrinsics.checkNotNullParameter(arr_object, "$this$resetRange");
        while(v < v1) {
    ...
    private static final boolean subarrayContentEquals(Object[] arr_object, int v, int v1, List list0) {
        ...
        for(int v2 = 0; v2 < v1; ++v2) {
            if((true ^ Intrinsics.areEqual(arr_object[v + v2], list0.get(v2))) != 0) {
                return false;
            }
        }
        return true;
