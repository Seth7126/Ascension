...
public final class MapBuilder implements Map, KMutableMap {
    ...
    public static final void access$setKeysArray$p(MapBuilder mapBuilder0, Object[] arr_object) {
        mapBuilder0.keysArray = arr_object;
    }

    public static final void access$setLength$p(MapBuilder mapBuilder0, int v) {
        mapBuilder0.length = v;
    }

    public static final void access$setPresenceArray$p(MapBuilder mapBuilder0, int[] arr_v) {
        mapBuilder0.presenceArray = arr_v;
    }

    public static final void access$setValuesArray$p(MapBuilder mapBuilder0, Object[] arr_object) {
        mapBuilder0.valuesArray = arr_object;
    }
    ...
    private final void ensureCapacity(int v) {
        if(v > this.getCapacity()) {
            ...
            Intrinsics.checkNotNullExpressionValue(arr_v, "java.util.Arrays.copyOf(this, newSize)");
            this.presenceArray = arr_v;
    ...
    private final boolean putEntry(Map.Entry map$Entry0) {
        ...
        if(!Intrinsics.areEqual(map$Entry0.getValue(), object0) != 0) {
    ...
    public final boolean removeEntry$kotlin_stdlib(Map.Entry map$Entry0) {
        ...
        Object[] arr_object = this.valuesArray;
        Intrinsics.checkNotNull(arr_object);
        if(!Intrinsics.areEqual(arr_object[v], map$Entry0.getValue()) != 0) {
            return false;
        }
        this.removeKeyAt(v);
        return true;
