...
public final class SlidingWindowKt {
    ...
    public static final Sequence windowedSequence(Sequence sequence0, int v, int v1, boolean z, boolean z1) {
        Intrinsics.checkNotNullParameter(sequence0, "$this$windowedSequence");
        ...
        return () -> {
            ...
            return !this.$this_windowedSequence$inlined.iterator().hasNext() ? EmptyIterator.INSTANCE : SequencesKt.iterator(new Function2(this.$size$inlined, this.$step$inlined, this.$this_windowedSequence$inlined.iterator(), this.$reuseBuffer$inlined, this.$partialWindows$inlined, null) {
                ...
                public final Continuation create(Object object0, Continuation continuation0) {
                    ...
                    Continuation continuation1 = new kotlin.collections.SlidingWindowKt.windowedIterator.1(this.$size, this.$step, this.$iterator, this.$reuseBuffer, this.$partialWindows, continuation0);
                ...
                public final Object invoke(Object object0, Object object1) {
                    return ((kotlin.collections.SlidingWindowKt.windowedIterator.1)this.create(object0, ((Continuation)object1))).invokeSuspend(Unit.INSTANCE);
                }
                ...
                public final Object invokeSuspend(Object object0) {
                    ...
                    switch(this.label) {
                        case 0: {
                            ...
                            int v1 = RangesKt.coerceAtMost(this.$size, 0x400);
                            int v2 = this.$step - this.$size;
                            if(v2 >= 0) {
