...
class CollectionsKt__IterablesKt extends CollectionsKt__CollectionsKt {
    ...
    public static final int collectionSizeOrDefault(Iterable iterable0, int v) {
        Intrinsics.checkNotNullParameter(iterable0, "$this$collectionSizeOrDefault");
    ...
    public static final Integer collectionSizeOrNull(Iterable iterable0) {
        Intrinsics.checkNotNullParameter(iterable0, "$this$collectionSizeOrNull");
    ...
    public static final Collection convertToSetForSetOperation(Iterable iterable0) {
        Intrinsics.checkNotNullParameter(iterable0, "$this$convertToSetForSetOperation");
        if(iterable0 instanceof Set) {
            return (Collection)iterable0;
        }
        return !(iterable0 instanceof Collection) || CollectionsKt__IterablesKt.safeToConvertToSet$CollectionsKt__IterablesKt(((Collection)iterable0)) ? CollectionsKt.toHashSet(iterable0) : ((Collection)iterable0);
    }

    public static final Collection convertToSetForSetOperationWith(Iterable iterable0, Iterable iterable1) {
        Intrinsics.checkNotNullParameter(iterable0, "$this$convertToSetForSetOperationWith");
        ...
        if(iterable0 instanceof Collection) {
            ...
            return CollectionsKt__IterablesKt.safeToConvertToSet$CollectionsKt__IterablesKt(((Collection)iterable0)) ? CollectionsKt.toHashSet(iterable0) : ((Collection)iterable0);
        }
        return CollectionsKt.toHashSet(iterable0);
    }

    public static final List flatten(Iterable iterable0) {
        Intrinsics.checkNotNullParameter(iterable0, "$this$flatten");
    ...
    private static final boolean safeToConvertToSet$CollectionsKt__IterablesKt(Collection collection0) {
        return collection0.size() > 2 && collection0 instanceof ArrayList;
    }

    public static final Pair unzip(Iterable iterable0) {
        Intrinsics.checkNotNullParameter(iterable0, "$this$unzip");
