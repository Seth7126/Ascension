...
final class RingBuffer extends AbstractList implements RandomAccess {
    ...
    public static final int access$forward(RingBuffer ringBuffer0, int v, int v1) {
        return ringBuffer0.forward(v, v1);
    }

    public static final int access$getSize$p(RingBuffer ringBuffer0) {
        return ringBuffer0.size();
    }

    public static final void access$setSize$p(RingBuffer ringBuffer0, int v) {
        ringBuffer0.size = v;
    }

    public static final void access$setStartIndex$p(RingBuffer ringBuffer0, int v) {
        ringBuffer0.startIndex = v;
    }
