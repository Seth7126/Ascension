...
class CollectionsKt__CollectionsJVMKt {
    ...
    public static final Object[] copyToArrayOfAny(Object[] arr_object, boolean z) {
        Intrinsics.checkNotNullParameter(arr_object, "$this$copyToArrayOfAny");
        if(!z || !Intrinsics.areEqual(arr_object.getClass(), Object[].class)) {
            ...
            Intrinsics.checkNotNullExpressionValue(arr_object, "java.util.Arrays.copyOf(… Array<Any?>::class.java)");
        }
        return arr_object;
    }
    ...
    public static final List listOf(Object object0) {
        ...
        Intrinsics.checkNotNullExpressionValue(list0, "java.util.Collections.singletonList(element)");
        return list0;
    }
