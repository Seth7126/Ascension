...
public final class ArrayDeque extends AbstractMutableList {
    ...
    public static final int access$getSize$p(ArrayDeque arrayDeque0) {
        return arrayDeque0.size();
    }

    public static final void access$setElementData$p(ArrayDeque arrayDeque0, Object[] arr_object) {
        arrayDeque0.elementData = arr_object;
    }

    public static final void access$setHead$p(ArrayDeque arrayDeque0, int v) {
        arrayDeque0.head = v;
    }
    ...
    private final boolean filterInPlace(Function1 function10) {
        ...
        if(!this.isEmpty() && this.elementData.length != 0) {
            ...
            int v2 = this.head;
            if(this.head < v1) {
                for(int v3 = this.head; v3 < v1; ++v3) {
                    Object object0 = this.elementData[v3];
                ...
                ArraysKt.fill(this.elementData, null, v2, v1);
            }
            else {
                int v4 = this.head;
                Object[] arr_object = this.elementData;
                ...
                v2 = this.positiveMod(v2);
                while(v < v1) {
                    Object object2 = this.elementData[v];
                    this.elementData[v] = null;
                    if(((Boolean)function10.invoke(object2)).booleanValue()) {
                        this.elementData[v2] = object2;
                        v2 = this.incremented(v2);
                    }
                    else {
                        v5 = 1;
                    }
            ...
            if(v) {
                this.size = this.negativeMod(v2 - this.head);
            }
        }
        return v != 0;
    }
    ...
    public final Object removeFirst() {
        ...
        Object object0 = this.elementData[this.head];
        int v = this.head;
        this.elementData[v] = null;
    ...
    public final Object removeLast() {
        ...
        Object object0 = this.elementData[v];
        this.elementData[v] = null;
        this.size = this.size() - 1;
        return object0;
    }
    ...
    public Object set(int v, Object object0) {
        AbstractList.Companion.checkElementIndex$kotlin_stdlib(v, this.size());
        int v1 = this.positiveMod(this.head + v);
        Object object1 = this.elementData[v1];
        this.elementData[v1] = object0;
        return object1;
    }
