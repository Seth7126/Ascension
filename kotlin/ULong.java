...
public final class ULong implements Comparable {
    ...
    public int compareTo(Object object0) {
        return this.compareTo-VKZWuLQ(((ULong)object0).unbox-impl());
    }
    ...
    private int compareTo-VKZWuLQ(long v) {
        return ULong.compareTo-VKZWuLQ(this.data, v);
    }
    ...
    private static final long div-xj2QHRw(long v, short v1) {
        return UnsignedKt.ulongDivide-eb3DHEI(v, ULong.constructor-impl(((long)v1) & 0xFFFFL));
    }
    ...
    public static boolean equals-impl(long v, Object object0) {
        return object0 instanceof ULong && v == ((ULong)object0).unbox-impl();
    }
    ...
    @Override
    public int hashCode() {
        return (int)(this.data ^ this.data >>> 0x20);
    }
