...
public final class FileWalkDirection extends Enum {
    ...
    static {
        FileWalkDirection[] arr_fileWalkDirection = new FileWalkDirection[2];
        FileWalkDirection.TOP_DOWN = new FileWalkDirection("TOP_DOWN", 0);
        arr_fileWalkDirection[0] = FileWalkDirection.TOP_DOWN;
        FileWalkDirection.BOTTOM_UP = new FileWalkDirection("BOTTOM_UP", 1);
        arr_fileWalkDirection[1] = FileWalkDirection.BOTTOM_UP;
