...
public final class FileTreeWalk implements Sequence {
    ...
    final class FileTreeWalkIterator extends AbstractIterator {
            ...
            public File step() {
                if(!this.failed && this.fileList == null) {
                    ...
                    if(arr_file == null) {
                        ...
                        if(function20 != null) {
                            Unit unit0 = (Unit)function20.invoke(this.getRoot(), new AccessDeniedException(this.getRoot(), null, "Cannot list files in a directory", 2, null));
                        }
                        this.failed = true;
                    }
                }
                ...
                if(function11 != null) {
                    Unit unit1 = (Unit)function11.invoke(this.getRoot());
                }
                return null;
            }
        }
            ...
            public File step() {
                ...
                if(arr_file != null) {
                    ...
                    if(v >= arr_file.length) {
                        Function1 function11 = FileTreeWalk.this.onLeave;
                        if(function11 != null) {
                            Unit unit0 = (Unit)function11.invoke(this.getRoot());
                        }
                        return null;
                    }
                }
                if(this.fileList == null) {
                    ...
                    if(arr_file1 == null) {
                        Function2 function20 = FileTreeWalk.this.onFail;
                        if(function20 != null) {
                            Unit unit1 = (Unit)function20.invoke(this.getRoot(), new AccessDeniedException(this.getRoot(), null, "Cannot list files in a directory", 2, null));
                        }
                    }
                    File[] arr_file2 = this.fileList;
                    if(arr_file2 == null) {
                    ...
                    label_26:
                        ...
                        if(function12 != null) {
                            Unit unit2 = (Unit)function12.invoke(this.getRoot());
                        }
                        return null;
                    }
                }
        ...
        private final File gotoNext() {
            WalkState fileTreeWalk$WalkState0;
            while((fileTreeWalk$WalkState0 = (WalkState)this.state.peek()) != null) {
                File file0 = fileTreeWalk$WalkState0.step();
                if(file0 == null) {
                    this.state.pop();
                    continue;
                }
