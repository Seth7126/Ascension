...
public final class FilePathComponents {
    ...
    public boolean equals(Object object0) {
        return this == object0 || object0 instanceof FilePathComponents && Intrinsics.areEqual(this.root, ((FilePathComponents)object0).root) && Intrinsics.areEqual(this.segments, ((FilePathComponents)object0).segments);
    }
    ...
    public int hashCode() {
        int v = 0;
        int v1 = this.root == null ? 0 : this.root.hashCode();
        List list0 = this.segments;
        if(list0 != null) {
            v = list0.hashCode();
        }
        return v1 * 0x1F + v;
