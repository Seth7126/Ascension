...
class FilesKt__FilePathComponentsKt {
    public static final File getRoot(File file0) {
        Intrinsics.checkNotNullParameter(file0, "$this$root");
    ...
    public static final String getRootName(File file0) {
        Intrinsics.checkNotNullParameter(file0, "$this$rootName");
        ...
        int v = FilesKt__FilePathComponentsKt.getRootLength$FilesKt__FilePathComponentsKt(s1);
        if(s == null) {
    ...
    public static final boolean isRooted(File file0) {
        Intrinsics.checkNotNullParameter(file0, "$this$isRooted");
        String s = file0.getPath();
        Intrinsics.checkNotNullExpressionValue(s, "path");
