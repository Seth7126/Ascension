...
public final class LineReader {
    ...
    static {
        ...
        Intrinsics.checkNotNullExpressionValue(byteBuffer0, "ByteBuffer.wrap(bytes)");
        LineReader.byteBuf = byteBuffer0;
        CharBuffer charBuffer0 = CharBuffer.wrap(arr_c);
        Intrinsics.checkNotNullExpressionValue(charBuffer0, "CharBuffer.wrap(chars)");
        LineReader.charBuf = charBuffer0;
        LineReader.sb = new StringBuilder();
    }

    public static final CharsetDecoder access$getDecoder$p(LineReader lineReader0) {
    ...
    public static final void access$setDecoder$p(LineReader lineReader0, CharsetDecoder charsetDecoder0) {
    ...
    public final String readLine(InputStream inputStream0, Charset charset0) {
        ...
        if(charsetDecoder0 == null) {
            ...
            if(!Intrinsics.areEqual(charsetDecoder0.charset(), charset0) != 0) {
                this.updateCharset(charset0);
            }
        }
        int v1 = 0;
