...
class FilesKt__UtilsKt extends FilesKt__FileTreeWalkKt {
    ...
    public static final boolean copyRecursively(File file0, File file1, boolean z, Function2 function20) {
        Intrinsics.checkNotNullParameter(file0, "$this$copyRecursively");
        Intrinsics.checkNotNullParameter(file1, "target");
        Intrinsics.checkNotNullParameter(function20, "onError");
        if(!file0.exists()) {
            return ((OnErrorAction)function20.invoke(file0, new NoSuchFileException(file0, null, "The source file doesn\'t exist.", 2, null))) != OnErrorAction.TERMINATE;
        }
        try {
            Iterator iterator0 = FilesKt.walkTopDown(file0).onFail(new Function2(function20) {
                ...
                public final void invoke(File file0, IOException iOException0) {
                    ...
                    if(((OnErrorAction)this.$onError.invoke(file0, iOException0)) == OnErrorAction.TERMINATE) {
            ...
            while(true) {
                ...
                if(!file2.exists()) {
                    if(((OnErrorAction)function20.invoke(file2, new NoSuchFileException(file2, null, "The source file doesn\'t exist.", 2, null))) != OnErrorAction.TERMINATE) {
                        continue;
                    }
                    return false;
                }
                ...
                if(file3.exists() && (!file2.isDirectory() || !file3.isDirectory()) && (!z || !FilesKt.deleteRecursively(file3) || !file3.isDirectory() && !file3.delete())) {
                    if(((OnErrorAction)function20.invoke(file3, new FileAlreadyExistsException(file2, file3, "The destination file already exists."))) != OnErrorAction.TERMINATE) {
                        continue;
                    }
                    return false;
                }
                ...
                else if(FilesKt.copyTo$default(file2, file3, z, 0, 4, null).length() != file2.length() && ((OnErrorAction)function20.invoke(file2, new IOException("Source file wasn\'t copied completely, length of destination file differs."))) == OnErrorAction.TERMINATE) {
                    break;
                }
            }
        }
    ...
    public static final File copyTo(File file0, File file1, boolean z, int v) {
        Intrinsics.checkNotNullParameter(file0, "$this$copyTo");
        Intrinsics.checkNotNullParameter(file1, "target");
        if(!file0.exists()) {
    ...
    public static final File createTempFile(String s, String s1, File file0) {
        Intrinsics.checkNotNullParameter(s, "prefix");
        File file1 = File.createTempFile(s, s1, file0);
        Intrinsics.checkNotNullExpressionValue(file1, "File.createTempFile(prefix, suffix, directory)");
        return file1;
    }
    ...
    public static final boolean deleteRecursively(File file0) {
        boolean z;
        Intrinsics.checkNotNullParameter(file0, "$this$deleteRecursively");
    ...
    public static final boolean endsWith(File file0, File file1) {
        Intrinsics.checkNotNullParameter(file0, "$this$endsWith");
    ...
    public static final String getExtension(File file0) {
        Intrinsics.checkNotNullParameter(file0, "$this$extension");
    ...
    public static final String getInvariantSeparatorsPath(File file0) {
        Intrinsics.checkNotNullParameter(file0, "$this$invariantSeparatorsPath");
    ...
    public static final String getNameWithoutExtension(File file0) {
        Intrinsics.checkNotNullParameter(file0, "$this$nameWithoutExtension");
        String s = file0.getName();
        Intrinsics.checkNotNullExpressionValue(s, "name");
    ...
    public static final File normalize(File file0) {
        Intrinsics.checkNotNullParameter(file0, "$this$normalize");
        FilePathComponents filePathComponents0 = FilesKt.toComponents(file0);
        List list0 = FilesKt__UtilsKt.normalize$FilesKt__UtilsKt(filePathComponents0.getSegments());
        Intrinsics.checkNotNullExpressionValue("/", "File.separator");
        ...
        for(Object object0: list0) {
            ...
            if(s != null) {
                switch(s) {
                    ...
                    case "..": {
                        if(arrayList0.isEmpty() || !Intrinsics.areEqual(((File)CollectionsKt.last(arrayList0)).getName(), "..") == 0) {
    ...
    public static final File relativeTo(File file0, File file1) {
        Intrinsics.checkNotNullParameter(file0, "$this$relativeTo");
    ...
    public static final File relativeToOrNull(File file0, File file1) {
        Intrinsics.checkNotNullParameter(file0, "$this$relativeToOrNull");
        Intrinsics.checkNotNullParameter(file1, "base");
    ...
    public static final File relativeToOrSelf(File file0, File file1) {
        Intrinsics.checkNotNullParameter(file0, "$this$relativeToOrSelf");
        Intrinsics.checkNotNullParameter(file1, "base");
        String s = FilesKt__UtilsKt.toRelativeStringOrNull$FilesKt__UtilsKt(file0, file1);
    ...
    public static final File resolve(File file0, File file1) {
        Intrinsics.checkNotNullParameter(file0, "$this$resolve");
    ...
    public static final File resolveSibling(File file0, File file1) {
        Intrinsics.checkNotNullParameter(file0, "$this$resolveSibling");
        Intrinsics.checkNotNullParameter(file1, "relative");
        FilePathComponents filePathComponents0 = FilesKt.toComponents(file0);
    ...
    public static final boolean startsWith(File file0, File file1) {
        Intrinsics.checkNotNullParameter(file0, "$this$startsWith");
        Intrinsics.checkNotNullParameter(file1, "other");
        FilePathComponents filePathComponents0 = FilesKt.toComponents(file0);
        FilePathComponents filePathComponents1 = FilesKt.toComponents(file1);
        if(!Intrinsics.areEqual(filePathComponents0.getRoot(), filePathComponents1.getRoot()) != 0) {
            return false;
        }
    ...
    public static final String toRelativeString(File file0, File file1) {
        Intrinsics.checkNotNullParameter(file0, "$this$toRelativeString");
        Intrinsics.checkNotNullParameter(file1, "base");
        String s = FilesKt__UtilsKt.toRelativeStringOrNull$FilesKt__UtilsKt(file0, file1);
        if(s == null) {
    ...
    private static final String toRelativeStringOrNull$FilesKt__UtilsKt(File file0, File file1) {
        ...
        int v3;
        for(v3 = 0; v3 < v2 && Intrinsics.areEqual(((File)filePathComponents0.getSegments().get(v3)), ((File)filePathComponents1.getSegments().get(v3))); ++v3) {
        }
