...
public final class UnsignedKt {
    ...
    public static final String ulongToString(long v, int v1) {
        ...
        Intrinsics.checkNotNullExpressionValue(s1, "java.lang.Long.toString(this, checkRadix(radix))");
        String s2 = Long.toString(v3, CharsKt.checkRadix(v1));
        Intrinsics.checkNotNullExpressionValue(s2, "java.lang.Long.toString(this, checkRadix(radix))");
        return s1 + s2;
    }
}
