...
public final class PlatformRandomKt {
    public static final Random asJavaRandom(kotlin.random.Random random0) {
        Intrinsics.checkNotNullParameter(random0, "$this$asJavaRandom");
        kotlin.random.Random random1 = random0 instanceof AbstractPlatformRandom ? random0 : null;
        if(((AbstractPlatformRandom)random1) != null) {
            Random random2 = ((AbstractPlatformRandom)random1).getImpl();
            if(random2 != null) {
                return random2;
            }
        }
    ...
    public static final kotlin.random.Random asKotlinRandom(Random random0) {
        Intrinsics.checkNotNullParameter(random0, "$this$asKotlinRandom");
        Random random1 = random0 instanceof KotlinRandom ? random0 : null;
        if(((KotlinRandom)random1) != null) {
            kotlin.random.Random random2 = ((KotlinRandom)random1).getImpl();
            if(random2 != null) {
                return random2;
            }
        }
