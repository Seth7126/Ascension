...
public abstract class Random {
    ...
    public byte[] nextBytes(byte[] arr_b, int v, int v1) {
        Intrinsics.checkNotNullParameter(arr_b, "array");
        if(v < 0 || arr_b.length < v || v1 < 0 || arr_b.length < v1) {
    ...
    public long nextLong(long v, long v1) {
        ...
        if(v2 > 0L) {
            if((-v2 & v2) == v2) {
                ...
                return ((int)(v2 >>> 0x20)) == 1 ? v + (((long)this.nextInt()) & 0xFFFFFFFFL) : v + ((((long)this.nextBits(RandomKt.fastLog2(((int)(v2 >>> 0x20))))) << 0x20) + ((long)this.nextInt()));
            }
            do {
