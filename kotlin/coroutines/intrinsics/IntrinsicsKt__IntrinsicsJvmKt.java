...
class IntrinsicsKt__IntrinsicsJvmKt {
    ...
    public static final Continuation createCoroutineUnintercepted(Function1 function10, Continuation continuation0) {
        Intrinsics.checkNotNullParameter(function10, "$this$createCoroutineUnintercepted");
    ...
    public static final Continuation createCoroutineUnintercepted(Function2 function20, Object object0, Continuation continuation0) {
        Intrinsics.checkNotNullParameter(function20, "$this$createCoroutineUnintercepted");
        Intrinsics.checkNotNullParameter(continuation0, "completion");
        Continuation continuation1 = DebugProbesKt.probeCoroutineCreated(continuation0);
    ...
    public static final Continuation intercepted(Continuation continuation0) {
        Intrinsics.checkNotNullParameter(continuation0, "$this$intercepted");
        Continuation continuation1 = continuation0 instanceof ContinuationImpl ? continuation0 : null;
        if(((ContinuationImpl)continuation1) != null) {
            Continuation continuation2 = ((ContinuationImpl)continuation1).intercepted();
            return continuation2 == null ? continuation0 : continuation2;
        }
