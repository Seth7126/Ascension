...
public abstract class BaseContinuationImpl implements Serializable, Continuation, CoroutineStackFrame {
    ...
    public CoroutineStackFrame getCallerFrame() {
        return (CoroutineStackFrame)(this.completion instanceof CoroutineStackFrame ? this.completion : null);
    }
    ...
    public final void resumeWith(Object object0) {
        ...
        while(true) {
            ...
            continuation0 = this.completion;
            Intrinsics.checkNotNull(continuation0);
            try {
                Object object1 = this.invokeSuspend(object0);
            ...
            if(!(continuation0 instanceof BaseContinuationImpl)) {
                break;
            }
            this = (BaseContinuationImpl)continuation0;
        }
