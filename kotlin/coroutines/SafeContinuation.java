...
public final class SafeContinuation implements Continuation, CoroutineStackFrame {
    ...
    public CoroutineStackFrame getCallerFrame() {
        return (CoroutineStackFrame)(this.delegate instanceof CoroutineStackFrame ? this.delegate : null);
    }
    ...
    public final Object getOrThrow() {
        ...
        if(object0 == CoroutineSingletons.UNDECIDED) {
            ...
            if(PainterModifier..ExternalSyntheticBackport0.m(SafeContinuation.RESULT, this, CoroutineSingletons.UNDECIDED, object1)) {
    ...
    public void resumeWith(Object object0) {
        while(true) {
            ...
            while((object1 = this.result) == CoroutineSingletons.UNDECIDED) {
                if(PainterModifier..ExternalSyntheticBackport0.m(SafeContinuation.RESULT, this, CoroutineSingletons.UNDECIDED, object0)) {
                    return;
                }
            }
            ...
            if(PainterModifier..ExternalSyntheticBackport0.m(SafeContinuation.RESULT, this, object2, CoroutineSingletons.RESUMED)) {
