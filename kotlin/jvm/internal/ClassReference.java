        ...
        public final String getClassQualifiedName(Class class0) {
            ...
            if(!class0.isAnonymousClass() && !class0.isLocalClass()) {
                if(class0.isArray()) {
                    ...
                    Intrinsics.checkNotNullExpressionValue(class1, "componentType");
                ...
                if(class0.isLocalClass()) {
                    ...
                    label_10:
                        ...
                        if(constructor0 == null) {
                            ...
                            s2 = StringsKt.substringAfter$default(s1, constructor0.getName() + "$", null, 2, null);
                        }
                    }
                    else {
                        Intrinsics.checkNotNullExpressionValue(s1, "name");
                        s2 = StringsKt.substringAfter$default(s1, method0.getName() + "$", null, 2, null);
                        if(s2 == null) {
                            goto label_10;
                        }
                    }
