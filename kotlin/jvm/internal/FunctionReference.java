...
public class FunctionReference extends CallableReference implements FunctionBase, KFunction {
    ...
    public boolean equals(Object object0) {
        ...
        if(object0 instanceof FunctionReference) {
            return Intrinsics.areEqual(this.getOwner(), ((FunctionReference)object0).getOwner()) && this.getName().equals(((FunctionReference)object0).getName()) && this.getSignature().equals(((FunctionReference)object0).getSignature()) && this.flags == ((FunctionReference)object0).flags && this.arity == ((FunctionReference)object0).arity && Intrinsics.areEqual(this.getBoundReceiver(), ((FunctionReference)object0).getBoundReceiver());
        }
