...
public interface KParameter extends KAnnotatedElement {
    ...
    public static final class Kind extends Enum {
        ...
        static {
            Kind[] arr_kParameter$Kind = new Kind[3];
            Kind.INSTANCE = new Kind("INSTANCE", 0);
            arr_kParameter$Kind[0] = Kind.INSTANCE;
            Kind.EXTENSION_RECEIVER = new Kind("EXTENSION_RECEIVER", 1);
            arr_kParameter$Kind[1] = Kind.EXTENSION_RECEIVER;
            Kind.VALUE = new Kind("VALUE", 2);
            arr_kParameter$Kind[2] = Kind.VALUE;
