...
public final class KTypeProjection {
    ...
    public boolean equals(Object object0) {
        return this == object0 || object0 instanceof KTypeProjection && Intrinsics.areEqual(this.variance, ((KTypeProjection)object0).variance) && Intrinsics.areEqual(this.type, ((KTypeProjection)object0).type);
    }
    ...
    public String toString() {
        KVariance kVariance0 = this.variance;
        if(kVariance0 == null) {
            return "*";
        }
        switch(KTypeProjection.WhenMappings.$EnumSwitchMapping$0[kVariance0.ordinal()]) {
            case 1: {
