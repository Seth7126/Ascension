...
class SequencesKt__SequencesKt extends SequencesKt__SequencesJVMKt {
    ...
    public static final Sequence asSequence(Iterator iterator0) {
        Intrinsics.checkNotNullParameter(iterator0, "$this$asSequence");
    ...
    public static final Sequence constrainOnce(Sequence sequence0) {
        Intrinsics.checkNotNullParameter(sequence0, "$this$constrainOnce");
    ...
    public static final Sequence flatMapIndexed(Sequence sequence0, Function2 function20, Function1 function10) {
        ...
        return SequencesKt.sequence(new Function2(sequence0, function20, function10, null) {
            ...
            public final Continuation create(Object object0, Continuation continuation0) {
                ...
                Continuation continuation1 = new kotlin.sequences.SequencesKt__SequencesKt.flatMapIndexed.1(this.$source, this.$transform, this.$iterator, continuation0);
            ...
            public final Object invoke(Object object0, Object object1) {
                return ((kotlin.sequences.SequencesKt__SequencesKt.flatMapIndexed.1)this.create(object0, ((Continuation)object1))).invokeSuspend(Unit.INSTANCE);
            }
    ...
    public static final Sequence flatten(Sequence sequence0) {
        Intrinsics.checkNotNullParameter(sequence0, "$this$flatten");
    ...
    public static final Sequence ifEmpty(Sequence sequence0, Function0 function00) {
        Intrinsics.checkNotNullParameter(sequence0, "$this$ifEmpty");
        ...
        return SequencesKt.sequence(new Function2(sequence0, function00, null) {
            ...
            public final Continuation create(Object object0, Continuation continuation0) {
                Intrinsics.checkNotNullParameter(continuation0, "completion");
                Continuation continuation1 = new kotlin.sequences.SequencesKt__SequencesKt.ifEmpty.1(this.$this_ifEmpty, this.$defaultValue, continuation0);
                continuation1.L$0 = object0;
                return continuation1;
            }
            ...
            @Override  // kotlin.jvm.functions.Function2
            public final Object invoke(Object object0, Object object1) {
                return ((kotlin.sequences.SequencesKt__SequencesKt.ifEmpty.1)this.create(object0, ((Continuation)object1))).invokeSuspend(Unit.INSTANCE);
            }
    ...
    public static final Sequence shuffled(Sequence sequence0) {
        Intrinsics.checkNotNullParameter(sequence0, "$this$shuffled");
    ...
    public static final Sequence shuffled(Sequence sequence0, Random random0) {
        ...
        return SequencesKt.sequence(new Function2(sequence0, random0, null) {
            ...
            public final Continuation create(Object object0, Continuation continuation0) {
                Intrinsics.checkNotNullParameter(continuation0, "completion");
                Continuation continuation1 = new kotlin.sequences.SequencesKt__SequencesKt.shuffled.1(this.$this_shuffled, this.$random, continuation0);
                continuation1.L$0 = object0;
                return continuation1;
            }
            ...
            @Override  // kotlin.jvm.functions.Function2
            public final Object invoke(Object object0, Object object1) {
                return ((kotlin.sequences.SequencesKt__SequencesKt.shuffled.1)this.create(object0, ((Continuation)object1))).invokeSuspend(Unit.INSTANCE);
            }
    ...
    public static final Pair unzip(Sequence sequence0) {
        Intrinsics.checkNotNullParameter(sequence0, "$this$unzip");
