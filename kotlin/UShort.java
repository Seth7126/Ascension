...
public final class UShort implements Comparable {
    ...
    public int compareTo(Object object0) {
        return this.compareTo-xj2QHRw(((UShort)object0).unbox-impl());
    }
    ...
    private int compareTo-xj2QHRw(short v) {
        return UShort.compareTo-xj2QHRw(this.data, v);
    }
    ...
    public static boolean equals-impl(short v, Object object0) {
        return object0 instanceof UShort && v == ((UShort)object0).unbox-impl();
    }
    ...
    private static final int floorDiv-7apg3OU(short v, byte b) {
        return UnsignedKt.uintDivide-J1ME1BU(UInt.constructor-impl(v & 0xFFFF), UInt.constructor-impl(b & 0xFF));
    }
    ...
    private static final int mod-WZ4Q5Ns(short v, int v1) {
        return UnsignedKt.uintRemainder-J1ME1BU(UInt.constructor-impl(v & 0xFFFF), v1);
    }
