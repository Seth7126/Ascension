...
public abstract class EventLoopImplBase extends EventLoopImplPlatform implements Delay {
    ...
    @Metadata(d1 = {"\u0000(\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\t\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\u0002\n\u0000\n\u0002\u0010\u000E\n\u0000\b\u0002\u0018\u00002\u00020\u0001B\u0019\u0012\u0006\u0010\u0002\u001A\u00020\u0003\u0012\n\u0010\u0004\u001A\u00060\u0005j\u0002`\u0006¢\u0006\u0002\u0010\u0007J\b\u0010\b\u001A\u00020\tH\u0016J\b\u0010\n\u001A\u00020\u000BH\u0016R\u0012\u0010\u0004\u001A\u00060\u0005j\u0002`\u0006X\u0082\u0004¢\u0006\u0002\n\u0000¨\u0006\f"}, d2 = {"Lkotlinx/coroutines/EventLoopImplBase$DelayedRunnableTask;", "Lkotlinx/coroutines/EventLoopImplBase$DelayedTask;", "nanoTime", "", "block", "Ljava/lang/Runnable;", "Lkotlinx/coroutines/Runnable;", "(JLjava/lang/Runnable;)V", "run", "", "toString", "", "kotlinx-coroutines-core"}, k = 1, mv = {1, 5, 1}, xi = 0x30)
    ...
    @Metadata(d1 = {"\u0000\u0016\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\t\n\u0002\b\u0002\b\u0000\u0018\u00002\b\u0012\u0004\u0012\u00020\u00020\u0001B\r\u0012\u0006\u0010\u0003\u001A\u00020\u0004¢\u0006\u0002\u0010\u0005R\u0012\u0010\u0003\u001A\u00020\u00048\u0006@\u0006X\u0087\u000E¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"Lkotlinx/coroutines/EventLoopImplBase$DelayedTaskQueue;", "Lkotlinx/coroutines/internal/ThreadSafeHeap;", "Lkotlinx/coroutines/EventLoopImplBase$DelayedTask;", "timeNow", "", "(J)V", "kotlinx-coroutines-core"}, k = 1, mv = {1, 5, 1}, xi = 0x30)
    ...
    private final void closeQueue() {
        ...
        while(true) {
            while(true) {
                ...
                if(PainterModifier..ExternalSyntheticBackport0.m(EventLoopImplBase._queue$FU, this, null, EventLoop_commonKt.access$getCLOSED_EMPTY$p())) {
                    return;
                }
            }
            ...
            if(PainterModifier..ExternalSyntheticBackport0.m(EventLoopImplBase._queue$FU, this, object0, lockFreeTaskQueueCore0)) {
                return;
            }
        }
    ...
    private final Runnable dequeue() {
        ...
        while(true) {
            ...
            if(object0 instanceof LockFreeTaskQueueCore) {
                ...
                PainterModifier..ExternalSyntheticBackport0.m(EventLoopImplBase._queue$FU, this, object0, lockFreeTaskQueueCore0);
            }
            else {
                if(object0 == EventLoop_commonKt.access$getCLOSED_EMPTY$p()) {
                    return null;
                }
                if(PainterModifier..ExternalSyntheticBackport0.m(EventLoopImplBase._queue$FU, this, object0, null)) {
                    break;
                }
            }
        }
    ...
    public final void enqueue(Runnable runnable0) {
    ...
    private final boolean enqueueImpl(Runnable runnable0) {
        ...
        alab1:
            while(true) {
                ...
                label_0:
                    ...
                    if(PainterModifier..ExternalSyntheticBackport0.m(EventLoopImplBase._queue$FU, this, null, runnable0)) {
                        return true;
                    }
                }
                if(!(object0 instanceof LockFreeTaskQueueCore)) {
        ...
        label_19:
            ...
            if(PainterModifier..ExternalSyntheticBackport0.m(EventLoopImplBase._queue$FU, this, object0, lockFreeTaskQueueCore1)) {
                return true;
            }
        }
        throw new NullPointerException("null cannot be cast to non-null type java.lang.Runnable{ kotlinx.coroutines.RunnableKt.Runnable }");
    ...
    protected long getNextTime() {
        ...
        DelayedTask eventLoopImplBase$DelayedTask0 = eventLoopImplBase$DelayedTaskQueue0 == null ? null : ((DelayedTask)eventLoopImplBase$DelayedTaskQueue0.peek());
        if(eventLoopImplBase$DelayedTask0 == null) {
    ...
    private final void rescheduleAllDelayed() {
        ...
        while(true) {
            DelayedTaskQueue eventLoopImplBase$DelayedTaskQueue0 = (DelayedTaskQueue)this._delayed;
            DelayedTask eventLoopImplBase$DelayedTask0 = eventLoopImplBase$DelayedTaskQueue0 == null ? null : ((DelayedTask)eventLoopImplBase$DelayedTaskQueue0.removeFirstOrNull());
            if(eventLoopImplBase$DelayedTask0 == null) {
                break;
            }
    ...
    private final int scheduleImpl(long v, DelayedTask eventLoopImplBase$DelayedTask0) {
        ...
        if(eventLoopImplBase$DelayedTaskQueue0 == null) {
            ...
            PainterModifier..ExternalSyntheticBackport0.m(EventLoopImplBase._delayed$FU, this, null, eventLoopImplBase$DelayedTaskQueue1);
            eventLoopImplBase$DelayedTaskQueue0 = (DelayedTaskQueue)this._delayed;
            Intrinsics.checkNotNull(eventLoopImplBase$DelayedTaskQueue0);
        }
