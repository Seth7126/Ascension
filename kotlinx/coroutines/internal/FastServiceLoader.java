...
public final class FastServiceLoader {
    ...
    public final List loadMainDispatcherFactory$kotlinx_coroutines_core() {
        ...
        try {
            ...
            try {
                ...
                mainDispatcherFactory1 = (MainDispatcherFactory)class0.cast(Class.forName("kotlinx.coroutines.android.AndroidDispatcherFactory", true, class0.getClassLoader()).getDeclaredConstructor().newInstance());
            }
            catch(ClassNotFoundException unused_ex) {
            }
            ...
            try {
                mainDispatcherFactory0 = (MainDispatcherFactory)class0.cast(Class.forName("kotlinx.coroutines.test.internal.TestMainDispatcherFactory", true, class0.getClassLoader()).getDeclaredConstructor().newInstance());
            }
            catch(ClassNotFoundException unused_ex) {
            }
    ...
    public final List loadProviders$kotlinx_coroutines_core(Class class0, ClassLoader classLoader0) {
        ArrayList arrayList0 = Collections.list(classLoader0.getResources(Intrinsics.stringPlus("META-INF/services/", class0.getName())));
        Intrinsics.checkNotNullExpressionValue(arrayList0, "java.util.Collections.list(this)");
    ...
    private final List parseFile(BufferedReader bufferedReader0) {
        ...
        while(true) {
            ...
            String s1 = StringsKt.substringBefore$default(s, "#", null, 2, null);
            if(s1 == null) {
                break;
            }
            ...
            if(!z) {
                throw new IllegalArgumentException(("Illegal service provider class name: " + s2).toString());
            }
