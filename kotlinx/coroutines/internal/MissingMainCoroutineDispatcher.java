...
final class MissingMainCoroutineDispatcher extends MainCoroutineDispatcher implements Delay {
    ...
    private final Void missing() {
        if(this.cause != null) {
            throw new IllegalStateException("Module with the Main dispatcher had failed to initialize" + (this.errorHint == null || ". " + this.errorHint == null ? "" : ". " + this.errorHint), this.cause);
        }
