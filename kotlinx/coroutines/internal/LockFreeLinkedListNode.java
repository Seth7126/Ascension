...
public class LockFreeLinkedListNode {
    ...
    public static abstract class AbstractAtomicDesc extends AtomicDesc {
        ...
        public final void complete(AtomicOp atomicOp0, Object object0) {
            ...
            if(PainterModifier..ExternalSyntheticBackport0.m(LockFreeLinkedListNode._next$FU, lockFreeLinkedListNode0, atomicOp0, lockFreeLinkedListNode2) && object0 == null) {
        ...
        public final Object prepare(AtomicOp atomicOp0) {
            ...
            while(true) {
                while(true) {
                    ...
                    if(!PainterModifier..ExternalSyntheticBackport0.m(LockFreeLinkedListNode._next$FU, lockFreeLinkedListNode0, object0, lockFreeLinkedListNode$PrepareOp0)) {
                        goto label_0;
                    }
                    break;
                }
            ...
            PainterModifier..ExternalSyntheticBackport0.m(LockFreeLinkedListNode._next$FU, lockFreeLinkedListNode0, lockFreeLinkedListNode$PrepareOp0, object0);
            throw throwable0;
        }
    ...
    public static class AddLastDesc extends AbstractAtomicDesc {
        ...
        static {
            AddLastDesc._affectedNode$FU = AtomicReferenceFieldUpdater.newUpdater(AddLastDesc.class, Object.class, "_affectedNode");
        }
        ...
        public void finishPrepare(PrepareOp lockFreeLinkedListNode$PrepareOp0) {
            PainterModifier..ExternalSyntheticBackport0.m(AddLastDesc._affectedNode$FU, this, null, lockFreeLinkedListNode$PrepareOp0.affected);
        }
        ...
        public Object updatedNext(LockFreeLinkedListNode lockFreeLinkedListNode0, LockFreeLinkedListNode lockFreeLinkedListNode1) {
            PainterModifier..ExternalSyntheticBackport0.m(LockFreeLinkedListNode._prev$FU, this.node, this.node, lockFreeLinkedListNode0);
            PainterModifier..ExternalSyntheticBackport0.m(LockFreeLinkedListNode._next$FU, this.node, this.node, this.queue);
            return this.node;
        }
    }

    @Metadata(d1 = {"\u0000\"\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\n\u0002\u0010\u0002\n\u0002\b\u0002\n\u0002\u0010\u0000\n\u0000\b!\u0018\u00002\f\u0012\b\u0012\u00060\u0002j\u0002`\u00030\u0001B\u0011\u0012\n\u0010\u0004\u001A\u00060\u0002j\u0002`\u0003¢\u0006\u0002\u0010\u0005J\u001E\u0010\u0007\u001A\u00020\b2\n\u0010\t\u001A\u00060\u0002j\u0002`\u00032\b\u0010\n\u001A\u0004\u0018\u00010\u000BH\u0016R\u0014\u0010\u0004\u001A\u00060\u0002j\u0002`\u00038\u0006X\u0087\u0004¢\u0006\u0002\n\u0000R\u001A\u0010\u0006\u001A\n\u0018\u00010\u0002j\u0004\u0018\u0001`\u00038\u0006@\u0006X\u0087\u000E¢\u0006\u0002\n\u0000¨\u0006\f"}, d2 = {"Lkotlinx/coroutines/internal/LockFreeLinkedListNode$CondAddOp;", "Lkotlinx/coroutines/internal/AtomicOp;", "Lkotlinx/coroutines/internal/LockFreeLinkedListNode;", "Lkotlinx/coroutines/internal/Node;", "newNode", "(Lkotlinx/coroutines/internal/LockFreeLinkedListNode;)V", "oldNext", "complete", "", "affected", "failure", "", "kotlinx-coroutines-core"}, k = 1, mv = {1, 5, 1}, xi = 0x30)
    public static abstract class CondAddOp extends AtomicOp {
        ...
        public void complete(LockFreeLinkedListNode lockFreeLinkedListNode0, Object object0) {
            ...
            if(lockFreeLinkedListNode1 != null && PainterModifier..ExternalSyntheticBackport0.m(LockFreeLinkedListNode._next$FU, lockFreeLinkedListNode0, this, lockFreeLinkedListNode1) && object0 == null) {
    ...
    public static final class PrepareOp extends OpDescriptor {
        ...
        public Object perform(Object object0) {
            ...
            if(object1 == LockFreeLinkedList_commonKt.REMOVE_PREPARED) {
                ...
                if(PainterModifier..ExternalSyntheticBackport0.m(LockFreeLinkedListNode._next$FU, ((LockFreeLinkedListNode)object0), this, removed0)) {
            ...
            PainterModifier..ExternalSyntheticBackport0.m(LockFreeLinkedListNode._next$FU, ((LockFreeLinkedListNode)object0), this, object3);
            return null;
        }
    ...
    public static class RemoveFirstDesc extends AbstractAtomicDesc {
        ...
        static {
            RemoveFirstDesc._affectedNode$FU = AtomicReferenceFieldUpdater.newUpdater(RemoveFirstDesc.class, Object.class, "_affectedNode");
            RemoveFirstDesc._originalNext$FU = AtomicReferenceFieldUpdater.newUpdater(RemoveFirstDesc.class, Object.class, "_originalNext");
        }
        ...
        @Override  // kotlinx.coroutines.internal.LockFreeLinkedListNode$AbstractAtomicDesc
        public void finishPrepare(PrepareOp lockFreeLinkedListNode$PrepareOp0) {
            PainterModifier..ExternalSyntheticBackport0.m(RemoveFirstDesc._affectedNode$FU, this, null, lockFreeLinkedListNode$PrepareOp0.affected);
            PainterModifier..ExternalSyntheticBackport0.m(RemoveFirstDesc._originalNext$FU, this, null, lockFreeLinkedListNode$PrepareOp0.next);
        }
    ...
    public final boolean addLastIf(LockFreeLinkedListNode lockFreeLinkedListNode0, Function0 function00) {
        CondAddOp lockFreeLinkedListNode$CondAddOp0 = new kotlinx.coroutines.internal.LockFreeLinkedListNode.makeCondAddOp.1(function00, lockFreeLinkedListNode0);
    alab1:
        while(true) {
    ...
    public final boolean addNext(LockFreeLinkedListNode lockFreeLinkedListNode0, LockFreeLinkedListNode lockFreeLinkedListNode1) {
        ...
        if(!PainterModifier..ExternalSyntheticBackport0.m(LockFreeLinkedListNode._next$FU, this, lockFreeLinkedListNode1, lockFreeLinkedListNode0)) {
            return false;
        }
    ...
    public final boolean addOneIfEmpty(LockFreeLinkedListNode lockFreeLinkedListNode0) {
        ...
        while(!PainterModifier..ExternalSyntheticBackport0.m(LockFreeLinkedListNode._next$FU, this, this, lockFreeLinkedListNode0));
    ...
    private final LockFreeLinkedListNode correctPrev(OpDescriptor opDescriptor0) {
        ...
        while(true) {
            ...
            label_3:
                ...
                if(!PainterModifier..ExternalSyntheticBackport0.m(LockFreeLinkedListNode._prev$FU, this, lockFreeLinkedListNode0, lockFreeLinkedListNode1)) {
                    continue;
                }
                return lockFreeLinkedListNode1;
            }
            ...
            if(!PainterModifier..ExternalSyntheticBackport0.m(LockFreeLinkedListNode._next$FU, lockFreeLinkedListNode2, lockFreeLinkedListNode1, ((Removed)object0).ref)) {
                goto label_0;
            }
    ...
    private final void finishAdd(LockFreeLinkedListNode lockFreeLinkedListNode0) {
        ...
        while(!PainterModifier..ExternalSyntheticBackport0.m(LockFreeLinkedListNode._prev$FU, lockFreeLinkedListNode0, lockFreeLinkedListNode1, this));
        if(this.isRemoved()) {
            lockFreeLinkedListNode0.correctPrev(null);
        }
    }
    ...
    public final void helpRemove() {
        ((Removed)this.getNext()).ref.correctPrev(null);
    }
    ...
    public final CondAddOp makeCondAddOp(LockFreeLinkedListNode lockFreeLinkedListNode0, Function0 function00) {
        return new CondAddOp(/*ERROR_MISSING_ARG_1/*) {
            @Override  // kotlinx.coroutines.internal.AtomicOp
            ...
            public Object prepare(LockFreeLinkedListNode lockFreeLinkedListNode0) {
                return ((Boolean)lockFreeLinkedListNode0.invoke()).booleanValue() ? null : LockFreeLinkedListKt.getCONDITION_FALSE();
            }
        };
    }
    ...
    public final LockFreeLinkedListNode removeOrNext() {
        ...
        while(!PainterModifier..ExternalSyntheticBackport0.m(LockFreeLinkedListNode._next$FU, this, object0, removed0));
    ...
    public final int tryCondAddNext(LockFreeLinkedListNode lockFreeLinkedListNode0, LockFreeLinkedListNode lockFreeLinkedListNode1, CondAddOp lockFreeLinkedListNode$CondAddOp0) {
        ...
        if(!PainterModifier..ExternalSyntheticBackport0.m(LockFreeLinkedListNode._next$FU, this, lockFreeLinkedListNode1, lockFreeLinkedListNode$CondAddOp0)) {
            return 0;
        }
