...
public final class InlineList {
    ...
    public boolean equals(Object object0) {
        return InlineList.equals-impl(this.unbox-impl(), object0);
    }
    ...
    @Override
    public int hashCode() {
        return InlineList.hashCode-impl(this.unbox-impl());
    }
    ...
    public String toString() {
        return "InlineList(holder=" + this.unbox-impl() + ')';
    }
