...
public final class SegmentOrClosed {
    ...
    public boolean equals(Object object0) {
        return SegmentOrClosed.equals-impl(this.unbox-impl(), object0);
    }
    ...
    @Override
    public int hashCode() {
        return SegmentOrClosed.hashCode-impl(this.unbox-impl());
    }
    ...
    public String toString() {
        return "SegmentOrClosed(value=" + this.unbox-impl() + ')';
    }
