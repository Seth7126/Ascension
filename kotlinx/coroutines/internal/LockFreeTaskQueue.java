        ...
        while(true) {
            ...
            switch(v) {
                ...
                case 1: {
                    ...
                    PainterModifier..ExternalSyntheticBackport0.m(LockFreeTaskQueue._cur$FU, this, lockFreeTaskQueueCore0, lockFreeTaskQueueCore1);
                    break;
                }
                default: {
                    goto label_5;
