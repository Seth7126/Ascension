...
public final class ConcurrentWeakMap extends AbstractMutableMap {
    ...
    final class Core {
        ...
        final class KeyValueIterator implements Iterator, KMutableIterator {
            ...
            public Object next() {
                ...
                if(object0 != null) {
                    ...
                    if(object1 != null) {
                        Object object2 = function20.invoke(object0, object1);
                        this.findNext();
                        return object2;
                    }
        ...
        public final Object putImpl(Object object0, Object object1, HashedWeakRef hashedWeakRef0) {
            ...
            while(true) {
                ...
                if(hashedWeakRef1 == null) {
                    ...
                    if(!PainterModifier..ExternalSyntheticBackport0.m(this.keys, v, null, hashedWeakRef0)) {
                        continue;
                    }
                }
                else {
                ...
                while(!PainterModifier..ExternalSyntheticBackport0.m(this.values, v, object3, object1));
                return object3;
            label_25:
                if(object2 == null) {
                    this.removeCleanedAt(v);
        ...
        alab1:
            while(true) {
                ...
                for(int v2 = 0; true; ++v2) {
                    ...
                    while(!PainterModifier..ExternalSyntheticBackport0.m(this.values, v2, object1, ConcurrentWeakMapKt.mark(object1)));
        ...
        private final void removeCleanedAt(int v) {
            ...
            while(!PainterModifier..ExternalSyntheticBackport0.m(this.values, v, object0, null));
            ConcurrentWeakMap.this.decrementSize();
        }
    }

    @Metadata(d1 = {"\u0000\u0010\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\'\n\u0002\b\u000B\b\u0002\u0018\u0000*\u0004\b\u0002\u0010\u0001*\u0004\b\u0003\u0010\u00022\u000E\u0012\u0004\u0012\u0002H\u0001\u0012\u0004\u0012\u0002H\u00020\u0003B\u0015\u0012\u0006\u0010\u0004\u001A\u00028\u0002\u0012\u0006\u0010\u0005\u001A\u00028\u0003¢\u0006\u0002\u0010\u0006J\u0015\u0010\u000B\u001A\u00028\u00032\u0006\u0010\f\u001A\u00028\u0003H\u0016¢\u0006\u0002\u0010\rR\u0016\u0010\u0004\u001A\u00028\u0002X\u0096\u0004¢\u0006\n\n\u0002\u0010\t\u001A\u0004\b\u0007\u0010\bR\u0016\u0010\u0005\u001A\u00028\u0003X\u0096\u0004¢\u0006\n\n\u0002\u0010\t\u001A\u0004\b\n\u0010\b¨\u0006\u000E"}, d2 = {"Lkotlinx/coroutines/debug/internal/ConcurrentWeakMap$Entry;", "K", "V", "", "key", "value", "(Ljava/lang/Object;Ljava/lang/Object;)V", "getKey", "()Ljava/lang/Object;", "Ljava/lang/Object;", "getValue", "setValue", "newValue", "(Ljava/lang/Object;)Ljava/lang/Object;", "kotlinx-coroutines-core"}, k = 1, mv = {1, 5, 1}, xi = 0x30)
    ...
    private final Object putSynchronized(Object object0, Object object1) {
        synchronized(this) {
            ...
            Object object2;
            while((object2 = Core.putImpl$default(concurrentWeakMap$Core0, object0, object1, null, 4, null)) == ConcurrentWeakMapKt.access$getREHASH$p()) {
