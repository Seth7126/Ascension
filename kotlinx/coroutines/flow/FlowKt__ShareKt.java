...
final class FlowKt__ShareKt {
    ...
    private static final SharingConfig configureSharing$FlowKt__ShareKt(Flow flow0, int v) {
        int v1 = 1;
        int v2 = RangesKt.coerceAtLeast(v, 0x40) - v;
    ...
    private static final Job launchSharing$FlowKt__ShareKt(CoroutineScope coroutineScope0, CoroutineContext coroutineContext0, Flow flow0, MutableSharedFlow mutableSharedFlow0, SharingStarted sharingStarted0, Object object0) {
        return BuildersKt__Builders_commonKt.launch$default(coroutineScope0, coroutineContext0, null, new Function2(sharingStarted0, flow0, mutableSharedFlow0, object0, null) {
                ...
                switch(this.label) {
                    case 0: {
                        ...
                        try {
                            FlowCollector flowCollector0 = new FlowCollector() {
                                ...
                                public Object emit(Object object0, Continuation continuation0) {
                                    ...
                                    if(unit0 == null) {
                                        ...
                                        this.$result$inlined.complete(readonlyStateFlow0);
                            ...
                            this.label = 1;
                            return this.$upstream.collect(flowCollector0, this) == object1 ? object1 : Unit.INSTANCE;
                        label_10:
                            ResultKt.throwOnFailure(object0);
                            return Unit.INSTANCE;
                        }
