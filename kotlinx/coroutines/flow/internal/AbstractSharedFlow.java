...
public abstract class AbstractSharedFlow {
    ...
    protected final AbstractSharedFlowSlot allocateSlot() {
        ...
        synchronized(this) {
            ...
            this.nextIndex = v1;
            this.nCollectors = this.getNCollectors() + 1;
            mutableStateFlow0 = this._subscriptionCount;
        }
        if(mutableStateFlow0 != null) {
            StateFlowKt.increment(mutableStateFlow0, 1);
        }
    ...
    protected final void freeSlot(AbstractSharedFlowSlot abstractSharedFlowSlot0) {
        ...
        while(v1 < arr_continuation.length) {
            Continuation continuation0 = arr_continuation[v1];
            ++v1;
    ...
    public final StateFlow getSubscriptionCount() {
        synchronized(this) {
            MutableStateFlow mutableStateFlow0 = this._subscriptionCount;
            if(mutableStateFlow0 == null) {
                mutableStateFlow0 = StateFlowKt.MutableStateFlow(this.getNCollectors());
                this._subscriptionCount = mutableStateFlow0;
            }
            return mutableStateFlow0;
        }
    }
}
