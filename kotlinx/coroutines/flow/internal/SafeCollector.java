...
public final class SafeCollector extends ContinuationImpl implements CoroutineStackFrame, FlowCollector {
    ...
    public SafeCollector(FlowCollector flowCollector0, CoroutineContext coroutineContext0) {
        ...
        @Metadata(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0010\b\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\u0010\u0005\u001A\u00020\u0001\"\u0004\b\u0000\u0010\u00002\u0006\u0010\u0002\u001A\u00020\u00012\u0006\u0010\u0004\u001A\u00020\u0003H\n"}, d2 = {"T", "", "count", "Lkotlin/coroutines/CoroutineContext$Element;", "<anonymous parameter 1>", "<anonymous>"}, k = 3, mv = {1, 5, 1})
        final class kotlinx.coroutines.flow.internal.SafeCollector.collectContextSize.1 extends Lambda implements Function2 {
            ...
            public final int invoke(int v, Element coroutineContext$Element0) {
                return v + 1;
            }
    ...
    private final void checkContext(CoroutineContext coroutineContext0, CoroutineContext coroutineContext1, Object object0) {
        if(coroutineContext1 instanceof DownstreamExceptionElement) {
            this.exceptionTransparencyViolated(((DownstreamExceptionElement)coroutineContext1), object0);
        }
    ...
    private final Object emit(Continuation continuation0, Object object0) {
        ...
        return SafeCollectorKt.emitFun.invoke(this.collector, object0, this);
    }
    ...
    public Object emit(Object object0, Continuation continuation0) {
        ...
        try {
            ...
            this.lastEmissionContext = new DownstreamExceptionElement(throwable0);
            throw throwable0;
        }
    ...
    private final void exceptionTransparencyViolated(DownstreamExceptionElement downstreamExceptionElement0, Object object0) {
        throw new IllegalStateException(StringsKt.trimIndent(("\n            Flow exception transparency is violated:\n                Previous \'emit\' call has thrown exception " + downstreamExceptionElement0.e + ", but then emission attempt of value \'" + object0 + "\' has been detected.\n                Emissions from \'catch\' blocks are prohibited in order to avoid unspecified behaviour, \'Flow.catch\' operator can be used instead.\n                For a more detailed explanation, please refer to Flow documentation.\n            ")).toString());
    }
    ...
    public CoroutineContext getContext() {
        CoroutineContext coroutineContext0 = this.completion == null ? null : this.completion.getContext();
