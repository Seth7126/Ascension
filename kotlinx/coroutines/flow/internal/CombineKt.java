            ...
            public final Object invokeSuspend(Object object0) {
                                                ...
                                                try {
                                                    ...
                                                    FlowCollector flowCollector0 = new FlowCollector() {
                                                        ...
                                                        public Object emit(Object object0, Continuation continuation0) {
                                                            kotlinx.coroutines.flow.internal.CombineKt.combineInternal.2.1.invokeSuspend..inlined.collect.1.1 combineKt$combineInternal$2$1$invokeSuspend$$inlined$collect$1$10;
                                                            if(continuation0 instanceof kotlinx.coroutines.flow.internal.CombineKt.combineInternal.2.1.invokeSuspend..inlined.collect.1.1) {
                                                                combineKt$combineInternal$2$1$invokeSuspend$$inlined$collect$1$10 = (kotlinx.coroutines.flow.internal.CombineKt.combineInternal.2.1.invokeSuspend..inlined.collect.1.1)continuation0;
                                                                if((combineKt$combineInternal$2$1$invokeSuspend$$inlined$collect$1$10.label & 0x80000000) == 0) {
                                                                    combineKt$combineInternal$2$1$invokeSuspend$$inlined$collect$1$10 = new ContinuationImpl(/*ERROR_MISSING_ARG_1/*) {
                                                                        int label;
                                                                        Object result;
                                                                    ...
                                                                    combineKt$combineInternal$2$1$invokeSuspend$$inlined$collect$1$10.label ^= 0x80000000;
                                                                }
                                                            }
                                                            else {
                                                                combineKt$combineInternal$2$1$invokeSuspend$$inlined$collect$1$10 = new ContinuationImpl(/*ERROR_MISSING_ARG_1/*) {
                                                            ...
                                                            Object object1 = combineKt$combineInternal$2$1$invokeSuspend$$inlined$collect$1$10.result;
                                                            Object object2 = IntrinsicsKt.getCOROUTINE_SUSPENDED();
                                                            switch(combineKt$combineInternal$2$1$invokeSuspend$$inlined$collect$1$10.label) {
                                                                case 0: {
                                                                    ResultKt.throwOnFailure(object1);
                                                                    IndexedValue indexedValue0 = new IndexedValue(this.$i$inlined, object0);
                                                                    combineKt$combineInternal$2$1$invokeSuspend$$inlined$collect$1$10.label = 1;
                                                                    if(this.$i.send(indexedValue0, combineKt$combineInternal$2$1$invokeSuspend$$inlined$collect$1$10) == object2) {
                                                                        return object2;
                                                                    }
                                                                    break;
                                                                }
                                                            ...
                                                            combineKt$combineInternal$2$1$invokeSuspend$$inlined$collect$1$10.label = 2;
                                                            return YieldKt.yield(combineKt$combineInternal$2$1$invokeSuspend$$inlined$collect$1$10) == object2 ? object2 : Unit.INSTANCE;
                                                        }
                                                    };
                                                    this.label = 1;
                                                    if(flow0.collect(flowCollector0, this) == object1) {
                                                        return object1;
                                                    label_9:
                                                        ResultKt.throwOnFailure(object0);
                                                    }
                ...
                label_65:
                    ...
                    while(true) {
                        ...
                        Object object3 = arr_object[v7];
                        arr_object[v7] = indexedValue0.getValue();
                    ...
                    if(v2 == 0) {
                        ...
                        if(arr_object4 == null) {
                            ...
                            this.I$1 = v4;
                            this.label = 2;
                            if(this.$transform.invoke(this.$this_combineInternal, arr_object, this) == object1) {
                                return object1;
                            }
                        }
                        else {
                            ArraysKt.copyInto$default(arr_object, arr_object4, 0, 0, 0, 14, null);
                            this.L$0 = arr_object;
                            this.L$1 = channel1;
                            this.L$2 = arr_b;
                            this.I$0 = 0;
                                ...
                                switch(this.label) {
                                    case 0: {
                                        ...
                                        FlowCollector flowCollector0 = new FlowCollector() {
                                            @Override  // kotlinx.coroutines.flow.FlowCollector
                                            public Object emit(Object object0, Continuation continuation0) {
                                                SendChannel sendChannel0 = this.$$this$produce$inlined.getChannel();
                                                if(object0 == null) {
                                                    object0 = NullSurrogateKt.NULL;
                                                }
                                                Object object1 = sendChannel0.send(object0, continuation0);
                            ...
                            kotlinx.coroutines.flow.internal.CombineKt.zipImpl.1.1.2 combineKt$zipImpl$1$1$20 = new Function2(coroutineContext0, object2, receiveChannel0, this.$this_unsafeFlow, this.$transform, null) {
                                ...
                                public final Object invokeSuspend(Object object0) {
                                    ...
                                    switch(this.label) {
                                        case 0: {
                                            ResultKt.throwOnFailure(object0);
                                            kotlinx.coroutines.flow.internal.CombineKt.zipImpl.1.1.2.invokeSuspend..inlined.collect.1 combineKt$zipImpl$1$1$2$invokeSuspend$$inlined$collect$10 = new FlowCollector() {
                                                @Override  // kotlinx.coroutines.flow.FlowCollector
                                                public Object emit(Object object0, Continuation continuation0) {
                                                    kotlinx.coroutines.flow.internal.CombineKt.zipImpl.1.1.2.1.1 combineKt$zipImpl$1$1$2$1$10 = new kotlinx.coroutines.flow.internal.CombineKt.zipImpl.1.1.2.1.1(this.$this_unsafeFlow, this.$transform, this.$transform$inlined, object0, null);
                                                    Object object1 = ChannelFlowKt.withContextUndispatched(this.$cnt, Unit.INSTANCE, this.$second, combineKt$zipImpl$1$1$2$1$10, continuation0);
                                                    return object1 == IntrinsicsKt.getCOROUTINE_SUSPENDED() ? object1 : Unit.INSTANCE;
                                                }
                                            };
                                            this.label = 1;
                                            return this.$flow.collect(combineKt$zipImpl$1$1$2$invokeSuspend$$inlined$collect$10, this) == object1 ? object1 : Unit.INSTANCE;
                                        }
                                        case 1: {
                                            ResultKt.throwOnFailure(object0);
                                            return Unit.INSTANCE;
                                    ...
                                    @DebugMetadata(c = "kotlinx.coroutines.flow.internal.CombineKt$zipImpl$1$1$2$1$1", f = "Combine.kt", i = {}, l = {0x84, 0x87, 0x87}, m = "invokeSuspend", n = {}, s = {})
                                    final class kotlinx.coroutines.flow.internal.CombineKt.zipImpl.1.1.2.1.1 extends SuspendLambda implements Function2 {
                                        final ReceiveChannel $second;
                                        final FlowCollector $this_unsafeFlow;
                                        final Function3 $transform;
                                        final Object $value;
                                        ...
                                        kotlinx.coroutines.flow.internal.CombineKt.zipImpl.1.1.2.1.1(ReceiveChannel receiveChannel0, FlowCollector flowCollector0, Function3 function30, Object object0, Continuation continuation0) {
                                            this.$second = receiveChannel0;
                                            this.$this_unsafeFlow = flowCollector0;
                                            this.$transform = function30;
                                            this.$value = object0;
