        ...
        if(((Number)coroutineContext0.fold(0, new Function2(safeCollector0) {
            ...
            public final int invoke(int v, Element coroutineContext$Element0) {
                ...
                if(coroutineContext$Key0 != Job.Key) {
                    return coroutineContext$Element0 == coroutineContext$Element1 ? v + 1 : 0x80000000;
                }
                ...
                return ((Job)coroutineContext$Element1) == null ? v : v + 1;
            }
