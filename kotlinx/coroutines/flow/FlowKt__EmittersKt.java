...
final class FlowKt__EmittersKt {
    ...
    public static final Flow onEmpty(Flow flow0, Function2 function20) {
            ...
            public Object collect(FlowCollector flowCollector0, Continuation continuation0) {
                ...
                switch(flowKt__EmittersKt$onEmpty$$inlined$unsafeFlow$1$10.label) {
                    case 0: {
                        ...
                        FlowCollector flowCollector1 = new kotlinx.coroutines.flow.FlowKt__EmittersKt.onEmpty.lambda-5..inlined.collect.1(ref$BooleanRef0, flowCollector0);
                    ...
                    label_30:
                        if(ref$BooleanRef1.element) {
                            SafeCollector safeCollector0 = new SafeCollector(flowCollector2, flowKt__EmittersKt$onEmpty$$inlined$unsafeFlow$1$10.getContext());
                            try {
                    ...
                    case 2: {
                        safeCollector1 = (SafeCollector)flowKt__EmittersKt$onEmpty$$inlined$unsafeFlow$1$10.L$0;
                        try {
                            ResultKt.throwOnFailure(object0);
                            break;
                        }
        ...
        public final class kotlinx.coroutines.flow.FlowKt__EmittersKt.onEmpty.lambda-5..inlined.collect.1 implements FlowCollector {
            public kotlinx.coroutines.flow.FlowKt__EmittersKt.onEmpty.lambda-5..inlined.collect.1(BooleanRef ref$BooleanRef0, FlowCollector flowCollector0) {
            }
    ...
    public static final Flow transform(Flow flow0, Function3 function30) {
        return FlowKt.flow(new Function2(flow0, function30, null) {
                ...
                switch(this.label) {
                    case 0: {
                        ...
                        FlowCollector flowCollector0 = new FlowCollector() {
                            @Override  // kotlinx.coroutines.flow.FlowCollector
                            public Object emit(Object object0, Continuation continuation0) {
                                Object object1 = ((FlowCollector)this.L$0).invoke(this.$$this$flow$inlined, object0, continuation0);
                                return object1 == IntrinsicsKt.getCOROUTINE_SUSPENDED() ? object1 : Unit.INSTANCE;

                                @Metadata(k = 3, mv = {1, 5, 1}, xi = 0x30)
                                public final class kotlinx.coroutines.flow.FlowKt__EmittersKt.transform.1.invokeSuspend..inlined.collect.1.1 extends ContinuationImpl {
                                    int label;
                                    Object result;

                                    public kotlinx.coroutines.flow.FlowKt__EmittersKt.transform.1.invokeSuspend..inlined.collect.1.1(kotlinx.coroutines.flow.FlowKt__EmittersKt.transform.1.invokeSuspend..inlined.collect.1 flowKt__EmittersKt$transform$1$invokeSuspend$$inlined$collect$10, Continuation continuation0) {
                                    }
                                    ...
                                    public final Object invokeSuspend(Object object0) {
                                        this.result = object0;
                                        this.label |= 0x80000000;
                                        return kotlinx.coroutines.flow.FlowKt__EmittersKt.transform.1.invokeSuspend..inlined.collect.1.this.emit(null, this);
                                    }
                                }
                            ...
                            public Object emit$$forInline(Object object0, Continuation continuation0) {
                                new kotlinx.coroutines.flow.FlowKt__EmittersKt.transform.1.invokeSuspend..inlined.collect.1.1(this, continuation0);
                                ((FlowCollector)this.L$0).invoke(this.$$this$flow$inlined, object0, continuation0);
                                return Unit.INSTANCE;
                            }
                        };
                        this.label = 1;
                        return this.$this_transform.collect(flowCollector0, this) == object1 ? object1 : Unit.INSTANCE;
                    }
                    case 1: {
                        ResultKt.throwOnFailure(object0);
                        return Unit.INSTANCE;
            ...
            public final Object invokeSuspend$$forInline(Object object0) {
                FlowCollector flowCollector0 = new kotlinx.coroutines.flow.FlowKt__EmittersKt.transform.1.invokeSuspend..inlined.collect.1(this.$transform, ((FlowCollector)this.L$0));
                this.$this_transform.collect(flowCollector0, this);
                return Unit.INSTANCE;
            }
        });
    }
    ...
    public static final Flow unsafeTransform(Flow flow0, Function3 function30) {
        return new Flow() {
            @Override  // kotlinx.coroutines.flow.Flow
            public Object collect(FlowCollector flowCollector0, Continuation continuation0) {
                kotlinx.coroutines.flow.FlowKt__EmittersKt.unsafeTransform.lambda-1..inlined.collect.1 flowKt__EmittersKt$unsafeTransform$lambda-1$$inlined$collect$10 = new kotlinx.coroutines.flow.FlowKt__EmittersKt.unsafeTransform.lambda-1..inlined.collect.1(function30, flowCollector0);
                Object object0 = flow0.collect(flowKt__EmittersKt$unsafeTransform$lambda-1$$inlined$collect$10, continuation0);
            ...
            public Object collect$$forInline(FlowCollector flowCollector0, Continuation continuation0) {
                ...
                kotlinx.coroutines.flow.FlowKt__EmittersKt.unsafeTransform.lambda-1..inlined.collect.1 flowKt__EmittersKt$unsafeTransform$lambda-1$$inlined$collect$10 = new kotlinx.coroutines.flow.FlowKt__EmittersKt.unsafeTransform.lambda-1..inlined.collect.1(function30, flowCollector0);
                flow0.collect(flowKt__EmittersKt$unsafeTransform$lambda-1$$inlined$collect$10, continuation0);
                return Unit.INSTANCE;
            }
        };

        @Metadata(d1 = {"\u0000\u0013\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0003*\u0001\u0000\b\n\u0018\u00002\b\u0012\u0004\u0012\u00028\u00000\u0001J\u0019\u0010\u0002\u001A\u00020\u00032\u0006\u0010\u0004\u001A\u00028\u0000H\u0096@ø\u0001\u0000¢\u0006\u0002\u0010\u0005\u0082\u0002\u0004\n\u0002\b\u0019¨\u0006\u0006¸\u0006\u0000"}, d2 = {"kotlinx/coroutines/flow/FlowKt__CollectKt$collect$3", "Lkotlinx/coroutines/flow/FlowCollector;", "emit", "", "value", "(Ljava/lang/Object;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;", "kotlinx-coroutines-core"}, k = 1, mv = {1, 5, 1}, xi = 0x30)
        public final class kotlinx.coroutines.flow.FlowKt__EmittersKt.unsafeTransform.lambda-1..inlined.collect.1 implements FlowCollector {
            public kotlinx.coroutines.flow.FlowKt__EmittersKt.unsafeTransform.lambda-1..inlined.collect.1(Function3 function30, FlowCollector flowCollector0) {
            }

            @Override  // kotlinx.coroutines.flow.FlowCollector
            public Object emit(Object object0, Continuation continuation0) {
                Object object1 = this.$transform$inlined.invoke(this.$this_unsafeFlow$inlined, object0, continuation0);
                return object1 == IntrinsicsKt.getCOROUTINE_SUSPENDED() ? object1 : Unit.INSTANCE;

                @Metadata(k = 3, mv = {1, 5, 1}, xi = 0x30)
                public final class kotlinx.coroutines.flow.FlowKt__EmittersKt.unsafeTransform.lambda-1..inlined.collect.1.1 extends ContinuationImpl {
                    int label;
                    Object result;

                    public kotlinx.coroutines.flow.FlowKt__EmittersKt.unsafeTransform.lambda-1..inlined.collect.1.1(kotlinx.coroutines.flow.FlowKt__EmittersKt.unsafeTransform.lambda-1..inlined.collect.1 flowKt__EmittersKt$unsafeTransform$lambda-1$$inlined$collect$10, Continuation continuation0) {
                    }
                    ...
                    public final Object invokeSuspend(Object object0) {
                        this.result = object0;
                        this.label |= 0x80000000;
                        return kotlinx.coroutines.flow.FlowKt__EmittersKt.unsafeTransform.lambda-1..inlined.collect.1.this.emit(null, this);
                    }
                }
            ...
            public Object emit$$forInline(Object object0, Continuation continuation0) {
                new kotlinx.coroutines.flow.FlowKt__EmittersKt.unsafeTransform.lambda-1..inlined.collect.1.1(this, continuation0);
                this.$transform$inlined.invoke(this.$this_unsafeFlow$inlined, object0, continuation0);
                return Unit.INSTANCE;
            }
        }
