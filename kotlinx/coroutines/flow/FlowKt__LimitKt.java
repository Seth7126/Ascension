...
final class FlowKt__LimitKt {
    ...
    public static final Flow drop(Flow flow0, int v) {
        ...
        return new Flow() {
            ...
            public Object collect(FlowCollector flowCollector0, Continuation continuation0) {
                kotlinx.coroutines.flow.FlowKt__LimitKt.drop.lambda-2..inlined.collect.1 flowKt__LimitKt$drop$lambda-2$$inlined$collect$10 = new kotlinx.coroutines.flow.FlowKt__LimitKt.drop.lambda-2..inlined.collect.1(new IntRef(), v, flowCollector0);
                Object object0 = flow0.collect(flowKt__LimitKt$drop$lambda-2$$inlined$collect$10, continuation0);
        ...
        public final class kotlinx.coroutines.flow.FlowKt__LimitKt.drop.lambda-2..inlined.collect.1 implements FlowCollector {
            public kotlinx.coroutines.flow.FlowKt__LimitKt.drop.lambda-2..inlined.collect.1(IntRef ref$IntRef0, int v, FlowCollector flowCollector0) {
            }
    ...
    public static final Flow dropWhile(Flow flow0, Function2 function20) {
        return new Flow() {
            @Override  // kotlinx.coroutines.flow.Flow
            public Object collect(FlowCollector flowCollector0, Continuation continuation0) {
                kotlinx.coroutines.flow.FlowKt__LimitKt.dropWhile.lambda-4..inlined.collect.1 flowKt__LimitKt$dropWhile$lambda-4$$inlined$collect$10 = new kotlinx.coroutines.flow.FlowKt__LimitKt.dropWhile.lambda-4..inlined.collect.1(new BooleanRef(), flowCollector0, function20);
                Object object0 = flow0.collect(flowKt__LimitKt$dropWhile$lambda-4$$inlined$collect$10, continuation0);
                return object0 == IntrinsicsKt.getCOROUTINE_SUSPENDED() ? object0 : Unit.INSTANCE;
            }
        };

        @Metadata(d1 = {"\u0000\u0013\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0003*\u0001\u0000\b\n\u0018\u00002\b\u0012\u0004\u0012\u00028\u00000\u0001J\u0019\u0010\u0002\u001A\u00020\u00032\u0006\u0010\u0004\u001A\u00028\u0000H\u0096@ø\u0001\u0000¢\u0006\u0002\u0010\u0005\u0082\u0002\u0004\n\u0002\b\u0019¨\u0006\u0006¸\u0006\u0000"}, d2 = {"kotlinx/coroutines/flow/FlowKt__CollectKt$collect$3", "Lkotlinx/coroutines/flow/FlowCollector;", "emit", "", "value", "(Ljava/lang/Object;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;", "kotlinx-coroutines-core"}, k = 1, mv = {1, 5, 1}, xi = 0x30)
        public final class kotlinx.coroutines.flow.FlowKt__LimitKt.dropWhile.lambda-4..inlined.collect.1 implements FlowCollector {
            public kotlinx.coroutines.flow.FlowKt__LimitKt.dropWhile.lambda-4..inlined.collect.1(BooleanRef ref$BooleanRef0, FlowCollector flowCollector0, Function2 function20) {
            }

            @Override  // kotlinx.coroutines.flow.FlowCollector
            public Object emit(Object object0, Continuation continuation0) {
                kotlinx.coroutines.flow.FlowKt__LimitKt.dropWhile.lambda-4..inlined.collect.1 flowKt__LimitKt$dropWhile$lambda-4$$inlined$collect$10;
                kotlinx.coroutines.flow.FlowKt__LimitKt.dropWhile.lambda-4..inlined.collect.1.1 flowKt__LimitKt$dropWhile$lambda-4$$inlined$collect$1$10;
                if(continuation0 instanceof kotlinx.coroutines.flow.FlowKt__LimitKt.dropWhile.lambda-4..inlined.collect.1.1) {
                    flowKt__LimitKt$dropWhile$lambda-4$$inlined$collect$1$10 = (kotlinx.coroutines.flow.FlowKt__LimitKt.dropWhile.lambda-4..inlined.collect.1.1)continuation0;
                    if((flowKt__LimitKt$dropWhile$lambda-4$$inlined$collect$1$10.label & 0x80000000) == 0) {
                        flowKt__LimitKt$dropWhile$lambda-4$$inlined$collect$1$10 = new ContinuationImpl(/*ERROR_MISSING_ARG_1/*) {
                            Object L$0;
                            Object L$1;
                            int label;
                            Object result;
                        ...
                        flowKt__LimitKt$dropWhile$lambda-4$$inlined$collect$1$10.label ^= 0x80000000;
                    }
                }
                else {
                    flowKt__LimitKt$dropWhile$lambda-4$$inlined$collect$1$10 = new ContinuationImpl(/*ERROR_MISSING_ARG_1/*) {
                ...
                Object object1 = flowKt__LimitKt$dropWhile$lambda-4$$inlined$collect$1$10.result;
                Object object2 = IntrinsicsKt.getCOROUTINE_SUSPENDED();
                switch(flowKt__LimitKt$dropWhile$lambda-4$$inlined$collect$1$10.label) {
                    case 0: {
                        ResultKt.throwOnFailure(object1);
                        if(this.$matched$inlined.element) {
                            flowKt__LimitKt$dropWhile$lambda-4$$inlined$collect$1$10.label = 1;
                            if(this.$this_unsafeFlow$inlined.emit(object0, flowKt__LimitKt$dropWhile$lambda-4$$inlined$collect$1$10) == object2) {
                                return object2;
                            }
                        }
                        else {
                            flowKt__LimitKt$dropWhile$lambda-4$$inlined$collect$1$10.L$0 = this;
                            flowKt__LimitKt$dropWhile$lambda-4$$inlined$collect$1$10.L$1 = object0;
                            flowKt__LimitKt$dropWhile$lambda-4$$inlined$collect$1$10.label = 2;
                            object1 = this.$predicate$inlined.invoke(object0, flowKt__LimitKt$dropWhile$lambda-4$$inlined$collect$1$10);
                            if(object1 == object2) {
                                return object2;
                            }
                            flowKt__LimitKt$dropWhile$lambda-4$$inlined$collect$10 = this;
                            goto label_32;
                        }
                        break;
                    }
                    ...
                    case 2: {
                        object0 = flowKt__LimitKt$dropWhile$lambda-4$$inlined$collect$1$10.L$1;
                        flowKt__LimitKt$dropWhile$lambda-4$$inlined$collect$10 = (kotlinx.coroutines.flow.FlowKt__LimitKt.dropWhile.lambda-4..inlined.collect.1)flowKt__LimitKt$dropWhile$lambda-4$$inlined$collect$1$10.L$0;
                        ResultKt.throwOnFailure(object1);
                    label_32:
                        if(!((Boolean)object1).booleanValue()) {
                            flowKt__LimitKt$dropWhile$lambda-4$$inlined$collect$10.$matched$inlined.element = true;
                            flowKt__LimitKt$dropWhile$lambda-4$$inlined$collect$1$10.L$0 = null;
                            flowKt__LimitKt$dropWhile$lambda-4$$inlined$collect$1$10.L$1 = null;
                            flowKt__LimitKt$dropWhile$lambda-4$$inlined$collect$1$10.label = 3;
                            if(flowKt__LimitKt$dropWhile$lambda-4$$inlined$collect$10.$this_unsafeFlow$inlined.emit(object0, flowKt__LimitKt$dropWhile$lambda-4$$inlined$collect$1$10) == object2) {
                                return object2;
                            }
                        }
                        break;
    ...
    public static final Flow take(Flow flow0, int v) {
            ...
            public Object collect(FlowCollector flowCollector0, Continuation continuation0) {
                ...
                switch(flowKt__LimitKt$take$$inlined$unsafeFlow$1$10.label) {
                    case 0: {
                        ...
                        try {
                            kotlinx.coroutines.flow.FlowKt__LimitKt.take.lambda-7..inlined.collect.1 flowKt__LimitKt$take$lambda-7$$inlined$collect$10 = new kotlinx.coroutines.flow.FlowKt__LimitKt.take.lambda-7..inlined.collect.1(ref$IntRef0, v, flowCollector0);
                            flowKt__LimitKt$take$$inlined$unsafeFlow$1$10.L$0 = flowCollector0;
                            flowKt__LimitKt$take$$inlined$unsafeFlow$1$10.label = 1;
                            if(flow0.collect(flowKt__LimitKt$take$lambda-7$$inlined$collect$10, flowKt__LimitKt$take$$inlined$unsafeFlow$1$10) == object1) {
                                return object1;
                            }
                        }
                        catch(AbortFlowException abortFlowException0) {
        ...
        @Metadata(d1 = {"\u0000\u0013\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0003*\u0001\u0000\b\n\u0018\u00002\b\u0012\u0004\u0012\u00028\u00000\u0001J\u0019\u0010\u0002\u001A\u00020\u00032\u0006\u0010\u0004\u001A\u00028\u0000H\u0096@ø\u0001\u0000¢\u0006\u0002\u0010\u0005\u0082\u0002\u0004\n\u0002\b\u0019¨\u0006\u0006¸\u0006\u0000"}, d2 = {"kotlinx/coroutines/flow/FlowKt__CollectKt$collect$3", "Lkotlinx/coroutines/flow/FlowCollector;", "emit", "", "value", "(Ljava/lang/Object;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;", "kotlinx-coroutines-core"}, k = 1, mv = {1, 5, 1}, xi = 0x30)
        public final class kotlinx.coroutines.flow.FlowKt__LimitKt.take.lambda-7..inlined.collect.1 implements FlowCollector {
            public kotlinx.coroutines.flow.FlowKt__LimitKt.take.lambda-7..inlined.collect.1(IntRef ref$IntRef0, int v, FlowCollector flowCollector0) {
            }
            ...
            public Object emit(Object object0, Continuation continuation0) {
                ...
                if(this.$consumed$inlined.element < this.$count$inlined) {
                    ...
                    Object object2 = FlowKt__LimitKt.emitAbort$FlowKt__LimitKt(this.$this_unsafeFlow$inlined, object0, continuation0);
    ...
    public static final Flow takeWhile(Flow flow0, Function2 function20) {
        return new Flow() {
            @Override  // kotlinx.coroutines.flow.Flow
            public Object collect(FlowCollector flowCollector0, Continuation continuation0) {
                kotlinx.coroutines.flow.FlowKt__LimitKt.takeWhile.lambda-9..inlined.collectWhile.1 flowKt__LimitKt$takeWhile$lambda-9$$inlined$collectWhile$10;
                ...
                switch(flowKt__LimitKt$takeWhile$$inlined$unsafeFlow$1$10.label) {
                    case 0: {
                        ResultKt.throwOnFailure(object0);
                        kotlinx.coroutines.flow.FlowKt__LimitKt.takeWhile.lambda-9..inlined.collectWhile.1 flowKt__LimitKt$takeWhile$lambda-9$$inlined$collectWhile$11 = new kotlinx.coroutines.flow.FlowKt__LimitKt.takeWhile.lambda-9..inlined.collectWhile.1(function20, flowCollector0);
                        try {
                            flowKt__LimitKt$takeWhile$$inlined$unsafeFlow$1$10.L$0 = flowKt__LimitKt$takeWhile$lambda-9$$inlined$collectWhile$11;
                            flowKt__LimitKt$takeWhile$$inlined$unsafeFlow$1$10.label = 1;
                            return flow0.collect(flowKt__LimitKt$takeWhile$lambda-9$$inlined$collectWhile$11, flowKt__LimitKt$takeWhile$$inlined$unsafeFlow$1$10) == object1 ? object1 : Unit.INSTANCE;
                        }
                        catch(AbortFlowException abortFlowException0) {
                            flowKt__LimitKt$takeWhile$lambda-9$$inlined$collectWhile$10 = flowKt__LimitKt$takeWhile$lambda-9$$inlined$collectWhile$11;
                        }
                        FlowExceptions_commonKt.checkOwnership(abortFlowException0, flowKt__LimitKt$takeWhile$lambda-9$$inlined$collectWhile$10);
                        return Unit.INSTANCE;
                    }
                    case 1: {
                        flowKt__LimitKt$takeWhile$lambda-9$$inlined$collectWhile$10 = (kotlinx.coroutines.flow.FlowKt__LimitKt.takeWhile.lambda-9..inlined.collectWhile.1)flowKt__LimitKt$takeWhile$$inlined$unsafeFlow$1$10.L$0;
                        try {
                            ResultKt.throwOnFailure(object0);
                        }
                        catch(AbortFlowException abortFlowException0) {
        ...
        @Metadata(d1 = {"\u0000\u0013\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0003*\u0001\u0000\b\n\u0018\u00002\b\u0012\u0004\u0012\u00028\u00000\u0001J\u0019\u0010\u0002\u001A\u00020\u00032\u0006\u0010\u0004\u001A\u00028\u0000H\u0096@ø\u0001\u0000¢\u0006\u0002\u0010\u0005\u0082\u0002\u0004\n\u0002\b\u0019¨\u0006\u0006¸\u0006\u0000"}, d2 = {"kotlinx/coroutines/flow/FlowKt__LimitKt$collectWhile$collector$1", "Lkotlinx/coroutines/flow/FlowCollector;", "emit", "", "value", "(Ljava/lang/Object;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;", "kotlinx-coroutines-core"}, k = 1, mv = {1, 5, 1}, xi = 0x30)
        public final class kotlinx.coroutines.flow.FlowKt__LimitKt.takeWhile.lambda-9..inlined.collectWhile.1 implements FlowCollector {
            public kotlinx.coroutines.flow.FlowKt__LimitKt.takeWhile.lambda-9..inlined.collectWhile.1(Function2 function20, FlowCollector flowCollector0) {
            }
            ...
            public Object emit(Object object0, Continuation continuation0) {
                ...
                Object object5;
                Object object4;
                kotlinx.coroutines.flow.FlowKt__LimitKt.takeWhile.lambda-9..inlined.collectWhile.1.1 flowKt__LimitKt$takeWhile$lambda-9$$inlined$collectWhile$1$10;
                if(continuation0 instanceof kotlinx.coroutines.flow.FlowKt__LimitKt.takeWhile.lambda-9..inlined.collectWhile.1.1) {
                    flowKt__LimitKt$takeWhile$lambda-9$$inlined$collectWhile$1$10 = (kotlinx.coroutines.flow.FlowKt__LimitKt.takeWhile.lambda-9..inlined.collectWhile.1.1)continuation0;
                    if((flowKt__LimitKt$takeWhile$lambda-9$$inlined$collectWhile$1$10.label & 0x80000000) == 0) {
                        flowKt__LimitKt$takeWhile$lambda-9$$inlined$collectWhile$1$10 = new ContinuationImpl(/*ERROR_MISSING_ARG_1/*) {
                            Object L$0;
                            Object L$1;
                            int label;
                            Object result;
                        ...
                        flowKt__LimitKt$takeWhile$lambda-9$$inlined$collectWhile$1$10.label ^= 0x80000000;
                    }
                }
                else {
                    flowKt__LimitKt$takeWhile$lambda-9$$inlined$collectWhile$1$10 = new ContinuationImpl(/*ERROR_MISSING_ARG_1/*) {
                ...
                Object object1 = flowKt__LimitKt$takeWhile$lambda-9$$inlined$collectWhile$1$10.result;
                Object object2 = IntrinsicsKt.getCOROUTINE_SUSPENDED();
                boolean z = true;
                switch(flowKt__LimitKt$takeWhile$lambda-9$$inlined$collectWhile$1$10.label) {
                    case 0: {
                        ResultKt.throwOnFailure(object1);
                        flowKt__LimitKt$takeWhile$lambda-9$$inlined$collectWhile$1$10.L$0 = this;
                        flowKt__LimitKt$takeWhile$lambda-9$$inlined$collectWhile$1$10.L$1 = object0;
                        flowKt__LimitKt$takeWhile$lambda-9$$inlined$collectWhile$1$10.label = 1;
                        Object object3 = this.$predicate$inlined.invoke(object0, flowKt__LimitKt$takeWhile$lambda-9$$inlined$collectWhile$1$10);
                        if(object3 == object2) {
                            return object2;
                        }
                        object4 = object3;
                        object5 = object0;
                        flowKt__LimitKt$takeWhile$lambda-9$$inlined$collectWhile$10 = this;
                        goto label_30;
                    }
                    case 1: {
                        Object object6 = flowKt__LimitKt$takeWhile$lambda-9$$inlined$collectWhile$1$10.L$1;
                        kotlinx.coroutines.flow.FlowKt__LimitKt.takeWhile.lambda-9..inlined.collectWhile.1 flowKt__LimitKt$takeWhile$lambda-9$$inlined$collectWhile$11 = (kotlinx.coroutines.flow.FlowKt__LimitKt.takeWhile.lambda-9..inlined.collectWhile.1)flowKt__LimitKt$takeWhile$lambda-9$$inlined$collectWhile$1$10.L$0;
                        ResultKt.throwOnFailure(object1);
                        object5 = object6;
                        flowKt__LimitKt$takeWhile$lambda-9$$inlined$collectWhile$10 = flowKt__LimitKt$takeWhile$lambda-9$$inlined$collectWhile$11;
                        object4 = object1;
                    label_30:
                        if(((Boolean)object4).booleanValue()) {
                            flowKt__LimitKt$takeWhile$lambda-9$$inlined$collectWhile$1$10.L$0 = flowKt__LimitKt$takeWhile$lambda-9$$inlined$collectWhile$10;
                            flowKt__LimitKt$takeWhile$lambda-9$$inlined$collectWhile$1$10.L$1 = null;
                            flowKt__LimitKt$takeWhile$lambda-9$$inlined$collectWhile$1$10.label = 2;
                            if(flowKt__LimitKt$takeWhile$lambda-9$$inlined$collectWhile$10.$this_unsafeFlow$inlined.emit(object5, flowKt__LimitKt$takeWhile$lambda-9$$inlined$collectWhile$1$10) == object2) {
                                return object2;
                            }
                        }
                        else {
                    ...
                    case 2: {
                        flowKt__LimitKt$takeWhile$lambda-9$$inlined$collectWhile$10 = (kotlinx.coroutines.flow.FlowKt__LimitKt.takeWhile.lambda-9..inlined.collectWhile.1)flowKt__LimitKt$takeWhile$lambda-9$$inlined$collectWhile$1$10.L$0;
                        ResultKt.throwOnFailure(object1);
                        break;
                    }
                    default: {
                ...
                if(!Boxing.boxBoolean(z).booleanValue()) {
                    throw new AbortFlowException(flowKt__LimitKt$takeWhile$lambda-9$$inlined$collectWhile$10);
                }
                return Unit.INSTANCE;
            }
        }
