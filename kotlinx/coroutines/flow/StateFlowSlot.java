...
final class StateFlowSlot extends AbstractSharedFlowSlot {
    ...
    public final Object awaitPending(Continuation continuation0) {
        ...
        if(!PainterModifier..ExternalSyntheticBackport0.m(StateFlowSlot._state$FU, this, StateFlowKt.NONE, cancellableContinuationImpl0)) {
    ...
    public final void makePending() {
        ...
        do {
            while(true) {
                ...
                if(PainterModifier..ExternalSyntheticBackport0.m(StateFlowSlot._state$FU, this, object0, StateFlowKt.PENDING)) {
                    return;
                }
            }
        }
        while(!PainterModifier..ExternalSyntheticBackport0.m(StateFlowSlot._state$FU, this, object0, StateFlowKt.NONE));
