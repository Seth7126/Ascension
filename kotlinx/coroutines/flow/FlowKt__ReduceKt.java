...
final class FlowKt__ReduceKt {
        ...
        switch(flowKt__ReduceKt$fold$10.label) {
            case 0: {
                ...
                FlowCollector flowCollector0 = new FlowCollector() {
                    ...
                    public Object emit(Object object0, Continuation continuation0) {
                        ObjectRef ref$ObjectRef1;
                        kotlinx.coroutines.flow.FlowKt__ReduceKt.fold..inlined.collect.1.1 flowKt__ReduceKt$fold$$inlined$collect$1$10;
                        if(continuation0 instanceof kotlinx.coroutines.flow.FlowKt__ReduceKt.fold..inlined.collect.1.1) {
                            flowKt__ReduceKt$fold$$inlined$collect$1$10 = (kotlinx.coroutines.flow.FlowKt__ReduceKt.fold..inlined.collect.1.1)continuation0;
                            if((flowKt__ReduceKt$fold$$inlined$collect$1$10.label & 0x80000000) == 0) {
                                flowKt__ReduceKt$fold$$inlined$collect$1$10 = new ContinuationImpl(/*ERROR_MISSING_ARG_1/*) {
                                    Object L$0;
                                    int label;
                                    Object result;
                                ...
                                flowKt__ReduceKt$fold$$inlined$collect$1$10.label ^= 0x80000000;
                            }
                        }
                        else {
                            flowKt__ReduceKt$fold$$inlined$collect$1$10 = new ContinuationImpl(/*ERROR_MISSING_ARG_1/*) {
                        ...
                        Object object1 = flowKt__ReduceKt$fold$$inlined$collect$1$10.result;
                        Object object2 = IntrinsicsKt.getCOROUTINE_SUSPENDED();
                        switch(flowKt__ReduceKt$fold$$inlined$collect$1$10.label) {
                            case 0: {
                                ResultKt.throwOnFailure(object1);
                                ObjectRef ref$ObjectRef0 = ref$ObjectRef0;
                                flowKt__ReduceKt$fold$$inlined$collect$1$10.L$0 = ref$ObjectRef0;
                                flowKt__ReduceKt$fold$$inlined$collect$1$10.label = 1;
                                Object object3 = function30.invoke(ref$ObjectRef0.element, object0, flowKt__ReduceKt$fold$$inlined$collect$1$10);
                                if(object3 == object2) {
                                    return object2;
                                }
                                object1 = object3;
                            ...
                            case 1: {
                                ref$ObjectRef1 = (ObjectRef)flowKt__ReduceKt$fold$$inlined$collect$1$10.L$0;
                                ResultKt.throwOnFailure(object1);
                                break;
                            }
                            default: {
                    ...
                    public Object emit$$forInline(Object object0, Continuation continuation0) {
                        new kotlinx.coroutines.flow.FlowKt__ReduceKt.fold..inlined.collect.1.1(this, continuation0);
    ...
    private static final Object fold$$forInline(Flow flow0, Object object0, Function3 function30, Continuation continuation0) {
        ObjectRef ref$ObjectRef0 = new ObjectRef();
        ref$ObjectRef0.element = object0;
        flow0.collect(new kotlinx.coroutines.flow.FlowKt__ReduceKt.fold..inlined.collect.1(ref$ObjectRef0, function30), continuation0);
            ...
            case 0: {
                ...
                FlowCollector flowCollector0 = new FlowCollector() {
                    ...
                    public Object emit(Object object0, Continuation continuation0) {
                        ...
                        kotlinx.coroutines.flow.FlowKt__ReduceKt.reduce..inlined.collect.1.1 flowKt__ReduceKt$reduce$$inlined$collect$1$10;
                        if(continuation0 instanceof kotlinx.coroutines.flow.FlowKt__ReduceKt.reduce..inlined.collect.1.1) {
                            flowKt__ReduceKt$reduce$$inlined$collect$1$10 = (kotlinx.coroutines.flow.FlowKt__ReduceKt.reduce..inlined.collect.1.1)continuation0;
                            if((flowKt__ReduceKt$reduce$$inlined$collect$1$10.label & 0x80000000) == 0) {
                                flowKt__ReduceKt$reduce$$inlined$collect$1$10 = new ContinuationImpl(/*ERROR_MISSING_ARG_1/*) {
                                    Object L$0;
                                    int label;
                                    Object result;
                                ...
                                flowKt__ReduceKt$reduce$$inlined$collect$1$10.label ^= 0x80000000;
                            }
                        }
                        else {
                            flowKt__ReduceKt$reduce$$inlined$collect$1$10 = new ContinuationImpl(/*ERROR_MISSING_ARG_1/*) {
                        ...
                        Object object1 = flowKt__ReduceKt$reduce$$inlined$collect$1$10.result;
                        Object object2 = IntrinsicsKt.getCOROUTINE_SUSPENDED();
                        switch(flowKt__ReduceKt$reduce$$inlined$collect$1$10.label) {
                            case 0: {
                                ResultKt.throwOnFailure(object1);
                                ref$ObjectRef0 = ref$ObjectRef0;
                                if(ref$ObjectRef0.element != NullSurrogateKt.NULL) {
                                    flowKt__ReduceKt$reduce$$inlined$collect$1$10.L$0 = ref$ObjectRef0;
                                    flowKt__ReduceKt$reduce$$inlined$collect$1$10.label = 1;
                                    object0 = function30.invoke(ref$ObjectRef0.element, object0, flowKt__ReduceKt$reduce$$inlined$collect$1$10);
                                    if(object0 == object2) {
                                        return object2;
                                    }
                                }
                            ...
                            case 1: {
                                ObjectRef ref$ObjectRef1 = (ObjectRef)flowKt__ReduceKt$reduce$$inlined$collect$1$10.L$0;
                                ResultKt.throwOnFailure(object1);
