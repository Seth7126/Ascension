...
final class ChannelAsFlow extends ChannelFlow {
    ...
    public Object collect(FlowCollector flowCollector0, Continuation continuation0) {
        if(this.capacity == -3) {
            this.markConsumed();
            Object object0 = FlowKt__ChannelsKt.access$emitAllImpl(flowCollector0, this.channel, this.consume, continuation0);
    ...
    protected Object collectTo(ProducerScope producerScope0, Continuation continuation0) {
        Object object0 = FlowKt__ChannelsKt.access$emitAllImpl(new SendingCollector(producerScope0), this.channel, this.consume, continuation0);
        return object0 == IntrinsicsKt.getCOROUTINE_SUSPENDED() ? object0 : Unit.INSTANCE;
    }
