    ...
    public Object collect(FlowCollector flowCollector0, Continuation continuation0) {
        ...
        FlowCollector flowCollector1 = new FlowCollector() {
            ...
            public Object emit(Object object0, Continuation continuation0) {
                kotlinx.coroutines.flow.DistinctFlowImpl.collect..inlined.collect.1.1 distinctFlowImpl$collect$$inlined$collect$1$10;
                if(continuation0 instanceof kotlinx.coroutines.flow.DistinctFlowImpl.collect..inlined.collect.1.1) {
                    distinctFlowImpl$collect$$inlined$collect$1$10 = (kotlinx.coroutines.flow.DistinctFlowImpl.collect..inlined.collect.1.1)continuation0;
                    if((distinctFlowImpl$collect$$inlined$collect$1$10.label & 0x80000000) == 0) {
                        distinctFlowImpl$collect$$inlined$collect$1$10 = new ContinuationImpl(/*ERROR_MISSING_ARG_1/*) {
                            int label;
                            Object result;
                        ...
                        distinctFlowImpl$collect$$inlined$collect$1$10.label ^= 0x80000000;
                    }
                }
                else {
                    distinctFlowImpl$collect$$inlined$collect$1$10 = new ContinuationImpl(/*ERROR_MISSING_ARG_1/*) {
                ...
                Object object1 = distinctFlowImpl$collect$$inlined$collect$1$10.result;
                Object object2 = IntrinsicsKt.getCOROUTINE_SUSPENDED();
                switch(distinctFlowImpl$collect$$inlined$collect$1$10.label) {
                    case 0: {
                        ...
                        if(flowCollector0.element == NullSurrogateKt.NULL || !((Boolean)ref$ObjectRef0.areEquivalent.invoke(flowCollector0.element, object3)).booleanValue()) {
                            ...
                            distinctFlowImpl$collect$$inlined$collect$1$10.label = 1;
                            if(this.$collector$inlined.emit(object0, distinctFlowImpl$collect$$inlined$collect$1$10) == object2) {
                                return object2;
                            }
                        }
