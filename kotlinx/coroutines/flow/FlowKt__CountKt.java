        ...
        switch(flowKt__CountKt$count$30.label) {
            case 0: {
                ...
                FlowCollector flowCollector0 = new FlowCollector() {
                    @Override  // kotlinx.coroutines.flow.FlowCollector
                    public Object emit(Object object0, Continuation continuation0) {
                        kotlinx.coroutines.flow.FlowKt__CountKt.count..inlined.collect.2 flowKt__CountKt$count$$inlined$collect$20;
                        kotlinx.coroutines.flow.FlowKt__CountKt.count..inlined.collect.2.1 flowKt__CountKt$count$$inlined$collect$2$10;
                        if(continuation0 instanceof kotlinx.coroutines.flow.FlowKt__CountKt.count..inlined.collect.2.1) {
                            flowKt__CountKt$count$$inlined$collect$2$10 = (kotlinx.coroutines.flow.FlowKt__CountKt.count..inlined.collect.2.1)continuation0;
                            if((flowKt__CountKt$count$$inlined$collect$2$10.label & 0x80000000) == 0) {
                                flowKt__CountKt$count$$inlined$collect$2$10 = new ContinuationImpl(/*ERROR_MISSING_ARG_1/*) {
                                    Object L$0;
                                    int label;
                                    Object result;
                                ...
                                flowKt__CountKt$count$$inlined$collect$2$10.label ^= 0x80000000;
                            }
                        }
                        else {
                            flowKt__CountKt$count$$inlined$collect$2$10 = new ContinuationImpl(/*ERROR_MISSING_ARG_1/*) {
                        ...
                        Object object1 = flowKt__CountKt$count$$inlined$collect$2$10.result;
                        Object object2 = IntrinsicsKt.getCOROUTINE_SUSPENDED();
                        switch(flowKt__CountKt$count$$inlined$collect$2$10.label) {
                            case 0: {
                                ResultKt.throwOnFailure(object1);
                                flowKt__CountKt$count$$inlined$collect$2$10.L$0 = this;
                                flowKt__CountKt$count$$inlined$collect$2$10.label = 1;
                                object1 = function20.invoke(object0, flowKt__CountKt$count$$inlined$collect$2$10);
                                if(object1 == object2) {
                                    return object2;
                                }
                                flowKt__CountKt$count$$inlined$collect$20 = this;
                                break;
                            }
                            case 1: {
                                flowKt__CountKt$count$$inlined$collect$20 = (kotlinx.coroutines.flow.FlowKt__CountKt.count..inlined.collect.2)flowKt__CountKt$count$$inlined$collect$2$10.L$0;
                                ResultKt.throwOnFailure(object1);
                                break;
                            }
                            default: {
                        ...
                        if(((Boolean)object1).booleanValue()) {
                            ++flowKt__CountKt$count$$inlined$collect$20.$i$inlined.element;
                        }
                        return Unit.INSTANCE;
                    }
                };
