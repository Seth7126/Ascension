...
public abstract class AbstractSendChannel implements SendChannel {
    ...
    @Metadata(d1 = {"\u00006\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0010\u0000\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\b\u0004\u0018\u0000*\u0004\b\u0001\u0010\u00012\u001E\u0012\n\u0012\b\u0012\u0004\u0012\u0002H\u00010\u00030\u0002j\u000E\u0012\n\u0012\b\u0012\u0004\u0012\u0002H\u00010\u0003`\u0004B\u0015\u0012\u0006\u0010\u0005\u001A\u00028\u0001\u0012\u0006\u0010\u0006\u001A\u00020\u0007¢\u0006\u0002\u0010\bJ\u0012\u0010\n\u001A\u0004\u0018\u00010\u000B2\u0006\u0010\f\u001A\u00020\rH\u0014J\u0016\u0010\u000E\u001A\u0004\u0018\u00010\u000B2\n\u0010\u000F\u001A\u00060\u0010j\u0002`\u0011H\u0016R\u0012\u0010\u0005\u001A\u00028\u00018\u0006X\u0087\u0004¢\u0006\u0004\n\u0002\u0010\t¨\u0006\u0012"}, d2 = {"Lkotlinx/coroutines/channels/AbstractSendChannel$TryOfferDesc;", "E", "Lkotlinx/coroutines/internal/LockFreeLinkedListNode$RemoveFirstDesc;", "Lkotlinx/coroutines/channels/ReceiveOrClosed;", "Lkotlinx/coroutines/internal/RemoveFirstDesc;", "element", "queue", "Lkotlinx/coroutines/internal/LockFreeLinkedListHead;", "(Ljava/lang/Object;Lkotlinx/coroutines/internal/LockFreeLinkedListHead;)V", "Ljava/lang/Object;", "failure", "", "affected", "Lkotlinx/coroutines/internal/LockFreeLinkedListNode;", "onPrepare", "prepareOp", "Lkotlinx/coroutines/internal/LockFreeLinkedListNode$PrepareOp;", "Lkotlinx/coroutines/internal/PrepareOp;", "kotlinx-coroutines-core"}, k = 1, mv = {1, 5, 1}, xi = 0x30)
    ...
    static {
        AbstractSendChannel.onCloseHandler$FU = AtomicReferenceFieldUpdater.newUpdater(AbstractSendChannel.class, Object.class, "onCloseHandler");
    }
    ...
    protected String getBufferDebugString() [...] // 潜在的解密器
            ...
            do {
                ...
                if(AbstractSendChannel.this.isFullImpl()) {
                    ...
                    if(object1 != AbstractChannelKt.ENQUEUE_FAILED && !(object1 instanceof Receive)) {
                        throw new IllegalStateException(("enqueueSend returned " + object1 + ' ').toString());
                    }
                }
    ...
    private final String getQueueDebugStateString() {
        ...
        if(lockFreeLinkedListNode0 instanceof Closed) {
            s = "LockFreeLinkedListNode@a830131";
        }
        else if(lockFreeLinkedListNode0 instanceof Receive) {
            s = "ReceiveQueued";
        }
        else {
            s = lockFreeLinkedListNode0 instanceof Send ? "SendQueued" : "UNEXPECTED:" + lockFreeLinkedListNode0;
        }
        LockFreeLinkedListNode lockFreeLinkedListNode1 = this.queue.getPrevNode();
        if(lockFreeLinkedListNode1 != lockFreeLinkedListNode0) {
            s = s + ",queueSize=" + this.countQueueSize();
            return lockFreeLinkedListNode1 instanceof Closed ? s + ",closedForSend=" + lockFreeLinkedListNode1 : s;
        }
        return s;
    }
    ...
    public void invokeOnClose(Function1 function10) {
        ...
        if(!PainterModifier..ExternalSyntheticBackport0.m(atomicReferenceFieldUpdater0, this, null, function10)) {
            throw this.onCloseHandler == AbstractChannelKt.HANDLER_INVOKED ? new IllegalStateException("Another handler was already registered and successfully invoked") : new IllegalStateException("Another handler was already registered: " + this.onCloseHandler);
        }
        Closed closed0 = this.getClosedForSend();
        if(closed0 != null && PainterModifier..ExternalSyntheticBackport0.m(atomicReferenceFieldUpdater0, this, function10, AbstractChannelKt.HANDLER_INVOKED)) {
    ...
    private final void invokeOnCloseHandler(Throwable throwable0) {
        ...
        if(object0 != null && object0 != AbstractChannelKt.HANDLER_INVOKED && PainterModifier..ExternalSyntheticBackport0.m(AbstractSendChannel.onCloseHandler$FU, this, object0, AbstractChannelKt.HANDLER_INVOKED)) {
    ...
    private final Object sendSuspend(Object object0, Continuation continuation0) {
        ...
        if(!(object2 instanceof Closed)) {
            throw new IllegalStateException(("offerInternal returned " + object2).toString());
        }
    ...
    @Override
    public String toString() {
        return DebugStringsKt.getClassSimpleName(this) + '@' + DebugStringsKt.getHexAddress(this) + '{' + this.getQueueDebugStateString() + '}' + "";
    }
    ...
    public final Object trySend-JP2dKIU(Object object0) {
        ...
        if(!(object1 instanceof Closed)) {
            throw new IllegalStateException(("trySend returned " + object1).toString());
        }
