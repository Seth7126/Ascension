...
public class LinkedListChannel extends AbstractChannel {
    ...
    protected Object offerInternal(Object object0) {
        ...
        if(!(object1 instanceof Closed)) {
            throw new IllegalStateException(("Invalid offerInternal result " + object1).toString());
        }
        return object1;
    }
    ...
    protected Object offerSelectInternal(Object object0, SelectInstance selectInstance0) {
        ...
        if(!(symbol0 instanceof Closed)) {
            throw new IllegalStateException(("Invalid result " + symbol0).toString());
        }
        return symbol0;
    }
                ...
                if(v >= 0) {
                    ...
                    while(true) {
                        ...
                        if(send0 instanceof SendBuffered) {
                            ...
                            undeliveredElementException0 = function11 == null ? null : OnUndeliveredElementKt.callUndeliveredElementCatchingException(function11, ((SendBuffered)send0).element, undeliveredElementException0);
                        }
                        else {
                    ...
                    throwable0 = undeliveredElementException0;
                }
            }
