...
public abstract class AbstractChannel extends AbstractSendChannel implements Channel {
    ...
    static final class Itr implements ChannelIterator {
        ...
        public Object hasNext(Continuation continuation0) {
            if(this.getResult() != AbstractChannelKt.POLL_FAILED) {
                return Boxing.boxBoolean(this.hasNextResult(this.getResult()));
            }
            this.setResult(this.channel.pollInternal());
            return this.getResult() != AbstractChannelKt.POLL_FAILED ? Boxing.boxBoolean(this.hasNextResult(this.getResult())) : this.hasNextSuspend(continuation0);
        }
    ...
    public final void cancel(CancellationException cancellationException0) {
        ...
        if(cancellationException0 == null) {
            cancellationException0 = new CancellationException(Intrinsics.stringPlus(DebugStringsKt.getClassSimpleName(this), " was cancelled"));
        }
    ...
    protected void onCancelIdempotent(boolean z) {
        ...
        while(!((lockFreeLinkedListNode0 = closed0.getPrevNode()) instanceof LockFreeLinkedListHead)) {
