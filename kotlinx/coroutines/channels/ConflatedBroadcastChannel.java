...
public final class ConflatedBroadcastChannel implements BroadcastChannel {
    @Metadata(d1 = {"\u0000\u0012\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0000\n\u0002\u0010\u0003\n\u0002\b\u0007\b\u0002\u0018\u00002\u00020\u0001B\u000F\u0012\b\u0010\u0002\u001A\u0004\u0018\u00010\u0003¢\u0006\u0002\u0010\u0004R\u0012\u0010\u0002\u001A\u0004\u0018\u00010\u00038\u0006X\u0087\u0004¢\u0006\u0002\n\u0000R\u0011\u0010\u0005\u001A\u00020\u00038F¢\u0006\u0006\u001A\u0004\b\u0006\u0010\u0007R\u0011\u0010\b\u001A\u00020\u00038F¢\u0006\u0006\u001A\u0004\b\t\u0010\u0007¨\u0006\n"}, d2 = {"Lkotlinx/coroutines/channels/ConflatedBroadcastChannel$Closed;", "", "closeCause", "", "(Ljava/lang/Throwable;)V", "sendException", "getSendException", "()Ljava/lang/Throwable;", "valueException", "getValueException", "kotlinx-coroutines-core"}, k = 1, mv = {1, 5, 1}, xi = 0x30)
    ...
    static {
        ...
        Symbol symbol0 = new Symbol("UNDEFINED");
        ConflatedBroadcastChannel.UNDEFINED = symbol0;
        ConflatedBroadcastChannel.INITIAL_STATE = new State(symbol0, null);
        ConflatedBroadcastChannel._state$FU = AtomicReferenceFieldUpdater.newUpdater(ConflatedBroadcastChannel.class, Object.class, "_state");
        ConflatedBroadcastChannel._updating$FU = AtomicIntegerFieldUpdater.newUpdater(ConflatedBroadcastChannel.class, "_updating");
        ConflatedBroadcastChannel.onCloseHandler$FU = AtomicReferenceFieldUpdater.newUpdater(ConflatedBroadcastChannel.class, Object.class, "onCloseHandler");
    }
    ...
    public boolean close(Throwable throwable0) {
        ...
        while(true) {
            ...
            if(PainterModifier..ExternalSyntheticBackport0.m(ConflatedBroadcastChannel._state$FU, this, object0, conflatedBroadcastChannel$Closed0)) {
        ...
        throw new IllegalStateException(("Invalid state " + object0).toString());
    }
    ...
    private final void closeSubscriber(Subscriber conflatedBroadcastChannel$Subscriber0) {
        ...
        while(true) {
            ...
            if(PainterModifier..ExternalSyntheticBackport0.m(ConflatedBroadcastChannel._state$FU, this, object0, conflatedBroadcastChannel$State0)) {
                return;
            }
        }
        throw new IllegalStateException(("Invalid state " + object0).toString());
    ...
    public final Object getValue() {
        ...
        if(!(object0 instanceof State)) {
            throw new IllegalStateException(Intrinsics.stringPlus("Invalid state ", object0).toString());
        }
    ...
    public void invokeOnClose(Function1 function10) {
        ...
        Object object0 = this._state;
        if(object0 instanceof Closed && PainterModifier..ExternalSyntheticBackport0.m(atomicReferenceFieldUpdater0, this, function10, AbstractChannelKt.HANDLER_INVOKED)) {
            function10.invoke(((Closed)object0).closeCause);
        }
    }

    private final void invokeOnCloseHandler(Throwable throwable0) {
        Object object0 = this.onCloseHandler;
        if(object0 != null && object0 != AbstractChannelKt.HANDLER_INVOKED && PainterModifier..ExternalSyntheticBackport0.m(ConflatedBroadcastChannel.onCloseHandler$FU, this, object0, AbstractChannelKt.HANDLER_INVOKED)) {
    ...
    @Override  // kotlinx.coroutines.channels.SendChannel
    @kotlin.Deprecated(level = DeprecationLevel.WARNING, message = "Deprecated in the favour of \'trySend\' method", replaceWith = @ReplaceWith(expression = "trySend(element).isSuccess", imports = {}))
        ...
        try {
            do {
                ...
                if(!(object1 instanceof State)) {
                    throw new IllegalStateException(("Invalid state " + object1).toString());
                }
                State conflatedBroadcastChannel$State0 = new State(object0, ((State)object1).subscribers);
            }
            while(!PainterModifier..ExternalSyntheticBackport0.m(ConflatedBroadcastChannel._state$FU, this, object1, conflatedBroadcastChannel$State0));
