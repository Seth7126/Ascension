...
public final class AbstractChannelKt {
    ...
    static {
        AbstractChannelKt.EMPTY = new Symbol("EMPTY");
        AbstractChannelKt.OFFER_SUCCESS = new Symbol("OFFER_SUCCESS");
        AbstractChannelKt.OFFER_FAILED = new Symbol("OFFER_FAILED");
        AbstractChannelKt.POLL_FAILED = new Symbol("POLL_FAILED");
        AbstractChannelKt.ENQUEUE_FAILED = new Symbol("ENQUEUE_FAILED");
        AbstractChannelKt.HANDLER_INVOKED = new Symbol("ON_CLOSE_HANDLER_INVOKED");
    }
