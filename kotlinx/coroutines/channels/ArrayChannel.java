...
public class ArrayChannel extends AbstractChannel {
    ...
    public ArrayChannel(int v, BufferOverflow bufferOverflow0, Function1 function10) {
        ...
        if(v < 1) {
            throw new IllegalArgumentException(("ArrayChannel capacity must be at least 1, but " + v + " was specified").toString());
        }
        ...
        try {
            ...
            if(v1 == this.capacity) {
                ...
                if(!(object2 instanceof Closed)) {
                    throw new IllegalStateException(("performAtomicTrySelect(describeTryOffer) returned " + object2).toString());
                }
                symbol1 = object2;
                symbol0 = symbol1;
            label_37:
