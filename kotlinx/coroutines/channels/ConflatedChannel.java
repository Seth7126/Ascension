    ...
    protected Object offerInternal(Object object0) {
        ...
        try {
            ...
            if(closed0 == null) {
                ...
                UndeliveredElementException undeliveredElementException0 = this.updateValueLocked(object0);
                    ...
                    while(true) {
                        ...
                        if(object1 != AtomicKt.RETRY_ATOMIC) {
                            if(object1 != SelectKt.getALREADY_SELECTED() && !(object1 instanceof Closed)) {
                                throw new IllegalStateException(("performAtomicTrySelect(describeTryOffer) returned " + object1).toString());
                            }
                            return object1;
                        }
                    }
