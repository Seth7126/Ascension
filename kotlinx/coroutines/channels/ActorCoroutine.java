    ...
    protected void onCancelling(Throwable throwable0) {
        ...
        if(throwable0 != null) {
            ...
            if(cancellationException0 == null) {
                cancellationException0 = ExceptionsKt.CancellationException(Intrinsics.stringPlus(DebugStringsKt.getClassSimpleName(this), " was cancelled"), throwable0);
            }
        }
