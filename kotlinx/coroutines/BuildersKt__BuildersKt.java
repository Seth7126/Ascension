...
@Metadata(d1 = {"\u0000\"\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\u001AT\u0010\u0000\u001A\u0002H\u0001\"\u0004\b\u0000\u0010\u00012\b\b\u0002\u0010\u0002\u001A\u00020\u00032\'\u0010\u0004\u001A#\b\u0001\u0012\u0004\u0012\u00020\u0006\u0012\n\u0012\b\u0012\u0004\u0012\u0002H\u00010\u0007\u0012\u0006\u0012\u0004\u0018\u00010\b0\u0005¢\u0006\u0002\b\tø\u0001\u0000\u0082\u0002\n\n\b\b\u0001\u0012\u0002\u0010\u0002 \u0001¢\u0006\u0002\u0010\n\u0082\u0002\u0004\n\u0002\b\u0019¨\u0006\u000B"}, d2 = {"runBlocking", "T", "context", "Lkotlin/coroutines/CoroutineContext;", "block", "Lkotlin/Function2;", "Lkotlinx/coroutines/CoroutineScope;", "Lkotlin/coroutines/Continuation;", "", "Lkotlin/ExtensionFunctionType;", "(Lkotlin/coroutines/CoroutineContext;Lkotlin/jvm/functions/Function2;)Ljava/lang/Object;", "kotlinx-coroutines-core"}, k = 5, mv = {1, 5, 1}, xi = 0x30, xs = "kotlinx/coroutines/BuildersKt")
final class BuildersKt__BuildersKt {
    public static final Object runBlocking(CoroutineContext coroutineContext0, Function2 function20) throws InterruptedException {
        ...
        if(continuationInterceptor0 == null) {
            eventLoop1 = ThreadLocalEventLoop.INSTANCE.getEventLoop$kotlinx_coroutines_core();
            CoroutineContext coroutineContext1 = coroutineContext0.plus(eventLoop1);
            coroutineContext2 = CoroutineContextKt.newCoroutineContext(() -> EmptyCoroutineContext.INSTANCE, coroutineContext1);
        }
        else {
            EventLoop eventLoop2 = continuationInterceptor0 instanceof EventLoop ? ((EventLoop)continuationInterceptor0) : null;
            if(eventLoop2 != null && eventLoop2.shouldBeProcessedFromContext()) {
                eventLoop0 = eventLoop2;
            }
            eventLoop1 = eventLoop0 == null ? ThreadLocalEventLoop.INSTANCE.currentOrNull$kotlinx_coroutines_core() : eventLoop0;
            coroutineContext2 = CoroutineContextKt.newCoroutineContext(() -> EmptyCoroutineContext.INSTANCE, coroutineContext0);
        }
        BlockingCoroutine blockingCoroutine0 = new BlockingCoroutine(coroutineContext2, thread0, eventLoop1);
