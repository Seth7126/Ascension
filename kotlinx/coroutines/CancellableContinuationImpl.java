...
public class CancellableContinuationImpl extends DispatchedTask implements CoroutineStackFrame, CancellableContinuation {
    ...
    static {
        CancellableContinuationImpl._decision$FU = AtomicIntegerFieldUpdater.newUpdater(CancellableContinuationImpl.class, "_decision");
    ...
    public boolean cancel(Throwable throwable0) {
        ...
        while(!PainterModifier..ExternalSyntheticBackport0.m(CancellableContinuationImpl._state$FU, this, object0, cancelledContinuation0));
    ...
    alab1:
        while(true) {
            ...
            while(!PainterModifier..ExternalSyntheticBackport0.m(CancellableContinuationImpl._state$FU, this, object1, completedContinuation0));
        ...
        label_11:
            ...
            if(PainterModifier..ExternalSyntheticBackport0.m(CancellableContinuationImpl._state$FU, this, object1, completedContinuation1)) {
                return;
            }
        }
        ...
        while(true) {
            while(true) {
                ...
                label_1:
                    ...
                    if(PainterModifier..ExternalSyntheticBackport0.m(CancellableContinuationImpl._state$FU, this, object0, cancelHandler0)) {
                        return;
                    }
                }
                ...
                if(PainterModifier..ExternalSyntheticBackport0.m(CancellableContinuationImpl._state$FU, this, object0, completedContinuation0)) {
                    return;
                }
            }
            if(cancelHandler0 instanceof BeforeResumeCancelHandler) {
            ...
            if(!PainterModifier..ExternalSyntheticBackport0.m(CancellableContinuationImpl._state$FU, this, object0, completedContinuation1)) {
                goto label_1;
            }
            break;
        }
    ...
    private final void multipleHandlersError(Function1 function10, Object object0) {
        throw new IllegalStateException(("It\'s prohibited to register multiple handlers, tried to register " + function10 + ", already has " + object0).toString());
    }
    ...
    private final void releaseClaimedReusableContinuation() {
        ...
        if(dispatchedContinuation0 != null) {
            throwable0 = dispatchedContinuation0.tryReleaseClaimedContinuation(this);
        }
        if(throwable0 == null) {
            return;
        }
    ...
    private final void resumeImpl(Object object0, int v, Function1 function10) {
        ...
        while(true) {
            ...
            if(PainterModifier..ExternalSyntheticBackport0.m(CancellableContinuationImpl._state$FU, this, object1, object2)) {
                this.detachChildIfNonResuable();
    ...
    private final Symbol tryResumeImpl(Object object0, Object object1, Function1 function10) {
        ...
        while(true) {
            ...
            if(PainterModifier..ExternalSyntheticBackport0.m(CancellableContinuationImpl._state$FU, this, object2, object3)) {
                this.detachChildIfNonResuable();
