...
public final class SelectBuilderImpl extends LockFreeLinkedListHead implements Continuation, CoroutineStackFrame, SelectBuilder, SelectInstance {
    @Metadata(d1 = {"\u00004\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\t\n\u0002\b\u0003\n\u0002\u0010\u0002\n\u0002\b\u0006\n\u0002\u0010\u000E\n\u0002\b\u0002\b\u0002\u0018\u00002\n\u0012\u0006\u0012\u0004\u0018\u00010\u00020\u0001B\u0019\u0012\n\u0010\u0003\u001A\u0006\u0012\u0002\b\u00030\u0004\u0012\u0006\u0010\u0005\u001A\u00020\u0006¢\u0006\u0002\u0010\u0007J\u001C\u0010\f\u001A\u00020\r2\b\u0010\u000E\u001A\u0004\u0018\u00010\u00022\b\u0010\u000F\u001A\u0004\u0018\u00010\u0002H\u0016J\u0012\u0010\u0010\u001A\u00020\r2\b\u0010\u000F\u001A\u0004\u0018\u00010\u0002H\u0002J\u0014\u0010\u0011\u001A\u0004\u0018\u00010\u00022\b\u0010\u000E\u001A\u0004\u0018\u00010\u0002H\u0016J\n\u0010\u0012\u001A\u0004\u0018\u00010\u0002H\u0002J\b\u0010\u0013\u001A\u00020\u0014H\u0016J\b\u0010\u0015\u001A\u00020\rH\u0002R\u0010\u0010\u0005\u001A\u00020\u00068\u0006X\u0087\u0004¢\u0006\u0002\n\u0000R\u0014\u0010\u0003\u001A\u0006\u0012\u0002\b\u00030\u00048\u0006X\u0087\u0004¢\u0006\u0002\n\u0000R\u0014\u0010\b\u001A\u00020\tX\u0096\u0004¢\u0006\b\n\u0000\u001A\u0004\b\n\u0010\u000B¨\u0006\u0016"}, d2 = {"Lkotlinx/coroutines/selects/SelectBuilderImpl$AtomicSelectOp;", "Lkotlinx/coroutines/internal/AtomicOp;", "", "impl", "Lkotlinx/coroutines/selects/SelectBuilderImpl;", "desc", "Lkotlinx/coroutines/internal/AtomicDesc;", "(Lkotlinx/coroutines/selects/SelectBuilderImpl;Lkotlinx/coroutines/internal/AtomicDesc;)V", "opSequence", "", "getOpSequence", "()J", "complete", "", "affected", "failure", "completeSelect", "prepare", "prepareSelectOp", "toString", "", "undoPrepare", "kotlinx-coroutines-core"}, k = 1, mv = {1, 5, 1}, xi = 0x30)
    static final class AtomicSelectOp extends AtomicOp {
        ...
        private final void completeSelect(Object object0) {
            ...
            if(PainterModifier..ExternalSyntheticBackport0.m(SelectBuilderImpl._state$FU, this.impl, this, (z ? null : SelectKt.getNOT_SELECTED())) && z) {
        ...
        private final Object prepareSelectOp() {
            ...
            while(true) {
                ...
                if(object0 instanceof OpDescriptor) {
                    ...
                    if(PainterModifier..ExternalSyntheticBackport0.m(SelectBuilderImpl._state$FU, this.impl, SelectKt.getNOT_SELECTED(), this)) {
                        return null;
                    }
                }
            }
        ...
        private final void undoPrepare() {
            PainterModifier..ExternalSyntheticBackport0.m(SelectBuilderImpl._state$FU, this.impl, this, SelectKt.getNOT_SELECTED());
        }
    }

    @Metadata(d1 = {"\u0000\u0012\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\b\u0002\u0018\u00002\u00020\u0001B\r\u0012\u0006\u0010\u0002\u001A\u00020\u0003¢\u0006\u0002\u0010\u0004R\u0010\u0010\u0002\u001A\u00020\u00038\u0006X\u0087\u0004¢\u0006\u0002\n\u0000¨\u0006\u0005"}, d2 = {"Lkotlinx/coroutines/selects/SelectBuilderImpl$DisposeNode;", "Lkotlinx/coroutines/internal/LockFreeLinkedListNode;", "handle", "Lkotlinx/coroutines/DisposableHandle;", "(Lkotlinx/coroutines/DisposableHandle;)V", "kotlinx-coroutines-core"}, k = 1, mv = {1, 5, 1}, xi = 0x30)
    ...
    static final class PairSelectOp extends OpDescriptor {
        ...
        public Object perform(Object object0) {
            ...
            PainterModifier..ExternalSyntheticBackport0.m(SelectBuilderImpl._state$FU, ((SelectBuilderImpl)object0), this, lockFreeLinkedListNode$AbstractAtomicDesc0);
            return object1;
        }
    }

    @Metadata(d1 = {"\u0000\u0018\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\u0002\n\u0000\n\u0002\u0010\u0003\n\u0000\b\u0082\u0004\u0018\u00002\u00020\u0001B\u0005¢\u0006\u0002\u0010\u0002J\u0013\u0010\u0003\u001A\u00020\u00042\b\u0010\u0005\u001A\u0004\u0018\u00010\u0006H\u0096\u0002¨\u0006\u0007"}, d2 = {"Lkotlinx/coroutines/selects/SelectBuilderImpl$SelectOnCancelling;", "Lkotlinx/coroutines/JobCancellingNode;", "(Lkotlinx/coroutines/selects/SelectBuilderImpl;)V", "invoke", "", "cause", "", "kotlinx-coroutines-core"}, k = 1, mv = {1, 5, 1}, xi = 0x30)
    ...
    static {
        SelectBuilderImpl._state$FU = AtomicReferenceFieldUpdater.newUpdater(SelectBuilderImpl.class, Object.class, "_state");
        SelectBuilderImpl._result$FU = AtomicReferenceFieldUpdater.newUpdater(SelectBuilderImpl.class, Object.class, "_result");
    }
    ...
    private final void doResume(Function0 function00, Function0 function01) {
        while(true) {
            ...
            while((object0 = this._result) == SelectKt.UNDECIDED) {
                ...
                if(PainterModifier..ExternalSyntheticBackport0.m(SelectBuilderImpl._result$FU, this, SelectKt.UNDECIDED, object1)) {
                    return;
                }
            }
            ...
            if(PainterModifier..ExternalSyntheticBackport0.m(SelectBuilderImpl._result$FU, this, object2, SelectKt.RESUMED)) {
                function01.invoke();
                return;
            }
        }
        ...
        Runnable runnable0 = new Runnable() {
            ...
            public final void run() {
                if(function10.trySelect()) {
                    CancellableKt.startCoroutineCancellable(this.$block$inlined, function10.getCompletion());
                }
            }
        };
    ...
    public void resumeSelectWithException(Throwable throwable0) {
        while(true) {
            ...
            while((object0 = this._result) == SelectKt.UNDECIDED) {
                ...
                if(PainterModifier..ExternalSyntheticBackport0.m(SelectBuilderImpl._result$FU, this, SelectKt.UNDECIDED, completedExceptionally0)) {
                    return;
                }
            }
            if(object0 != IntrinsicsKt.getCOROUTINE_SUSPENDED()) {
            ...
            Object object1 = IntrinsicsKt.getCOROUTINE_SUSPENDED();
            if(PainterModifier..ExternalSyntheticBackport0.m(SelectBuilderImpl._result$FU, this, object1, SelectKt.RESUMED)) {
    ...
    public void resumeWith(Object object0) {
        while(true) {
            ...
            while((object1 = this._result) == SelectKt.UNDECIDED) {
                ...
                if(PainterModifier..ExternalSyntheticBackport0.m(SelectBuilderImpl._result$FU, this, SelectKt.UNDECIDED, object2)) {
                    return;
                }
            }
            ...
            if(PainterModifier..ExternalSyntheticBackport0.m(SelectBuilderImpl._result$FU, this, object3, SelectKt.RESUMED)) {
    ...
    public boolean trySelect() {
        ...
        if(object0 != null) {
            throw new IllegalStateException(("Unexpected trySelectIdempotent result " + object0).toString());
        }
        return false;
    }
        ...
        while(true) {
            ...
            if(object0 == SelectKt.getNOT_SELECTED()) {
                if(lockFreeLinkedListNode$PrepareOp0 != null) {
                    ...
                    if(!PainterModifier..ExternalSyntheticBackport0.m(SelectBuilderImpl._state$FU, this, SelectKt.getNOT_SELECTED(), selectBuilderImpl$PairSelectOp0)) {
                        continue;
                    }
                ...
                else if(!PainterModifier..ExternalSyntheticBackport0.m(SelectBuilderImpl._state$FU, this, SelectKt.getNOT_SELECTED(), null)) {
                    continue;
                }
                this.doAfterSelect();
