...
public final class SelectKt {
    ...
    static {
        SelectKt.NOT_SELECTED = new Symbol("NOT_SELECTED");
        SelectKt.ALREADY_SELECTED = new Symbol("ALREADY_SELECTED");
        SelectKt.UNDECIDED = new Symbol("UNDECIDED");
        SelectKt.RESUMED = new Symbol("RESUMED");
