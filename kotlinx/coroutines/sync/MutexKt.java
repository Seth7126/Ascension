...
public final class MutexKt {
    ...
    static {
        MutexKt.LOCK_FAIL = new Symbol("LOCK_FAIL");
        MutexKt.UNLOCK_FAIL = new Symbol("UNLOCK_FAIL");
        MutexKt.SELECT_SUCCESS = new Symbol("SELECT_SUCCESS");
        Symbol symbol0 = new Symbol("LOCKED");
        MutexKt.LOCKED = symbol0;
        Symbol symbol1 = new Symbol("UNLOCKED");
