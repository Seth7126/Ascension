...
public class JobSupport implements ChildJob, Job, ParentJob, SelectClause0 {
    ...
    @Metadata(d1 = {"\u00000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010\u0002\n\u0000\n\u0002\u0010\u0003\n\u0000\b\u0002\u0018\u00002\u00020\u0001B\'\u0012\u0006\u0010\u0002\u001A\u00020\u0003\u0012\u0006\u0010\u0004\u001A\u00020\u0005\u0012\u0006\u0010\u0006\u001A\u00020\u0007\u0012\b\u0010\b\u001A\u0004\u0018\u00010\t¢\u0006\u0002\u0010\nJ\u0013\u0010\u000B\u001A\u00020\f2\b\u0010\r\u001A\u0004\u0018\u00010\u000EH\u0096\u0002R\u000E\u0010\u0006\u001A\u00020\u0007X\u0082\u0004¢\u0006\u0002\n\u0000R\u000E\u0010\u0002\u001A\u00020\u0003X\u0082\u0004¢\u0006\u0002\n\u0000R\u0010\u0010\b\u001A\u0004\u0018\u00010\tX\u0082\u0004¢\u0006\u0002\n\u0000R\u000E\u0010\u0004\u001A\u00020\u0005X\u0082\u0004¢\u0006\u0002\n\u0000¨\u0006\u000F"}, d2 = {"Lkotlinx/coroutines/JobSupport$ChildCompletion;", "Lkotlinx/coroutines/JobNode;", "parent", "Lkotlinx/coroutines/JobSupport;", "state", "Lkotlinx/coroutines/JobSupport$Finishing;", "child", "Lkotlinx/coroutines/ChildHandleNode;", "proposedUpdate", "", "(Lkotlinx/coroutines/JobSupport;Lkotlinx/coroutines/JobSupport$Finishing;Lkotlinx/coroutines/ChildHandleNode;Ljava/lang/Object;)V", "invoke", "", "cause", "", "kotlinx-coroutines-core"}, k = 1, mv = {1, 5, 1}, xi = 0x30)
    ...
    public boolean cancel(Throwable throwable0) {
        CancellationException cancellationException0 = throwable0 == null ? new JobCancellationException(JobSupport.access$cancellationExceptionMessage(this), null, this) : JobSupport.toCancellationException$default(this, throwable0, null, 1, null);
        this.cancelInternal(cancellationException0);
        return true;
    }
    ...
    public final CancellationException getCancellationException() {
        ...
        if(object0 instanceof Finishing) {
            ...
            return this.toCancellationException(throwable0, Intrinsics.stringPlus(DebugStringsKt.getClassSimpleName(this), " is cancelling"));
        }
        if(object0 instanceof Incomplete) {
            throw new IllegalStateException(("Job is still new or active: " + this).toString());
        }
        return object0 instanceof CompletedExceptionally ? JobSupport.toCancellationException$default(this, ((CompletedExceptionally)object0).cause, null, 1, null) : new JobCancellationException(Intrinsics.stringPlus(DebugStringsKt.getClassSimpleName(this), " has completed normally"), null, this);
    }
    ...
    public CancellationException getChildJobCancellationCause() {
        ...
        return cancellationException0 == null ? new JobCancellationException(Intrinsics.stringPlus("Parent job is ", this.stateString(object0)), throwable0, this) : cancellationException0;
    }
    ...
    public final DisposableHandle invokeOnCompletion(boolean z, boolean z1, Function1 function10) {
        ...
        while(true) {
            ...
            while(!PainterModifier..ExternalSyntheticBackport0.m(JobSupport._state$FU, this, object0, jobNode0));
            return jobNode0;
        label_9:
            if(!(object0 instanceof Incomplete)) {
                break;
    ...
    private final JobNode makeNode(Function1 function10, boolean z) {
        ...
        if(z) {
            ...
            JobNode jobNode1 = function10 instanceof JobNode ? ((JobNode)function10) : null;
            if(jobNode1 != null) {
                jobNode0 = jobNode1;
            }
            if(jobNode0 == null) {
        ...
        while(!Intrinsics.areEqual(lockFreeLinkedListNode0, nodeList0)) {
            if(lockFreeLinkedListNode0 instanceof JobCancellingNode) {
                ...
                try {
                    ...
                    Throwable throwable2 = completionHandlerException0;
                    if(throwable2 == null) {
                        throwable2 = null;
                    }
                    else {
                        ExceptionsKt.addSuppressed(throwable2, throwable1);
                    }
                    if(throwable2 == null) {
    ...
    private final void promoteEmptyToNodeList(Empty empty0) {
        ...
        PainterModifier..ExternalSyntheticBackport0.m(JobSupport._state$FU, this, empty0, incomplete0);
    }
    ...
    private final void promoteSingleToNodeList(JobNode jobNode0) {
        ...
        PainterModifier..ExternalSyntheticBackport0.m(JobSupport._state$FU, this, jobNode0, lockFreeLinkedListNode0);
    }
    ...
    public final void removeNode$kotlinx_coroutines_core(JobNode jobNode0) {
        while(true) {
            ...
            if(PainterModifier..ExternalSyntheticBackport0.m(JobSupport._state$FU, this, object0, JobSupportKt.access$getEMPTY_ACTIVE$p())) {
                return;
            }
        }
    ...
    private final int startInternal(Object object0) {
        ...
        if(object0 instanceof InactiveNodeList) {
            ...
            if(!PainterModifier..ExternalSyntheticBackport0.m(JobSupport._state$FU, this, object0, nodeList0)) {
                return -1;
            }
            this.onStart();
            return 1;
    ...
    private final boolean tryFinalizeSimpleState(Incomplete incomplete0, Object object0) {
        ...
        if(!PainterModifier..ExternalSyntheticBackport0.m(JobSupport._state$FU, this, incomplete0, object1)) {
            return false;
        }
    ...
    private final boolean tryMakeCancelling(Incomplete incomplete0, Throwable throwable0) {
        ...
        if(!PainterModifier..ExternalSyntheticBackport0.m(JobSupport._state$FU, this, incomplete0, jobSupport$Finishing0)) {
            return false;
        }
    ...
    private final Object tryMakeCompletingSlowPath(Incomplete incomplete0, Object object0) {
        ...
        synchronized(jobSupport$Finishing0) {
            ...
            if(jobSupport$Finishing0 != incomplete0 && !PainterModifier..ExternalSyntheticBackport0.m(JobSupport._state$FU, this, incomplete0, jobSupport$Finishing0)) {
                return JobSupportKt.access$getCOMPLETING_RETRY$p();
            }
            boolean z = jobSupport$Finishing0.isCancelling();
            CompletedExceptionally completedExceptionally0 = object0 instanceof CompletedExceptionally ? ((CompletedExceptionally)object0) : null;
