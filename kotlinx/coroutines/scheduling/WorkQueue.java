...
public final class WorkQueue {
    ...
    public final long tryStealBlockingFrom(WorkQueue workQueue0) {
        ...
        while(v != v1 && workQueue0.blockingTasksInBuffer != 0) {
            ...
            if(task0 != null && (task0.taskContext.getTaskMode() == 1 && PainterModifier..ExternalSyntheticBackport0.m(atomicReferenceArray0, v & 0x7F, task0, null))) {
    ...
    private final long tryStealLastScheduled(WorkQueue workQueue0, boolean z) {
        ...
        while(!PainterModifier..ExternalSyntheticBackport0.m(WorkQueue.lastScheduledTask$FU, workQueue0, task0, null));
        WorkQueue.add$default(this, task0, false, 2, null);
        return -1L;
    }
}
