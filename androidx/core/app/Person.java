...
public class Person {
    ...
    public PersistableBundle toPersistableBundle() {
        ...
        persistableBundle0.putString("name", (this.mName == null ? null : this.mName.toString()));
        persistableBundle0.putString("uri", this.mUri);
        persistableBundle0.putString("key", this.mKey);
        persistableBundle0.putBoolean("isBot", this.mIsBot);
        persistableBundle0.putBoolean("isImportant", this.mIsImportant);
