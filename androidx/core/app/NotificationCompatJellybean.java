...
class NotificationCompatJellybean {
    ...
    public static Action readAction(int v, CharSequence charSequence0, PendingIntent pendingIntent0, Bundle bundle0) {
        return bundle0 == null ? new Action(v, charSequence0, pendingIntent0, null, null, null, false, 0, true, false) : new Action(v, charSequence0, pendingIntent0, bundle0, NotificationCompatJellybean.fromBundleArray(NotificationCompatJellybean.getBundleArrayFromBundle(bundle0, "android.support.remoteInputs")), NotificationCompatJellybean.fromBundleArray(NotificationCompatJellybean.getBundleArrayFromBundle(bundle0, "android.support.dataRemoteInputs")), bundle0.getBoolean("android.support.allowGeneratedReplies"), 0, true, false);
    }
