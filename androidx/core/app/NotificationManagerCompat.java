...
public final class NotificationManagerCompat {
    ...
    public boolean areNotificationsEnabled() {
        ...
        try {
            if(((int)(((Integer)AppOpsManager.class.getMethod("checkOpNoThrow", new Class[]{Integer.TYPE, Integer.TYPE, String.class}).invoke(appOpsManager0, new Object[]{((int)(((Integer)AppOpsManager.class.getDeclaredField("OP_POST_NOTIFICATION").get(Integer.class)))), v, "com.playdekgames.android.Ascension"})))) != 0) {
                return false;
            }
        }
    ...
    public void notify(String s, int v, Notification notification0) {
        if(NotificationManagerCompat.useSideChannelForNotification(notification0)) {
            this.pushSideChannelQueue(new NotifyTask("com.playdekgames.android.Ascension", v, s, notification0));
            this.mNotificationManager.cancel(s, v);
            return;
        }
