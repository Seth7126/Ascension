...
public final class RemoteInput {
    ...
    static android.app.RemoteInput fromCompat(RemoteInput remoteInput0) {
        ...
        if(Build.VERSION.SDK_INT >= 29) {
            remoteInput$Builder0.setEditChoicesBeforeSending(remoteInput0.getEditChoicesBeforeSending());
        }
    ...
    static RemoteInput fromPlatform(android.app.RemoteInput remoteInput0) {
        Builder remoteInput$Builder0 = new Builder(remoteInput0.getResultKey()).setLabel(remoteInput0.getLabel()).setChoices(remoteInput0.getChoices()).setAllowFreeFormInput(remoteInput0.getAllowFreeFormInput()).addExtras(remoteInput0.getExtras());
        if(Build.VERSION.SDK_INT >= 29) {
            remoteInput$Builder0.setEditChoicesBeforeSending(remoteInput0.getEditChoicesBeforeSending());
        }
        return remoteInput$Builder0.build();
