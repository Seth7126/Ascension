...
public class NotificationCompat {
    public static class Action {
        public static final class Builder {
            ...
            public Action build() {
                ...
                return new Action(this.mIcon, this.mTitle, this.mIntent, this.mExtras, arr_remoteInput, arr_remoteInput1, this.mAllowGeneratedReplies, this.mSemanticAction, this.mShowsUserInterface, this.mIsContextual);
            }
        ...
        Action(int v, CharSequence charSequence0, PendingIntent pendingIntent0, Bundle bundle0, RemoteInput[] arr_remoteInput, RemoteInput[] arr_remoteInput1, boolean z, int v1, boolean z1, boolean z2) {
            this((v == 0 ? null : IconCompat.createWithResource(null, "", v)), charSequence0, pendingIntent0, bundle0, arr_remoteInput, arr_remoteInput1, z, v1, z1, z2);
        }

        public Action(IconCompat iconCompat0, CharSequence charSequence0, PendingIntent pendingIntent0) {
            this(iconCompat0, charSequence0, pendingIntent0, new Bundle(), null, null, true, 0, true, false);
        }

        Action(IconCompat iconCompat0, CharSequence charSequence0, PendingIntent pendingIntent0, Bundle bundle0, RemoteInput[] arr_remoteInput, RemoteInput[] arr_remoteInput1, boolean z, int v, boolean z1, boolean z2) {
            this.mShowsUserInterface = true;
            this.mIcon = iconCompat0;
    ...
    public static class BigPictureStyle extends Style {
        ...
        public void apply(NotificationBuilderWithBuilderAccessor notificationBuilderWithBuilderAccessor0) {
            ...
            if(this.mBigLargeIconSet) {
                if(this.mBigLargeIcon == null) {
                    ...
                    Api16Impl.setBigLargeIcon(notification$BigPictureStyle0, this.mBigLargeIcon.getBitmap());
                }
                else {
                    Api16Impl.setBigLargeIcon(notification$BigPictureStyle0, null);
                }
        ...
        private static IconCompat asIconCompat(Parcelable parcelable0) {
            if(parcelable0 != null) {
                if(Build.VERSION.SDK_INT >= 23 && parcelable0 instanceof Icon) {
    ...
    public static final class CarExtender implements androidx.core.app.NotificationCompat.Extender {
        ...
        label_22:
            ...
            if(arr_s2 != null && arr_s2.length == 1) {
                if(remoteInput0 != null) {
                    notificationCompat$CarExtender$UnreadConversation0 = new RemoteInput(remoteInput0.getResultKey(), remoteInput0.getLabel(), remoteInput0.getChoices(), remoteInput0.getAllowFreeFormInput(), (Build.VERSION.SDK_INT < 29 ? 0 : remoteInput0.getEditChoicesBeforeSending()), remoteInput0.getExtras(), null);
                }
    ...
    public static class DecoratedCustomViewStyle extends Style {
        ...
        private RemoteViews generateActionButton(Action notificationCompat$Action0) {
            ...
            RemoteViews remoteViews0 = new RemoteViews("com.playdekgames.android.Ascension", (z ? layout.notification_action_tombstone : layout.notification_action));
    ...
    public static abstract class Style {
        ...
        public RemoteViews applyStandardTemplate(boolean z, int v, boolean z1) {
            ...
            RemoteViews remoteViews0 = new RemoteViews("com.playdekgames.android.Ascension", v);
            int v1 = 0;
            ...
            remoteViews0.setViewVisibility(0x7F06004F, (v7 == 0 ? 8 : 0));  // id:right_side
            if(!z2) {
                v1 = 8;
            }
            remoteViews0.setViewVisibility(0x7F060044, v1);  // id:line3
            return remoteViews0;
        }
        ...
        private Bitmap createIconWithBackground(int v, int v1, int v2, int v3) {
            ...
            Bitmap bitmap0 = this.createColoredBitmap(0x7F050024, v3, v1);  // drawable:notification_icon_background
    ...
    public static final class androidx.core.app.NotificationCompat.WearableExtender implements androidx.core.app.NotificationCompat.Extender {
        ...
        private static Notification.Action getActionFromActionCompat(Action notificationCompat$Action0) {
            ...
            if(Build.VERSION.SDK_INT >= 23) {
                IconCompat iconCompat0 = notificationCompat$Action0.getIconCompat();
                notification$Action$Builder0 = new Notification.Action.Builder((iconCompat0 == null ? null : iconCompat0.toIcon()), notificationCompat$Action0.getTitle(), notificationCompat$Action0.getActionIntent());
            }
            else {
                IconCompat iconCompat1 = notificationCompat$Action0.getIconCompat();
                notification$Action$Builder0 = new Notification.Action.Builder((iconCompat1 == null || iconCompat1.getType() != 2 ? 0 : iconCompat1.getResId()), notificationCompat$Action0.getTitle(), notificationCompat$Action0.getActionIntent());
            }
    ...
    static Action getActionCompatFromAction(Notification.Action notification$Action0) {
        ...
        if(Build.VERSION.SDK_INT < 24) {
            z = notification$Action0.getExtras().getBoolean("android.support.allowGeneratedReplies");
        }
        ...
        boolean z2 = Build.VERSION.SDK_INT < 29 ? false : notification$Action0.isContextual();
        if(Build.VERSION.SDK_INT < 23 || notification$Action0.getIcon() == null && notification$Action0.icon != 0) {
            return new Action(notification$Action0.icon, notification$Action0.title, notification$Action0.actionIntent, notification$Action0.getExtras(), arr_remoteInput1, null, z, v1, z1, z2);
        }
        if(notification$Action0.getIcon() != null) {
            iconCompat0 = IconCompat.createFromIconOrNullIfZeroResId(notification$Action0.getIcon());
        }
        return new Action(iconCompat0, notification$Action0.title, notification$Action0.actionIntent, notification$Action0.getExtras(), arr_remoteInput1, null, z, v1, z1, z2);
    }
