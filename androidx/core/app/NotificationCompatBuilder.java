...
class NotificationCompatBuilder implements NotificationBuilderWithBuilderAccessor {
    ...
    private void addAction(Action notificationCompat$Action0) {
        ...
        Notification.Action.Builder notification$Action$Builder0 = Build.VERSION.SDK_INT < 23 ? new Notification.Action.Builder((iconCompat0 == null ? 0 : iconCompat0.getResId()), notificationCompat$Action0.getTitle(), notificationCompat$Action0.getActionIntent()) : new Notification.Action.Builder((iconCompat0 == null ? null : iconCompat0.toIcon()), notificationCompat$Action0.getTitle(), notificationCompat$Action0.getActionIntent());
