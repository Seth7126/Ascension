...
public class TypefaceCompat {
    ...
    public static Typeface createFromResourcesFamilyXml(Context context0, FamilyResourceEntry fontResourcesParserCompat$FamilyResourceEntry0, Resources resources0, int v, int v1, FontCallback resourcesCompat$FontCallback0, Handler handler0, boolean z) {
        ...
        if(fontResourcesParserCompat$FamilyResourceEntry0 instanceof ProviderResourceEntry) {
            ...
            typeface1 = FontsContractCompat.requestFont(context0, ((ProviderResourceEntry)fontResourcesParserCompat$FamilyResourceEntry0).getRequest(), v1, z1, (z ? ((ProviderResourceEntry)fontResourcesParserCompat$FamilyResourceEntry0).getTimeout() : -1), FontCallback.getHandler(handler0), new ResourcesCallbackAdapter(resourcesCompat$FontCallback0));
        }
        else {
            typeface1 = TypefaceCompat.sTypefaceCompatImpl.createFromFontFamilyFilesResourceEntry(context0, ((FontFamilyFilesResourceEntry)fontResourcesParserCompat$FamilyResourceEntry0), resources0, v1);
            if(resourcesCompat$FontCallback0 != null) {
                if(typeface1 == null) {
        ...
        if(typeface1 != null) {
            ...
            TypefaceCompat.sTypefaceCache.put(s, typeface1);
        }
        return typeface1;
    }
