...
class TypefaceCompatBaseImpl {
    ...
    public Typeface createFromFontFamilyFilesResourceEntry(Context context0, FontFamilyFilesResourceEntry fontResourcesParserCompat$FontFamilyFilesResourceEntry0, Resources resources0, int v) {
        ...
        Typeface typeface0 = TypefaceCompat.createFromResourcesFontFile(context0, resources0, fontResourcesParserCompat$FontFileResourceEntry0.getResourceId(), fontResourcesParserCompat$FontFileResourceEntry0.getFileName(), v);
