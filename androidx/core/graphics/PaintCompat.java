    ...
    public static boolean setBlendMode(Paint paint0, BlendModeCompat blendModeCompat0) {
        ...
        if(Build.VERSION.SDK_INT >= 29) {
            if(blendModeCompat0 != null) {
                blendMode0 = BlendModeUtils.obtainBlendModeFromCompat(blendModeCompat0);
            }
        ...
        if(blendModeCompat0 != null) {
            ...
            if(porterDuff$Mode0 != null) {
                blendMode0 = new PorterDuffXfermode(porterDuff$Mode0);
            }
            paint0.setXfermode(((Xfermode)blendMode0));
