...
class FontProvider {
    ...
    static {
        FontProvider.sByteArrayComparator = new Comparator() {
            @Override
    ...
    static FontInfo[] query(Context context0, FontRequest fontRequest0, String s, CancellationSignal cancellationSignal0) {
        ...
        Cursor cursor0 = null;
        try {
            cursor0 = context0.getContentResolver().query(uri0, new String[]{"_id", "file_id", "font_ttc_index", "font_variation_settings", "font_weight", "font_italic", "result_code"}, "query = ?", new String[]{fontRequest0.getQuery()}, null, cancellationSignal0);
