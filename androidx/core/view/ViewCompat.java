...
public class ViewCompat {
    static class AccessibilityPaneVisibilityManager implements View.OnAttachStateChangeListener, ViewTreeObserver.OnGlobalLayoutListener {
        ...
        void addAccessibilityPane(View view0) {
            this.mPanesToVisible.put(view0, Boolean.valueOf(view0.getVisibility() == 0));
        ...
        private void checkPaneVisibility(View view0, boolean z) {
            boolean z1 = view0.getVisibility() == 0;
            if(z != z1) {
    ...
    static abstract class AccessibilityViewProperty {
        ...
        boolean booleanNullToFalseEquals(Boolean boolean0, Boolean boolean1) {
            return (boolean0 == null ? false : boolean0.booleanValue()) == (boolean1 == null ? false : boolean1.booleanValue());
        }
        ...
        void set(View view0, Object object0) {
            ...
            if(this.shouldUpdate(this.get(view0), object0)) {
                ViewCompat.getOrCreateAccessibilityDelegateCompat(view0);
    ...
    static class CompatImplApi28 {
        static void addOnUnhandledKeyEventListener(View view0, OnUnhandledKeyEventListenerCompat viewCompat$OnUnhandledKeyEventListenerCompat0) {
            ...
            androidx.core.view.ViewCompat.CompatImplApi28.1 viewCompat$CompatImplApi28$10 = new View.OnUnhandledKeyEventListener() {
                @Override  // android.view.View$OnUnhandledKeyEventListener
                public boolean onUnhandledKeyEvent(View view0, KeyEvent keyEvent0) {
                    return viewCompat$OnUnhandledKeyEventListenerCompat0.onUnhandledKeyEvent(view0, keyEvent0);
                }
            };
            simpleArrayMap0.put(viewCompat$OnUnhandledKeyEventListenerCompat0, viewCompat$CompatImplApi28$10);
            view0.addOnUnhandledKeyEventListener(viewCompat$CompatImplApi28$10);
        }
    ...
    static {
        ...
        ViewCompat.NO_OP_ON_RECEIVE_CONTENT_VIEW_BEHAVIOR = new OnReceiveContentViewBehavior() {
    ...
    private static AccessibilityViewProperty accessibilityHeadingProperty() {
        return new AccessibilityViewProperty(id.tag_accessibility_heading, Boolean.class, 28) {
            Boolean frameworkGet(View view0) {
                return Boolean.valueOf(view0.isAccessibilityHeading());
            }
            ...
            void frameworkSet(View view0, Boolean boolean0) {
                view0.setAccessibilityHeading(boolean0.booleanValue());
            }
    ...
    public static int addAccessibilityAction(View view0, CharSequence charSequence0, AccessibilityViewCommand accessibilityViewCommand0) {
        int v = ViewCompat.getAvailableActionIdFromResources(view0);
        if(v != -1) {
    ...
    public static void addOnUnhandledKeyEventListener(View view0, OnUnhandledKeyEventListenerCompat viewCompat$OnUnhandledKeyEventListenerCompat0) {
        if(Build.VERSION.SDK_INT >= 28) {
            CompatImplApi28.addOnUnhandledKeyEventListener(view0, viewCompat$OnUnhandledKeyEventListenerCompat0);
            return;
        }
        ArrayList arrayList0 = (ArrayList)view0.getTag(id.tag_unhandled_key_listeners);
        if(arrayList0 == null) {
    ...
    private static View.AccessibilityDelegate getAccessibilityDelegateInternal(View view0) {
        return Build.VERSION.SDK_INT < 29 ? ViewCompat.getAccessibilityDelegateThroughReflection(view0) : view0.getAccessibilityDelegate();
    }
    ...
    private static int getAvailableActionIdFromResources(View view0) {
        List list0 = ViewCompat.getActionList(view0);
        int v1 = -1;
        for(int v = 0; true; ++v) {
            int[] arr_v = ViewCompat.ACCESSIBILITY_ACTIONS_RESOURCE_IDS;
            if(v >= arr_v.length || v1 != -1) {
                break;
            }
            int v2 = arr_v[v];
            int v4 = 1;
            for(int v3 = 0; v3 < list0.size(); ++v3) {
                v4 &= (((AccessibilityActionCompat)list0.get(v3)).getId() == v2 ? 0 : 1);
            }
            if(v4 != 0) {
                v1 = v2;
            }
    ...
    public static String[] getOnReceiveContentMimeTypes(View view0) {
        return (String[])view0.getTag(id.tag_on_receive_content_mime_types);
    }

    static AccessibilityDelegateCompat getOrCreateAccessibilityDelegateCompat(View view0) {
        ...
        return accessibilityDelegateCompat0;
    }
    ...
    public static final CharSequence getStateDescription(View view0) {
    ...
    public static List getSystemGestureExclusionRects(View view0) {
        return Build.VERSION.SDK_INT < 29 ? Collections.emptyList() : view0.getSystemGestureExclusionRects();
    }
    ...
    static void notifyViewAccessibilityStateChangedIfNeeded(View view0, int v) {
        ...
        boolean z = ViewCompat.getAccessibilityPaneTitle(view0) != null && view0.getVisibility() == 0;
        int v1 = 0x20;
        if(ViewCompat.getAccessibilityLiveRegion(view0) != 0 || z) {
            ...
            if(view0.getParent() != null) {
                try {
                    view0.getParent().notifySubtreeAccessibilityStateChanged(view0, view0, v);
                }
    ...
    public static void removeOnUnhandledKeyEventListener(View view0, OnUnhandledKeyEventListenerCompat viewCompat$OnUnhandledKeyEventListenerCompat0) {
        if(Build.VERSION.SDK_INT >= 28) {
            CompatImplApi28.removeOnUnhandledKeyEventListener(view0, viewCompat$OnUnhandledKeyEventListenerCompat0);
            return;
        }
        ArrayList arrayList0 = (ArrayList)view0.getTag(id.tag_unhandled_key_listeners);
        if(arrayList0 != null) {
    ...
    private static AccessibilityViewProperty screenReaderFocusableProperty() {
        return new AccessibilityViewProperty(id.tag_screen_reader_focusable, Boolean.class, 28) {
            Boolean frameworkGet(View view0) {
                return Boolean.valueOf(view0.isScreenReaderFocusable());
            }
            ...
            void frameworkSet(View view0, Boolean boolean0) {
                view0.setScreenReaderFocusable(boolean0.booleanValue());
            }
