...
public final class EditorInfoCompat {
    ...
    public static CharSequence getInitialSelectedText(EditorInfo editorInfo0, int v) {
        if(Build.VERSION.SDK_INT >= 30) {
            return Impl30.getInitialSelectedText(editorInfo0, v);
        }
        if(editorInfo0.extras == null) {
            return null;
        }
        int v1 = editorInfo0.initialSelStart <= editorInfo0.initialSelEnd ? editorInfo0.initialSelStart : editorInfo0.initialSelEnd;
        int v2 = editorInfo0.initialSelStart <= editorInfo0.initialSelEnd ? editorInfo0.initialSelEnd : editorInfo0.initialSelStart;
    ...
    public static CharSequence getInitialTextAfterCursor(EditorInfo editorInfo0, int v, int v1) {
        if(Build.VERSION.SDK_INT >= 30) {
            return Impl30.getInitialTextAfterCursor(editorInfo0, v, v1);
        }
        if(editorInfo0.extras == null) {
            return null;
        }
    ...
    public static CharSequence getInitialTextBeforeCursor(EditorInfo editorInfo0, int v, int v1) {
        if(Build.VERSION.SDK_INT >= 30) {
            return Impl30.getInitialTextBeforeCursor(editorInfo0, v, v1);
        }
        if(editorInfo0.extras == null) {
            return null;
        }
    ...
    public static void setInitialSurroundingSubText(EditorInfo editorInfo0, CharSequence charSequence0, int v) {
        ...
        if(Build.VERSION.SDK_INT >= 30) {
            Impl30.setInitialSurroundingSubText(editorInfo0, charSequence0, v);
            return;
        }
    ...
    public static void setInitialSurroundingText(EditorInfo editorInfo0, CharSequence charSequence0) {
        if(Build.VERSION.SDK_INT >= 30) {
            Impl30.setInitialSurroundingSubText(editorInfo0, charSequence0, 0);
            return;
        }
