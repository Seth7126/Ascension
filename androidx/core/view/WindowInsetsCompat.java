...
public class WindowInsetsCompat {
    ...
    static class BuilderImpl20 extends BuilderImpl {
        ...
        BuilderImpl20(WindowInsetsCompat windowInsetsCompat0) {
            this.mInsets = windowInsetsCompat0.toWindowInsets();
        }

        @Override  // androidx.core.view.WindowInsetsCompat$BuilderImpl
        WindowInsetsCompat build() {
            this.applyInsetTypes();
            WindowInsetsCompat windowInsetsCompat0 = WindowInsetsCompat.toWindowInsetsCompat(this.mInsets);
        ...
        void setSystemWindowInsets(Insets insets0) {
            WindowInsets windowInsets0 = this.mInsets;
            if(windowInsets0 != null) {
                this.mInsets = windowInsets0.replaceSystemWindowInsets(insets0.left, insets0.top, insets0.right, insets0.bottom);
            }
        }
    }
    ...
    static class BuilderImpl29 extends BuilderImpl {
        ...
        void setDisplayCutout(DisplayCutoutCompat displayCutoutCompat0) {
            DisplayCutout displayCutout0 = displayCutoutCompat0 == null ? null : displayCutoutCompat0.unwrap();
            this.mPlatBuilder.setDisplayCutout(displayCutout0);
        }
    ...
    static class BuilderImpl {
        ...
        protected final void applyInsetTypes() {
            ...
            if(arr_insets != null) {
                ...
                if(insets0 != null && insets1 != null) {
                    this.setSystemWindowInsets(Insets.max(insets0, insets1));
                }
                else if(insets0 != null) {
                    this.setSystemWindowInsets(insets0);
                }
                else if(insets1 != null) {
                    this.setSystemWindowInsets(insets1);
                }
    ...
    static class Impl20 extends Impl {
        ...
        private static void loadReflectionField() {
            try {
                ...
                Impl20.sViewRootImplClass = Class.forName("android.view.ViewRootImpl");
                Class class0 = Class.forName("android.view.View$AttachInfo");
                Impl20.sAttachInfoClass = class0;
                Impl20.sVisibleInsetsField = class0.getDeclaredField("mVisibleInsets");
                Impl20.sAttachInfoField = Impl20.sViewRootImplClass.getDeclaredField("mAttachInfo");
