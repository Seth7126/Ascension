...
public final class DisplayCompat {
    ...
    static class Api23Impl {
        ...
        static boolean isCurrentModeTheLargestMode(Display display0) {
            ...
            while(v < arr_display$Mode.length) {
                if(display$Mode0.getPhysicalHeight() >= arr_display$Mode[v].getPhysicalHeight() && display$Mode0.getPhysicalWidth() >= arr_display$Mode[v].getPhysicalWidth()) {
                    ++v;
                    continue;
                }
                return false;
    ...
    public static final class ModeCompat {
        ...
        ModeCompat(Display.Mode display$Mode0, boolean z) {
            Preconditions.checkNotNull(display$Mode0, "mode == null, can\'t wrap a null reference");
            this.mPhysicalSize = new Point(display$Mode0.getPhysicalWidth(), display$Mode0.getPhysicalHeight());
            this.mMode = display$Mode0;
            this.mIsNative = z;
        }
