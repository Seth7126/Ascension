...
public final class WindowInsetsControllerCompat {
        ...
        private void showForType(int v) {
            switch(v) {
                ...
                case 8: {
                    ...
                    if(view0 == null || !view0.isInEditMode() && !view0.onCheckIsTextEditor()) {
    ...
    static class Impl30 extends Impl {
        ...
        void addOnControllableInsetsChangedListener(OnControllableInsetsChangedListener windowInsetsControllerCompat$OnControllableInsetsChangedListener0) {
            ...
            androidx.core.view.WindowInsetsControllerCompat.Impl30.2 windowInsetsControllerCompat$Impl30$20 = new WindowInsetsController.OnControllableInsetsChangedListener() {
                @Override  // android.view.WindowInsetsController$OnControllableInsetsChangedListener
                public void onControllableInsetsChanged(WindowInsetsController windowInsetsController0, int v) {
                    if(Impl30.this.mInsetsController == windowInsetsController0) {
                        windowInsetsControllerCompat$OnControllableInsetsChangedListener0.onControllableInsetsChanged(Impl30.this.mCompatController, v);
                    }
                }
            };
            this.mListeners.put(windowInsetsControllerCompat$OnControllableInsetsChangedListener0, windowInsetsControllerCompat$Impl30$20);
            this.mInsetsController.addOnControllableInsetsChangedListener(windowInsetsControllerCompat$Impl30$20);
        }
    ...
    public WindowInsetsControllerCompat(Window window0, View view0) {
        ...
        this.mImpl = new Impl20(window0, view0);
    }
