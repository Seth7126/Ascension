...
public final class TextViewOnReceiveContentListener implements OnReceiveContentListener {
    ...
    private static CharSequence coerceToText(ClipData clipData0, Context context0, int v) {
        CharSequence charSequence0 = new SpannableStringBuilder();
        for(int v1 = 0; v1 < clipData0.getItemCount(); ++v1) {
            CharSequence charSequence1 = TextViewOnReceiveContentListener.coerceToText(context0, clipData0.getItemAt(v1), v);
            if(charSequence1 != null) {
                ((SpannableStringBuilder)charSequence0).append(charSequence1);
            }
        }
    ...
    public ContentInfoCompat onReceiveContent(View view0, ContentInfoCompat contentInfoCompat0) {
        ...
        int v = contentInfoCompat0.getSource();
        if(v == 2) {
            return contentInfoCompat0;
        }
        if(v == 3) {
            TextViewOnReceiveContentListener.onReceiveForDragAndDrop(((TextView)view0), contentInfoCompat0);
            return null;
        }
        ClipData clipData0 = contentInfoCompat0.getClip();
        int v1 = contentInfoCompat0.getFlags();
        Editable editable0 = (Editable)((TextView)view0).getText();
        Context context0 = ((TextView)view0).getContext();
        boolean z = false;
        for(int v2 = 0; v2 < clipData0.getItemCount(); ++v2) {
            CharSequence charSequence0 = TextViewOnReceiveContentListener.coerceToText(context0, clipData0.getItemAt(v2), v1);
    ...
    private static void onReceiveForDragAndDrop(TextView textView0, ContentInfoCompat contentInfoCompat0) {
        CharSequence charSequence0 = TextViewOnReceiveContentListener.coerceToText(contentInfoCompat0.getClip(), textView0.getContext(), contentInfoCompat0.getFlags());
        TextViewOnReceiveContentListener.replaceSelection(((Editable)textView0.getText()), charSequence0);
    }
