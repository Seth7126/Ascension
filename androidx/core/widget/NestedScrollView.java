            ...
            switch(v) {
                ...
                case 0x1020038: {
                    ...
                    if(v8 != ((NestedScrollView)view0).getScrollY()) {
                        ((NestedScrollView)view0).smoothScrollTo(0, v8, true);
                        return true;
                    }
                    return false;
                }
        ...
        if(v == 0) {
            ...
            switch(v) {
                case 1: {
                    ...
                    else if(!this.dispatchNestedPreFling(0.0f, ((float)(-v1)))) {
                ...
                case 2: {
                    ...
                    if(v2 == -1) {
                        ...
                        if(!this.mIsBeingDragged && Math.abs(v4) > this.mTouchSlop) {
                            ...
                            this.mIsBeingDragged = true;
                            v4 = v4 <= 0 ? v4 + this.mTouchSlop : v4 - this.mTouchSlop;
                        }
                        int v5 = v4;
                        if(this.mIsBeingDragged) {
                            if(this.dispatchNestedPreScroll(0, v5, this.mScrollConsumed, this.mScrollOffset, 0)) {
                                v5 -= this.mScrollConsumed[1];
                            ...
                            this.mScrollConsumed[1] = 0;
                            this.dispatchNestedScroll(0, v9 - v6, 0, v5 - (v9 - v6), this.mScrollOffset, 0, this.mScrollConsumed);
                            this.mLastMotionY -= this.mScrollOffset[1];
                            this.mNestedYOffset += this.mScrollOffset[1];
                            if(v8 == 0 || v8 == 1 && v7 > 0) {
                                int v10 = v5 - this.mScrollConsumed[1];
                                this.ensureGlows();
                                int v11 = v6 + v10;
                                if(v11 < 0) {
                                    EdgeEffectCompat.onPull(this.mEdgeGlowTop, ((float)v10) / ((float)this.getHeight()), motionEvent0.getX(v2) / ((float)this.getWidth()));
                                    if(!this.mEdgeGlowBottom.isFinished()) {
                                        this.mEdgeGlowBottom.onRelease();
                                    }
                                }
                                else if(v11 > v7) {
                                    EdgeEffectCompat.onPull(this.mEdgeGlowBottom, ((float)v10) / ((float)this.getHeight()), 1.0f - motionEvent0.getX(v2) / ((float)this.getWidth()));
                                    if(!this.mEdgeGlowTop.isFinished()) {
                ...
                case 5: {
                    ...
                    this.mLastMotionY = (int)motionEvent0.getY(v12);
                    this.mActivePointerId = motionEvent0.getPointerId(v12);
                    break;
                }
                case 6: {
                    this.onSecondaryPointerUp(motionEvent0);
