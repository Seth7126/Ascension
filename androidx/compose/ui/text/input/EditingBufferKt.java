...
@Metadata(d1 = {"\u0000\n\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0005\u001A%\u0010\u0000\u001A\u00020\u00012\u0006\u0010\u0002\u001A\u00020\u00012\u0006\u0010\u0003\u001A\u00020\u0001H\u0000ø\u0001\u0000ø\u0001\u0001¢\u0006\u0004\b\u0004\u0010\u0005\u0082\u0002\u000B\n\u0002\b\u0019\n\u0005\b¡\u001E0\u0001¨\u0006\u0006"}, d2 = {"updateRangeAfterDelete", "Landroidx/compose/ui/text/TextRange;", "target", "deleted", "updateRangeAfterDelete-pWDy79M", "(JJ)J", "ui-text_release"}, k = 2, mv = {1, 5, 1}, xi = 0x30)
public final class EditingBufferKt {
    public static final long updateRangeAfterDelete-pWDy79M(long v, long v1) {
        ...
        if(v3 > TextRange.getMin-impl(v1)) {
            v2 -= TextRange.getLength-impl(v1);
            v3 -= TextRange.getLength-impl(v1);
        }
        return TextRangeKt.TextRange(v2, v3);
    }
}
