...
public final class CommitTextCommand implements EditCommand {
    ...
    public CommitTextCommand(AnnotatedString annotatedString0, int v) {
    ...
    public CommitTextCommand(String s, int v) {
    ...
    public void applyTo(EditingBuffer editingBuffer0) {
        ...
        int v = editingBuffer0.getCursor$ui_text_release();
        editingBuffer0.setCursor$ui_text_release(RangesKt.coerceIn((this.newCursorPosition <= 0 ? v + this.newCursorPosition - this.getText().length() : v + this.newCursorPosition - 1), 0, editingBuffer0.getLength$ui_text_release()));
    }
    ...
    public boolean equals(Object object0) {
        ...
        return Intrinsics.areEqual(this.getText(), ((CommitTextCommand)object0).getText()) ? this.newCursorPosition == ((CommitTextCommand)object0).newCursorPosition : false;
    }
