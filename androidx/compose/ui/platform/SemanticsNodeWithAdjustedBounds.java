...
public final class SemanticsNodeWithAdjustedBounds {
    ...
    public SemanticsNodeWithAdjustedBounds(SemanticsNode semanticsNode0, Rect rect0) {
        Intrinsics.checkNotNullParameter(semanticsNode0, "semanticsNode");
        Intrinsics.checkNotNullParameter(rect0, "adjustedBounds");
        super();
        this.semanticsNode = semanticsNode0;
        this.adjustedBounds = rect0;
    }
