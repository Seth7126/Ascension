...
public final class ScrollObservationScope implements OwnerScope {
    ...
    public ScrollObservationScope(int v, List list0, Float float0, Float float1, ScrollAxisRange scrollAxisRange0, ScrollAxisRange scrollAxisRange1) {
        Intrinsics.checkNotNullParameter(list0, "allScopes");
        super();
        this.semanticsNodeId = v;
        this.allScopes = list0;
        this.oldXValue = float0;
        this.oldYValue = float1;
        this.horizontalScrollAxisRange = scrollAxisRange0;
        this.verticalScrollAxisRange = scrollAxisRange1;
    }
    ...
    public final void setHorizontalScrollAxisRange(ScrollAxisRange scrollAxisRange0) {
        this.horizontalScrollAxisRange = scrollAxisRange0;
    }

    public final void setOldXValue(Float float0) {
        this.oldXValue = float0;
    }

    public final void setOldYValue(Float float0) {
        this.oldYValue = float0;
    }

    public final void setVerticalScrollAxisRange(ScrollAxisRange scrollAxisRange0) {
        this.verticalScrollAxisRange = scrollAxisRange0;
    }
}
