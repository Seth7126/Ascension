...
public final class RectKt {
    ...
    public static final Rect Rect-tz77jQw(long v, long v1) {
        return new Rect(Offset.getX-impl(v), Offset.getY-impl(v), Offset.getX-impl(v) + Size.getWidth-impl(v1), Offset.getY-impl(v) + Size.getHeight-impl(v1));
    }

    public static final Rect lerp(Rect rect0, Rect rect1, float f) {
        Intrinsics.checkNotNullParameter(rect0, "start");
        Intrinsics.checkNotNullParameter(rect1, "stop");
