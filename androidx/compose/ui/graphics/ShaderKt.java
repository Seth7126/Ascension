...
public final class ShaderKt {
    ...
    public static final Shader LinearGradientShader-VjE6UOU(long v, long v1, List list0, List list1, int v2) {
    ...
    public static final Shader RadialGradientShader-8uybcMk(long v, float f, List list0, List list1, int v1) {
        Intrinsics.checkNotNullParameter(list0, "colors");
    ...
    public static final Shader SweepGradientShader-9KIMszo(long v, List list0, List list1) {
        Intrinsics.checkNotNullParameter(list0, "colors");
