...
public interface Paint {
    ...
    void setAntiAlias(boolean arg1);

    void setBlendMode-s9anfk8(int arg1);

    void setColor-8_81llA(long arg1);

    void setColorFilter(ColorFilter arg1);

    void setFilterQuality-vDHp3xo(int arg1);

    void setPathEffect(PathEffect arg1);

    void setShader(Shader arg1);

    void setStrokeCap-BeK7IIE(int arg1);

    void setStrokeJoin-Ww9F2mQ(int arg1);

    void setStrokeMiterLimit(float arg1);

    void setStrokeWidth(float arg1);

    void setStyle-k9PVt8s(int arg1);
}
