...
public interface Canvas {
    ...
    public static final class DefaultImpls {
        ...
        public static void clipRect-mtrdD-E(Canvas canvas0, Rect rect0, int v) {
            Intrinsics.checkNotNullParameter(canvas0, "this");
            Intrinsics.checkNotNullParameter(rect0, "rect");
            canvas0.clipRect-N_I0leg(rect0.getLeft(), rect0.getTop(), rect0.getRight(), rect0.getBottom(), v);
        }
        ...
        public static void drawArc(Canvas canvas0, Rect rect0, float f, float f1, boolean z, Paint paint0) {
            Intrinsics.checkNotNullParameter(canvas0, "this");
            Intrinsics.checkNotNullParameter(rect0, "rect");
            Intrinsics.checkNotNullParameter(paint0, "paint");
            canvas0.drawArc(rect0.getLeft(), rect0.getTop(), rect0.getRight(), rect0.getBottom(), f, f1, z, paint0);
        }

        public static void drawArcRad(Canvas canvas0, Rect rect0, float f, float f1, boolean z, Paint paint0) {
            Intrinsics.checkNotNullParameter(canvas0, "this");
            Intrinsics.checkNotNullParameter(rect0, "rect");
            Intrinsics.checkNotNullParameter(paint0, "paint");
            canvas0.drawArc(rect0, f * 57.29578f, f1 * 57.29578f, z, paint0);
        }
        ...
        public static void drawOval(Canvas canvas0, Rect rect0, Paint paint0) {
            Intrinsics.checkNotNullParameter(canvas0, "this");
            Intrinsics.checkNotNullParameter(rect0, "rect");
            Intrinsics.checkNotNullParameter(paint0, "paint");
            canvas0.drawOval(rect0.getLeft(), rect0.getTop(), rect0.getRight(), rect0.getBottom(), paint0);
        }

        public static void drawRect(Canvas canvas0, Rect rect0, Paint paint0) {
            Intrinsics.checkNotNullParameter(canvas0, "this");
            Intrinsics.checkNotNullParameter(rect0, "rect");
            Intrinsics.checkNotNullParameter(paint0, "paint");
            canvas0.drawRect(rect0.getLeft(), rect0.getTop(), rect0.getRight(), rect0.getBottom(), paint0);
        }
        ...
        public static void skewRad(Canvas canvas0, float f, float f1) {
            Intrinsics.checkNotNullParameter(canvas0, "this");
            canvas0.skew(f * 57.29578f, f1 * 57.29578f);
        }
    }

    void clipPath-mtrdD-E(Path arg1, int arg2);

    void clipRect-N_I0leg(float arg1, float arg2, float arg3, float arg4, int arg5);

    void clipRect-mtrdD-E(Rect arg1, int arg2);

    void concat-58bKbWc(float[] arg1);

    void disableZ();

    void drawArc(float arg1, float arg2, float arg3, float arg4, float arg5, float arg6, boolean arg7, Paint arg8);

    void drawArc(Rect arg1, float arg2, float arg3, boolean arg4, Paint arg5);

    void drawArcRad(Rect arg1, float arg2, float arg3, boolean arg4, Paint arg5);

    void drawCircle-9KIMszo(long arg1, float arg2, Paint arg3);

    void drawImage-d-4ec7I(ImageBitmap arg1, long arg2, Paint arg3);

    void drawImageRect-HPBpro0(ImageBitmap arg1, long arg2, long arg3, long arg4, long arg5, Paint arg6);

    void drawLine-Wko1d7g(long arg1, long arg2, Paint arg3);

    void drawOval(float arg1, float arg2, float arg3, float arg4, Paint arg5);

    void drawOval(Rect arg1, Paint arg2);

    void drawPath(Path arg1, Paint arg2);

    void drawPoints-O7TthRY(int arg1, List arg2, Paint arg3);

    void drawRawPoints-O7TthRY(int arg1, float[] arg2, Paint arg3);

    void drawRect(float arg1, float arg2, float arg3, float arg4, Paint arg5);

    void drawRect(Rect arg1, Paint arg2);

    void drawRoundRect(float arg1, float arg2, float arg3, float arg4, float arg5, float arg6, Paint arg7);

    void drawVertices-TPEHhCM(Vertices arg1, int arg2, Paint arg3);
    ...
    void saveLayer(Rect arg1, Paint arg2);

    void scale(float arg1, float arg2);

    void skew(float arg1, float arg2);

    void skewRad(float arg1, float arg2);
