...
public interface DrawTransform {
    ...
    public static final class DefaultImpls {
        ...
        public static long getCenter-F1C5BW0(DrawTransform drawTransform0) {
            Intrinsics.checkNotNullParameter(drawTransform0, "this");
            return OffsetKt.Offset(Size.getWidth-impl(drawTransform0.getSize-NH-jbRc()) / 2.0f, Size.getHeight-impl(drawTransform0.getSize-NH-jbRc()) / 2.0f);
        }
    ...
    void transform-58bKbWc(float[] arg1);
