...
final class SnapshotMapKeySet extends SnapshotMapSet {
    public SnapshotMapKeySet(SnapshotStateMap snapshotStateMap0) {
    ...
    public boolean containsAll(Collection collection0) {
        ...
        if(!collection0.isEmpty()) {
            for(Object object0: collection0) {
                if(!this.getMap().containsKey(object0)) {
                    return false;
                }
                if(false) {
                    break;
    ...
    public StateMapMutableKeysIterator iterator() {
        return new StateMapMutableKeysIterator(this.getMap(), ((ImmutableSet)this.getMap().getReadable$runtime_release().getMap$runtime_release().entrySet()).iterator());
    }
    ...
    public boolean remove(Object object0) {
        return this.getMap().remove(object0) != null;
    }
    ...
    alab1:
        while(true) {
            for(z = false; true; z = true) {
                ...
                if(this.getMap().remove(object0) == null && !z) {
                    break;
                }
            }
        }
    ...
    public boolean retainAll(Collection collection0) {
        ...
        for(Object object0: snapshotStateMap0.entrySet()) {
            ...
            if(!set0.contains(map$Entry0.getKey()) != 0) {
