...
public final class ListUtilsKt {
    ...
    public static final List fastFilterIndexed(List list0, Function2 function20) {
    ...
    private static final Appendable fastJoinTo(List list0, Appendable appendable0, CharSequence charSequence0, CharSequence charSequence1, CharSequence charSequence2, int v, CharSequence charSequence3, Function1 function10) {
        ...
        if(v1 - 1 >= 0) {
            ...
            while(true) {
                ...
                ListUtilsKt.appendElement(appendable0, object0, function10);
                if(v2 + 1 > v1 - 1) {
                    break;
                }
                ++v2;
    ...
    static Appendable fastJoinTo$default(List list0, Appendable appendable0, CharSequence charSequence0, CharSequence charSequence1, CharSequence charSequence2, int v, CharSequence charSequence3, Function1 function10, int v1, Object object0) {
        ...
        int v2 = (v1 & 16) == 0 ? v : -1;
        if((v1 & 0x20) != 0) {
            return (v1 & 0x40) == 0 ? ListUtilsKt.fastJoinTo(list0, appendable0, charSequence4, charSequence5, charSequence6, v2, "...", function10) : ListUtilsKt.fastJoinTo(list0, appendable0, charSequence4, charSequence5, charSequence6, v2, "...", null);
        }
        return (v1 & 0x40) == 0 ? ListUtilsKt.fastJoinTo(list0, appendable0, charSequence4, charSequence5, charSequence6, v2, charSequence3, function10) : ListUtilsKt.fastJoinTo(list0, appendable0, charSequence4, charSequence5, charSequence6, v2, charSequence3, null);
    }
    ...
    public static final String fastJoinToString(List list0, CharSequence charSequence0, CharSequence charSequence1, CharSequence charSequence2, int v, CharSequence charSequence3, Function1 function10) {
        ...
        String s = ((StringBuilder)ListUtilsKt.fastJoinTo(list0, new StringBuilder(), charSequence0, charSequence1, charSequence2, v, charSequence3, function10)).toString();
    ...
    public static String fastJoinToString$default(List list0, CharSequence charSequence0, CharSequence charSequence1, CharSequence charSequence2, int v, CharSequence charSequence3, Function1 function10, int v1, Object object0) {
        ...
        return ListUtilsKt.fastJoinToString(list0, charSequence0, charSequence1, charSequence2, ((v1 & 8) == 0 ? v : -1), charSequence3, function10);
    }
    ...
    public static final Set fastToSet(List list0) {
        Intrinsics.checkNotNullParameter(list0, "<this>");
        HashSet hashSet0 = new HashSet(list0.size());
        int v = list0.size();
        if(v - 1 >= 0) {
            for(int v1 = 0; true; ++v1) {
                hashSet0.add(list0.get(v1));
                if(v1 + 1 > v - 1) {
                    break;
                }
            }
