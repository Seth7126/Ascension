...
public interface PersistentSet extends ImmutableSet, PersistentCollection {
    @Metadata(d1 = {"\u0000\u0016\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010#\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\bf\u0018\u0000*\u0004\b\u0001\u0010\u00012\b\u0012\u0004\u0012\u0002H\u00010\u00022\b\u0012\u0004\u0012\u0002H\u00010\u0003J\u000E\u0010\u0004\u001A\b\u0012\u0004\u0012\u00028\u00010\u0005H&¨\u0006\u0006"}, d2 = {"Landroidx/compose/runtime/external/kotlinx/collections/immutable/PersistentSet$Builder;", "E", "", "Landroidx/compose/runtime/external/kotlinx/collections/immutable/PersistentCollection$Builder;", "build", "Landroidx/compose/runtime/external/kotlinx/collections/immutable/PersistentSet;", "runtime_release"}, k = 1, mv = {1, 5, 1}, xi = 0x30)
    public interface Builder extends androidx.compose.runtime.external.kotlinx.collections.immutable.PersistentCollection.Builder, Set, KMutableSet {
        PersistentSet build();
    }

    PersistentSet add(Object arg1);

    PersistentSet addAll(Collection arg1);
    ...
    PersistentSet removeAll(Collection arg1);

    PersistentSet removeAll(Function1 arg1);

    PersistentSet retainAll(Collection arg1);
}
