...
public final class ParcelableSnapshotMutableState.Companion.CREATOR.1 implements Parcelable.ClassLoaderCreator {
    public ParcelableSnapshotMutableState createFromParcel(Parcel parcel0) {
        Intrinsics.checkNotNullParameter(parcel0, "parcel");
        return this.createFromParcel(parcel0, null);
    }

    public ParcelableSnapshotMutableState createFromParcel(Parcel parcel0, ClassLoader classLoader0) {
        Intrinsics.checkNotNullParameter(parcel0, "parcel");
