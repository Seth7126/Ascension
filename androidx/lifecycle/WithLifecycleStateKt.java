...
public final class WithLifecycleStateKt {
    public static final Object suspendWithStateAtLeastUnchecked(Lifecycle lifecycle0, State lifecycle$State0, boolean z, CoroutineDispatcher coroutineDispatcher0, Function0 function00, Continuation continuation0) {
        ...
        androidx.lifecycle.WithLifecycleStateKt.suspendWithStateAtLeastUnchecked..inlined.suspendCancellableCoroutine.lambda.1 withLifecycleStateKt$suspendWithStateAtLeastUnchecked$$inlined$suspendCancellableCoroutine$lambda$10 = new LifecycleEventObserver() {
        ...
        if(z) {
            androidx.lifecycle.WithLifecycleStateKt.suspendWithStateAtLeastUnchecked..inlined.suspendCancellableCoroutine.lambda.2 withLifecycleStateKt$suspendWithStateAtLeastUnchecked$$inlined$suspendCancellableCoroutine$lambda$20 = new Runnable() {
                @Override
                public final void run() {
                    lifecycle0.addObserver(withLifecycleStateKt$suspendWithStateAtLeastUnchecked$$inlined$suspendCancellableCoroutine$lambda$10);
                }
            };
            coroutineDispatcher0.dispatch(EmptyCoroutineContext.INSTANCE, withLifecycleStateKt$suspendWithStateAtLeastUnchecked$$inlined$suspendCancellableCoroutine$lambda$20);
        }
        else {
            lifecycle0.addObserver(withLifecycleStateKt$suspendWithStateAtLeastUnchecked$$inlined$suspendCancellableCoroutine$lambda$10);
        }
        cancellableContinuationImpl0.invokeOnCancellation(new Function1(withLifecycleStateKt$suspendWithStateAtLeastUnchecked$$inlined$suspendCancellableCoroutine$lambda$10, lifecycle0, lifecycle$State0, function00, z, coroutineDispatcher0) {
            final Function0 $block$inlined;
            final boolean $dispatchNeeded$inlined;
            final CoroutineDispatcher $lifecycleDispatcher$inlined;
            final androidx.lifecycle.WithLifecycleStateKt.suspendWithStateAtLeastUnchecked..inlined.suspendCancellableCoroutine.lambda.1 $observer;
            final State $state$inlined;
            final Lifecycle $this_suspendWithStateAtLeastUnchecked$inlined;

            {
                this.$observer = withLifecycleStateKt$suspendWithStateAtLeastUnchecked$$inlined$suspendCancellableCoroutine$lambda$10;
                this.$this_suspendWithStateAtLeastUnchecked$inlined = lifecycle0;
                this.$state$inlined = lifecycle$State0;
                this.$block$inlined = function00;
                this.$dispatchNeeded$inlined = z;
                this.$lifecycleDispatcher$inlined = coroutineDispatcher0;
                super(1);
            }
            ...
            public final void invoke(Throwable throwable0) {
                if(this.$lifecycleDispatcher$inlined.isDispatchNeeded(EmptyCoroutineContext.INSTANCE)) {
                    Runnable runnable0 = new Runnable() {
                        @Override
                        public final void run() {
                            androidx.lifecycle.WithLifecycleStateKt.suspendWithStateAtLeastUnchecked..inlined.suspendCancellableCoroutine.lambda.3.this.$this_suspendWithStateAtLeastUnchecked$inlined.removeObserver(androidx.lifecycle.WithLifecycleStateKt.suspendWithStateAtLeastUnchecked..inlined.suspendCancellableCoroutine.lambda.3.this.$observer);
                        }
                    };
                    this.$lifecycleDispatcher$inlined.dispatch(EmptyCoroutineContext.INSTANCE, runnable0);
                    return;
                }
    ...
    private static final Object withCreated$$forInline(LifecycleOwner lifecycleOwner0, Function0 function00, Continuation continuation0) {
        Intrinsics.checkNotNullExpressionValue(lifecycleOwner0.getLifecycle(), "lifecycle");
        Dispatchers.getMain().getImmediate();
        throw new NullPointerException();
    }
