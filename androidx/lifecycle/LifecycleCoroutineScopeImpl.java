...
public final class LifecycleCoroutineScopeImpl extends LifecycleCoroutineScope implements LifecycleEventObserver {
    ...
    public LifecycleCoroutineScopeImpl(Lifecycle lifecycle0, CoroutineContext coroutineContext0) {
        ...
        if(this.getLifecycle$lifecycle_runtime_ktx_release().getCurrentState() == State.DESTROYED) {
    ...
    public void onStateChanged(LifecycleOwner lifecycleOwner0, Event lifecycle$Event0) {
        ...
        if(this.getLifecycle$lifecycle_runtime_ktx_release().getCurrentState().compareTo(State.DESTROYED) <= 0) {
    ...
    public final void register() {
        BuildersKt__Builders_commonKt.launch$default(this, Dispatchers.getMain().getImmediate(), null, new Function2(null) {
            private Object L$0;
            int label;
            ...
            public final Continuation create(Object object0, Continuation continuation0) {
                ...
                Continuation continuation1 = new androidx.lifecycle.LifecycleCoroutineScopeImpl.register.1(LifecycleCoroutineScopeImpl.this, continuation0);
            ...
            public final Object invoke(Object object0, Object object1) {
                return ((androidx.lifecycle.LifecycleCoroutineScopeImpl.register.1)this.create(object0, ((Continuation)object1))).invokeSuspend(Unit.INSTANCE);
            }
            ...
            public final Object invokeSuspend(Object object0) {
                ...
                if(LifecycleCoroutineScopeImpl.this.getLifecycle$lifecycle_runtime_ktx_release().getCurrentState().compareTo(State.INITIALIZED) >= 0) {
