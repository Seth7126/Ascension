...
public final class DispatchQueue {
    ...
    public final void dispatchAndEnqueue(CoroutineContext coroutineContext0, Runnable runnable0) {
        ...
        mainCoroutineDispatcher0.dispatch(coroutineContext0, () -> {
            if(!DispatchQueue.this.queue.offer(this.$runnable$inlined)) {
                throw new IllegalStateException("cannot enqueue any more runnables");
            }
            DispatchQueue.this.drainQueue();
        });

        @Metadata(bv = {1, 0, 3}, d1 = {"\u0000\n\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0002\u0010\u0000\u001A\u00020\u0001H\n¢\u0006\u0002\b\u0002¨\u0006\u0003"}, d2 = {"<anonymous>", "", "run", "androidx/lifecycle/DispatchQueue$dispatchAndEnqueue$1$1"}, k = 3, mv = {1, 4, 1})
        final class androidx.lifecycle.DispatchQueue.dispatchAndEnqueue..inlined.with.lambda.1 implements Runnable {
            androidx.lifecycle.DispatchQueue.dispatchAndEnqueue..inlined.with.lambda.1(DispatchQueue dispatchQueue0, CoroutineContext coroutineContext0, Runnable runnable0) {
            }
    ...
    public final void drainQueue() {
        ...
        try {
            ...
            while(!this.queue.isEmpty() != 0 && this.canRun()) {
