...
final class BackStackState implements Parcelable {
    ...
    public BackStackState(BackStackRecord backStackRecord0) {
        ...
        for(int v2 = 0; v1 < v; v2 += 5) {
            ...
            this.mOps[v2 + 4] = fragmentTransaction$Op0.mPopExitAnim;
    ...
    public BackStackRecord instantiate(FragmentManagerImpl fragmentManagerImpl0) {
        ...
        int v1 = 0;
        for(int v = 0; v < this.mOps.length; v += 5) {
            ...
            fragmentTransaction$Op0.mPopExitAnim = this.mOps[v + 4];
