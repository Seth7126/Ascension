...
final class FragmentManagerImpl extends FragmentManager implements LayoutInflater.Factory2 {
    ...
    class PopBackStackState implements OpGenerator {
        ...
        public boolean generateOps(ArrayList arrayList0, ArrayList arrayList1) {
            return FragmentManagerImpl.this.mPrimaryNav == null || this.mId >= 0 || this.mName != null || !FragmentManagerImpl.this.mPrimaryNav.getChildFragmentManager().popBackStackImmediate() ? FragmentManagerImpl.this.popBackStackState(arrayList0, arrayList1, this.mName, this.mId, this.mFlags) : false;
        }
    }
    ...
    static class StartEnterTransitionListener implements OnStartEnterTransitionListener {
        ...
        public void onStartEnterTransition() {
            int v = this.mNumPostponed - 1;
            this.mNumPostponed = v;
            if(v != 0) {
                return;
            }
    ...
    FragmentManagerImpl() {
        ...
        this.mExecCommit = () -> {
            ...
            FragmentManagerImpl.this.updateOnBackPressedCallbackEnabled();
    ...
    void addRetainedFragment(Fragment fragment0) {
        ...
        if(this.mNonConfig.addRetainedFragment(fragment0) && FragmentManagerImpl.DEBUG) {
    ...
    private void animateRemoveFragment(Fragment fragment0, AnimationOrAnimator fragmentManagerImpl$AnimationOrAnimator0, int v) {
        ...
        if(fragmentManagerImpl$AnimationOrAnimator0.animation != null) {
            EndViewTransitionAnimation fragmentManagerImpl$EndViewTransitionAnimation0 = new EndViewTransitionAnimation(fragmentManagerImpl$AnimationOrAnimator0.animation, viewGroup0, view0);
            fragment0.setAnimatingAway(fragment0.mView);
            fragmentManagerImpl$EndViewTransitionAnimation0.setAnimationListener(new Animation.AnimationListener() {
                @Override  // android.view.animation.Animation$AnimationListener
                public void onAnimationEnd(Animation animation0) {
                    androidx.fragment.app.FragmentManagerImpl.3.1 fragmentManagerImpl$3$10 = new Runnable() {
                        @Override
                        public void run() {
                            if(androidx.fragment.app.FragmentManagerImpl.3.this.val$fragment.getAnimatingAway() != null) {
                                androidx.fragment.app.FragmentManagerImpl.3.this.val$fragment.setAnimatingAway(null);
                                int v = androidx.fragment.app.FragmentManagerImpl.3.this.val$fragment.getStateAfterAnimating();
                                FragmentManagerImpl.this.moveToState(androidx.fragment.app.FragmentManagerImpl.3.this.val$fragment, v, 0, 0, false);
                            }
                        }
                    };
                    viewGroup0.post(fragmentManagerImpl$3$10);
                }
            ...
            fragment0.mView.startAnimation(fragmentManagerImpl$EndViewTransitionAnimation0);
            return;
        }
        ...
        if(fragment0.mView != null) {
            ...
            if(fragmentManagerImpl$AnimationOrAnimator0 == null || fragmentManagerImpl$AnimationOrAnimator0.animator == null) {
                ...
                if(!fragment0.mHidden) {
                    ...
                    View view0 = fragment0.mView;
                    viewGroup0.startViewTransition(view0);
                    androidx.fragment.app.FragmentManagerImpl.5 fragmentManagerImpl$50 = new AnimatorListenerAdapter() {
                        @Override  // android.animation.AnimatorListenerAdapter
                        public void onAnimationEnd(Animator animator0) {
                            viewGroup0.endViewTransition(view0);
                            animator0.removeListener(this);
                            if(fragment0.mView != null && fragment0.mHidden) {
                                fragment0.mView.setVisibility(8);
                            }
                        }
                    };
                    fragmentManagerImpl$AnimationOrAnimator0.animator.addListener(fragmentManagerImpl$50);
                }
                fragmentManagerImpl$AnimationOrAnimator0.animator.start();
            }
        }
    ...
    void dispatchOnFragmentAttached(Fragment fragment0, Context context0, boolean z) {
        Fragment fragment1 = this.mParent;
        if(fragment1 != null) {
            FragmentManager fragmentManager0 = fragment1.getFragmentManager();
            if(fragmentManager0 instanceof FragmentManagerImpl) {
    ...
    void dispatchOnFragmentPreAttached(Fragment fragment0, Context context0, boolean z) {
        Fragment fragment1 = this.mParent;
        if(fragment1 != null) {
            FragmentManager fragmentManager0 = fragment1.getFragmentManager();
            if(fragmentManager0 instanceof FragmentManagerImpl) {
    ...
    private void dispatchParentPrimaryNavigationFragmentChanged(Fragment fragment0) {
        if(fragment0 != null && this.mActive.get(fragment0.mWho) == fragment0) {
    ...
    public void dump(String s, FileDescriptor fileDescriptor0, PrintWriter printWriter0, String[] arr_s) {
        ...
        if(v > 0) {
            ...
            for(int v2 = 0; v2 < v; ++v2) {
                Fragment fragment1 = (Fragment)this.mAdded.get(v2);
                printWriter0.print(s);
                printWriter0.print("  #");
                printWriter0.print(v2);
                printWriter0.print(": ");
                printWriter0.println(fragment1.toString());
            }
        }
        ...
        if(arrayList0 != null) {
            ...
            if(v3 > 0) {
                ...
                for(int v4 = 0; v4 < v3; ++v4) {
                    Fragment fragment2 = (Fragment)this.mCreatedMenus.get(v4);
                    printWriter0.print(s);
                    printWriter0.print("  #");
                    printWriter0.print(v4);
                    printWriter0.print(": ");
                    printWriter0.println(fragment2.toString());
                }
            }
        }
        ...
        if(arrayList1 != null) {
            ...
            if(v5 > 0) {
                ...
                for(int v6 = 0; v6 < v5; ++v6) {
                    BackStackRecord backStackRecord0 = (BackStackRecord)this.mBackStack.get(v6);
                    printWriter0.print(s);
                    printWriter0.print("  #");
        ...
        synchronized(this) {
            ArrayList arrayList2 = this.mBackStackIndices;
            if(arrayList2 != null) {
                ...
                if(v8 > 0) {
                    ...
                    for(int v9 = 0; v9 < v8; ++v9) {
                        BackStackRecord backStackRecord1 = (BackStackRecord)this.mBackStackIndices.get(v9);
                        printWriter0.print(s);
                        printWriter0.print("  #");
                        printWriter0.print(v9);
                        printWriter0.print(": ");
        ...
        if(arrayList3 != null) {
            ...
            if(v10 > 0) {
                ...
                for(int v1 = 0; v1 < v10; ++v1) {
                    OpGenerator fragmentManagerImpl$OpGenerator0 = (OpGenerator)this.mPendingActions.get(v1);
                    printWriter0.print(s);
                    printWriter0.print("  #");
    ...
    private void endAnimatingAwayFragments() {
        for(Object object0: this.mActive.values()) {
            ...
            if(fragment0 == null) {
            ...
            else if(fragment0.getAnimatingAway() != null) {
                int v = fragment0.getStateAfterAnimating();
                ...
                this.moveToState(fragment0, v, 0, 0, false);
            }
    ...
    public Fragment getFragment(Bundle bundle0, String s) {
        ...
        Fragment fragment0 = (Fragment)this.mActive.get(s1);
        if(fragment0 == null) {
    ...
    public FragmentFactory getFragmentFactory() {
        if(super.getFragmentFactory() == FragmentManagerImpl.DEFAULT_FACTORY) {
            Fragment fragment0 = this.mParent;
            if(fragment0 != null) {
                return fragment0.mFragmentManager.getFragmentFactory();
            }
            this.setFragmentFactory(new FragmentFactory() {
                @Override  // androidx.fragment.app.FragmentFactory
                public Fragment instantiate(ClassLoader classLoader0, String s) {
                    return FragmentManagerImpl.this.mHost.instantiate(FragmentManagerImpl.this.mHost.getContext(), s, null);
                }
            });
        }
    ...
    boolean isPrimaryNavigation(Fragment fragment0) {
        return fragment0 == null ? true : fragment0 == fragment0.mFragmentManager.getPrimaryNavigationFragment() && this.isPrimaryNavigation(fragment0.mFragmentManager.mParent);
    }
    ...
    AnimationOrAnimator loadAnimation(Fragment fragment0, int v, boolean z, int v1) {
        ...
        boolean z1 = false;
        fragment0.setNextAnim(0);
        if(fragment0.mContainer != null && fragment0.mContainer.getLayoutTransition() != null) {
            return null;
        }
        if(v2 != 0) {
            boolean z2 = "anim".equals(this.mHost.getContext().getResources().getResourceTypeName(v2));
            if(z2) {
                try {
    ...
    void makeActive(Fragment fragment0) {
        if(this.mActive.get(fragment0.mWho) != null) {
            return;
        }
        this.mActive.put(fragment0.mWho, fragment0);
        if(fragment0.mRetainInstanceChangedWhileDetached) {
            if(fragment0.mRetainInstance) {
                this.addRetainedFragment(fragment0);
            }
            else {
                this.removeRetainedFragment(fragment0);
            }
    ...
    static AnimationOrAnimator makeFadeAnimation(float f, float f1) {
    ...
    void makeInactive(Fragment fragment0) {
        ...
        for(Object object0: this.mActive.values()) {
            Fragment fragment1 = (Fragment)object0;
            if(fragment1 != null && fragment0.mWho.equals(fragment1.mTargetWho)) {
                fragment1.mTarget = fragment0;
                fragment1.mTargetWho = null;
            }
        }
        this.mActive.put(fragment0.mWho, null);
        this.removeRetainedFragment(fragment0);
        if(fragment0.mTargetWho != null) {
            fragment0.mTarget = (Fragment)this.mActive.get(fragment0.mTargetWho);
        }
        fragment0.initState();
    }

    static AnimationOrAnimator makeOpenCloseAnimation(float f, float f1, float f2, float f3) {
    ...
    private void makeRemovedFragmentsInvisible(ArraySet arraySet0) {
        ...
        for(int v1 = 0; v1 < v; ++v1) {
            ...
            if(!fragment0.mAdded) {
                View view0 = fragment0.requireView();
    ...
    void moveFragmentToExpectedState(Fragment fragment0) {
        ...
        if(!this.mActive.containsKey(fragment0.mWho)) {
            if(FragmentManagerImpl.DEBUG) {
                Log.v("FragmentManager", "Ignoring moving " + fragment0 + " to state " + this.mCurState + "since it is not added to " + this);
            }
            return;
        }
        int v = this.mCurState;
        if(fragment0.mRemoving) {
            v = fragment0.isInBackStack() ? Math.min(v, 1) : Math.min(v, 0);
        }
        this.moveToState(fragment0, v, fragment0.getNextTransition(), fragment0.getNextTransitionStyle(), false);
        if(fragment0.mView != null) {
            Fragment fragment1 = this.findFragmentUnder(fragment0);
            if(fragment1 != null) {
                ViewGroup viewGroup0 = fragment0.mContainer;
                int v1 = viewGroup0.indexOfChild(fragment1.mView);
                int v2 = viewGroup0.indexOfChild(fragment0.mView);
                if(v2 < v1) {
                    viewGroup0.removeViewAt(v2);
                    viewGroup0.addView(fragment0.mView, v1);
                }
            }
    ...
    void moveToState(Fragment fragment0, int v, int v1, int v2, boolean z) {
        ...
        if(fragment0.mDeferStart && fragment0.mState < 3 && v4 > 2) {
            v4 = 2;
        }
        int v5 = fragment0.mMaxState == State.CREATED ? Math.min(v4, 1) : Math.min(v4, fragment0.mMaxState.ordinal());
                ...
                case 0: {
                    if(v5 > 0) {
                        ...
                        if(fragment0.mSavedFragmentState != null) {
                            ...
                            Fragment fragment1 = this.getFragment(fragment0.mSavedFragmentState, "android:target_state");
                            fragment0.mTargetWho = fragment1 == null ? null : fragment1.mWho;
                            if(fragment0.mTargetWho != null) {
                        ...
                        fragment0.mFragmentManager = this.mParent == null ? this.mHost.mFragmentManager : this.mParent.mChildFragmentManager;
                        if(fragment0.mTarget != null) {
                            if(this.mActive.get(fragment0.mTarget.mWho) != fragment0.mTarget) {
                        ...
                        if(fragment0.mTargetWho != null) {
                            Object object0 = this.mActive.get(fragment0.mTargetWho);
                            if(((Fragment)object0) == null) {
                                throw new IllegalStateException("Fragment " + fragment0 + " declared target fragment " + fragment0.mTargetWho + " that does not belong to this FragmentManager!");
                            }
                            if(((Fragment)object0).mState < 1) {
                                this.moveToState(((Fragment)object0), 1, 0, 0, true);
                            }
                        }
                ...
                label_155:
                    if(v5 < 1) {
                        ...
                        if(fragment0.getAnimatingAway() != null || fragment0.getAnimator() != null) {
                            ...
                            boolean z1 = fragment0.mRemoving && !fragment0.isInBackStack();
                            if(z1 || this.mNonConfig.shouldDestroy(fragment0)) {
                                FragmentHostCallback fragmentHostCallback0 = this.mHost;
                                if(fragmentHostCallback0 instanceof ViewModelStoreOwner) {
                                    v3 = this.mNonConfig.isCleared();
                                }
                                else if(fragmentHostCallback0.getContext() instanceof Activity) {
                                    v3 = true ^ ((Activity)this.mHost.getContext()).isChangingConfigurations();
                                }
                                if(z1 || v3 != 0) {
                                    this.mNonConfig.clearNonConfigState(fragment0);
                                }
                            ...
                            if(!z) {
                                if(z1 || this.mNonConfig.shouldDestroy(fragment0)) {
                                    ...
                                    if(fragment0.mTargetWho != null) {
                                        Fragment fragment2 = (Fragment)this.mActive.get(fragment0.mTargetWho);
                                        if(fragment2 != null && fragment2.getRetainInstance()) {
                                            fragment0.mTarget = fragment2;
                                        }
                                    }
                                }
                            }
                ...
                label_133:
                    if(v5 < 2) {
                        ...
                        if(fragment0.mView != null && fragment0.mContainer != null) {
                            ...
                            if(fragment0.getParentFragment() == null || !fragment0.getParentFragment().mRemoving) {
    ...
    public View onCreateView(View view0, String s, Context context0, AttributeSet attributeSet0) {
        ...
        if(s1 != null && FragmentFactory.isFragmentClass(context0.getClassLoader(), s1)) {
            ...
            if(v1 != -1) {
                fragment0 = this.findFragmentById(v1);
            }
            if(fragment0 == null && s2 != null) {
                fragment0 = this.findFragmentByTag(s2);
            }
            if(fragment0 == null && v != -1) {
                fragment0 = this.findFragmentById(v);
            }
            if(FragmentManagerImpl.DEBUG) {
                Log.v("FragmentManager", "onCreateView: id=0x" + Integer.toHexString(v1) + " fname=" + s1 + " existing=" + fragment0);
            }
            if(fragment0 == null) {
                fragment0 = this.getFragmentFactory().instantiate(context0.getClassLoader(), s1);
                fragment0.mFromLayout = true;
                fragment0.mFragmentId = v1 == 0 ? v : v1;
                ...
                this.addFragment(fragment0, true);
            }
            ...
            if(this.mCurState >= 1 || !fragment0.mFromLayout) {
                this.moveToState(fragment0);
            }
            else {
                this.moveToState(fragment0, 1, 0, 0, false);
            }
            if(fragment0.mView == null) {
                throw new IllegalStateException("Fragment " + s1 + " did not create a view.");
            }
            if(v1 != 0) {
                fragment0.mView.setId(v1);
            }
    ...
    boolean popBackStackState(ArrayList arrayList0, ArrayList arrayList1, String s, int v, int v1) {
        ...
        if(s != null || v >= 0) {
            int v4;
            for(v4 = arrayList2.size() - 1; v4 >= 0; --v4) {
            ...
            if((v1 & 1) != 0) {
                while(true) {
                    ...
                    BackStackRecord backStackRecord1 = (BackStackRecord)this.mBackStack.get(v4);
        ...
        for(int v5 = this.mBackStack.size() - 1; v5 > v3; --v5) {
            arrayList0.add(this.mBackStack.remove(v5));
            arrayList1.add(Boolean.TRUE);
        }
        return true;
    }
    ...
    void removeRetainedFragment(Fragment fragment0) {
        ...
        if(this.mNonConfig.removeRetainedFragment(fragment0) && FragmentManagerImpl.DEBUG) {
    ...
    void restoreAllState(Parcelable parcelable0, FragmentManagerNonConfig fragmentManagerNonConfig0) {
        ...
        this.restoreSaveState(parcelable0);
    }
    ...
    void restoreSaveState(Parcelable parcelable0) {
        ...
        for(Object object0: this.mNonConfig.getRetainedFragments()) {
            Fragment fragment0 = (Fragment)object0;
            if(FragmentManagerImpl.DEBUG) {
                Log.v("FragmentManager", "restoreSaveState: re-attaching retained " + fragment0);
            }
            for(Object object1: ((FragmentManagerState)parcelable0).mActive) {
                fragmentState0 = (FragmentState)object1;
                if(!fragmentState0.mWho.equals(fragment0.mWho)) {
                    continue;
                }
                goto label_17;
            }
        ...
        label_17:
            if(fragmentState0 == null) {
                if(FragmentManagerImpl.DEBUG) {
                    Log.v("FragmentManager", "Discarding retained Fragment " + fragment0 + " that was not found in the set of active Fragments " + ((FragmentManagerState)parcelable0).mActive);
                }
                this.moveToState(fragment0, 1, 0, 0, false);
                fragment0.mRemoving = true;
                this.moveToState(fragment0, 0, 0, 0, false);
            }
            else {
        ...
        this.mActive.clear();
        for(Object object2: ((FragmentManagerState)parcelable0).mActive) {
            FragmentState fragmentState1 = (FragmentState)object2;
            if(fragmentState1 != null) {
                Fragment fragment1 = fragmentState1.instantiate(this.mHost.getContext().getClassLoader(), this.getFragmentFactory());
                fragment1.mFragmentManager = this;
                if(FragmentManagerImpl.DEBUG) {
                    Log.v("FragmentManager", "restoreSaveState: active (" + fragment1.mWho + "): " + fragment1);
                }
                this.mActive.put(fragment1.mWho, fragment1);
                fragmentState1.mInstance = null;
            }
        }
        this.mAdded.clear();
        if(((FragmentManagerState)parcelable0).mAdded != null) {
            for(Object object3: ((FragmentManagerState)parcelable0).mAdded) {
                String s = (String)object3;
                Fragment fragment2 = (Fragment)this.mActive.get(s);
                if(fragment2 == null) {
                    this.throwException(new IllegalStateException("No instantiated fragment for (" + s + ")"));
                }
                fragment2.mAdded = true;
                if(FragmentManagerImpl.DEBUG) {
                    Log.v("FragmentManager", "restoreSaveState: added (" + s + "): " + fragment2);
                }
        ...
        if(((FragmentManagerState)parcelable0).mBackStack == null) {
            ...
            for(int v1 = 0; v1 < ((FragmentManagerState)parcelable0).mBackStack.length; ++v1) {
                BackStackRecord backStackRecord0 = ((FragmentManagerState)parcelable0).mBackStack[v1].instantiate(this);
                if(FragmentManagerImpl.DEBUG) {
        ...
        if(((FragmentManagerState)parcelable0).mPrimaryNavActiveWho != null) {
            Fragment fragment3 = (Fragment)this.mActive.get(((FragmentManagerState)parcelable0).mPrimaryNavActiveWho);
    ...
    Parcelable saveAllState() {
        ...
        for(Object object0: this.mActive.values()) {
            ...
            if(fragment0 != null) {
                if(fragment0.mFragmentManager != this) {
                    this.throwException(new IllegalStateException("Failure saving state: active " + fragment0 + " was removed from the FragmentManager"));
                }
                ...
                if(fragment0.mState <= 0 || fragmentState0.mSavedFragmentState != null) {
                    ...
                    if(fragment0.mTargetWho != null) {
                        Fragment fragment1 = (Fragment)this.mActive.get(fragment0.mTargetWho);
                        if(fragment1 == null) {
                            this.throwException(new IllegalStateException("Failure saving state: " + fragment0 + " has target not in fragment manager: " + fragment0.mTargetWho));
                        }
                        if(fragmentState0.mSavedFragmentState == null) {
                            fragmentState0.mSavedFragmentState = new Bundle();
                        }
                        this.putFragment(fragmentState0.mSavedFragmentState, "android:target_state", fragment1);
        ...
        int v1 = this.mAdded.size();
        if(v1 > 0) {
            arrayList1 = new ArrayList(v1);
            for(Object object1: this.mAdded) {
                Fragment fragment2 = (Fragment)object1;
                arrayList1.add(fragment2.mWho);
                if(fragment2.mFragmentManager != this) {
                    this.throwException(new IllegalStateException("Failure saving state: active " + fragment2 + " was removed from the FragmentManager"));
                }
                if(FragmentManagerImpl.DEBUG) {
        ...
        if(arrayList2 != null) {
            int v2 = arrayList2.size();
            if(v2 > 0) {
                arr_backStackState = new BackStackState[v2];
                for(int v = 0; v < v2; ++v) {
                    arr_backStackState[v] = new BackStackState(((BackStackRecord)this.mBackStack.get(v)));
                    if(FragmentManagerImpl.DEBUG) {
                        Log.v("FragmentManager", "saveAllState: adding back stack #" + v + ": " + this.mBackStack.get(v));
                    }
                }
            }
        }
        Parcelable parcelable0 = new FragmentManagerState();
        parcelable0.mActive = arrayList0;
        parcelable0.mAdded = arrayList1;
        parcelable0.mBackStack = arr_backStackState;
        Fragment fragment3 = this.mPrimaryNav;
        if(fragment3 != null) {
            parcelable0.mPrimaryNavActiveWho = fragment3.mWho;
        }
    ...
    Bundle saveFragmentBasicState(Fragment fragment0) {
        ...
        if(!this.mStateBundle.isEmpty()) {
            Bundle bundle1 = this.mStateBundle;
            this.mStateBundle = null;
            bundle0 = bundle1;
        }
        if(fragment0.mView != null) {
    ...
    public void setMaxLifecycle(Fragment fragment0, State lifecycle$State0) {
        if(this.mActive.get(fragment0.mWho) != fragment0 || fragment0.mHost != null && fragment0.getFragmentManager() != this) {
    ...
    public void setPrimaryNavigationFragment(Fragment fragment0) {
        if(fragment0 != null && (this.mActive.get(fragment0.mWho) != fragment0 || fragment0.mHost != null && fragment0.getFragmentManager() != this)) {
            throw new IllegalArgumentException("Fragment " + fragment0 + " is not an active fragment of FragmentManager " + this);
        }
    ...
    class androidx.fragment.app.FragmentManagerImpl.2 implements Runnable {
        @Override
        public void run() {
